 ...
 * @export
 */
export type GetV1TariffsCommission200Response =
  | Fee
  | FeeChina
  | FeeTurkey
  | FeeUAE
...
export const DefaultApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    getV1AcceptanceCoefficients: async (
      warehouseIDs?: string,
...
export const DefaultApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getV1AcceptanceCoefficients(
      warehouseIDs?: string,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<ModelsAcceptanceCoefficient>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getV1AcceptanceCoefficients(
          warehouseIDs,
          options,
        );
    ...
    async getV1TariffsBox(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<RatesBoxResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getV1TariffsBox(
        date,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
    ...
    async getV1TariffsCommission(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GetV1TariffsCommission200Response>
    > {
      const localVarAxiosArgs =
    ...
    async getV1TariffsPallet(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<RatesPalletResponse>
    > {
      const localVarAxiosArgs =
    ...
    async getV1TariffsReturn(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<ReturnRatesResponse>
    > {
      const localVarAxiosArgs =
