...
export type ModelsDateFilterRequestTypeEnum =
  (typeof ModelsDateFilterRequestTypeEnum)[keyof typeof ModelsDateFilterRequestTypeEnum];
...
export type ModelsDiscrepancyResponseItemDiscrepancyTypeEnum =
  (typeof ModelsDiscrepancyResponseItemDiscrepancyTypeEnum)[keyof typeof ModelsDiscrepancyResponseItemDiscrepancyTypeEnum];
...
export type ModelsHandySupplyStatus =
  (typeof ModelsHandySupplyStatus)[keyof typeof ModelsHandySupplyStatus];
...
export type ModelsItemScansDiscrepancyLabelEnum =
  (typeof ModelsItemScansDiscrepancyLabelEnum)[keyof typeof ModelsItemScansDiscrepancyLabelEnum];
...
export type ModelsSupplyStatusIDEnum =
  (typeof ModelsSupplyStatusIDEnum)[keyof typeof ModelsSupplyStatusIDEnum];
...
export type ModelsSupplyDetailsStatusIDEnum =
  (typeof ModelsSupplyDetailsStatusIDEnum)[keyof typeof ModelsSupplyDetailsStatusIDEnum];
...
export const DefaultApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    deleteV1DraftsDraftIdItems: async (
      draftId: string,
      ...
      const localVarPath = `/api/supplies/v1/drafts/{draftId}/items`.replace(
        `{${"draftId"}}`,
        encodeURIComponent(String(draftId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getV1SuppliesId: async (
      ...
      const localVarPath = `/api/v1/supplies/{ID}`.replace(
        `{${"ID"}}`,
    ...
    getV1SuppliesIdGoods: async (
      ...
      const localVarPath = `/api/v1/supplies/{ID}/goods`.replace(
        `{${"ID"}}`,
        encodeURIComponent(String(iD)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getV1SuppliesIdPackage: async (
      iD: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'iD' is not null or undefined
      assertParamExists("getV1SuppliesIdPackage", "iD", iD);
      const localVarPath = `/api/v1/supplies/{ID}/package`.replace(
        `{${"ID"}}`,
        encodeURIComponent(String(iD)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getV1SuppliesSupplyIdDiscrepanciesQuantity: async (
      supplyId: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/supplies/v1/discrepancies/{supplyId}`.replace(
        `{${"supplyId"}}`,
     ...
     * @throws {RequiredError}
     */
    postV1DraftsDraftIdItems: async (
      draftId: string,
...
export const DefaultApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async deleteV1DraftsDraftIdItems(
      draftId: string,
      modelsDraftDeleteitemsRequest: ModelsDraftDeleteitemsRequest,
      options?: RawAxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteV1DraftsDraftIdItems(
          draftId,
          modelsDraftDeleteitemsRequest,
          options,
        );
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getV1Drafts(
        limit,
        offset,
        sort,
        order,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getV1DraftsDraftIdItems(
          draftId,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getV1SuppliesId(
        iD,
        isPreorderID,
        options,
      );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getV1SuppliesIdGoods(
          iD,
          limit,
          offset,
          isPreorderID,
     ...
     * @throws {RequiredError}
     */
    async getV1SuppliesSupplyIdDiscrepanciesQuantity(
      supplyId: number,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getV1SuppliesSupplyIdDiscrepanciesQuantity(
          supplyId,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.postV1AcceptanceOptions(
          modelsGood,
          warehouseID,
          options,
        );
     ...
     * @throws {RequiredError}
     */
    async postV1DraftsDraftIdItems(
      draftId: string,
      modelsDraftAdditemsRequest: ModelsDraftAdditemsRequest,
      options?: RawAxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.postV1DraftsDraftIdItems(
          draftId,
          modelsDraftAdditemsRequest,
          options,
        );
    ...
    async postV1Supplies(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<ModelsSupply>>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.postV1Supplies(
        modelsSuppliesFiltersRequest,
        limit,
        offset,
        options,
...
export type GetV1DraftsSortEnum =
  (typeof GetV1DraftsSortEnum)[keyof typeof GetV1DraftsSortEnum];
/**
 * @export
 */
...
export type GetV1DraftsOrderEnum =
  (typeof GetV1DraftsOrderEnum)[keyof typeof GetV1DraftsOrderEnum];
