...
export type ApiOrdersMetaDleteRequestV2KeyEnum =
  (typeof ApiOrdersMetaDleteRequestV2KeyEnum)[keyof typeof ApiOrdersMetaDleteRequestV2KeyEnum];
...
export type OrderNewDBWCargoTypeEnum =
  (typeof OrderNewDBWCargoTypeEnum)[keyof typeof OrderNewDBWCargoTypeEnum];
...
export const DBWApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    patchV3DbwOrdersOrderIdCancel: async (
      orderId: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'orderId' is not null or undefined
      assertParamExists("patchV3DbwOrdersOrderIdCancel", "orderId", orderId);
      const localVarPath = `/api/v3/dbw/orders/{orderId}/cancel`.replace(
        `{${"orderId"}}`,
     ...
     * @throws {RequiredError}
     */
    patchV3DbwOrdersOrderIdConfirm: async (
      orderId: number,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'orderId' is not null or undefined
      assertParamExists("patchV3DbwOrdersOrderIdConfirm", "orderId", orderId);
      const localVarPath = `/api/v3/dbw/orders/{orderId}/confirm`.replace(
        `{${"orderId"}}`,
        encodeURIComponent(String(orderId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    postV3DbwOrdersDeliveryDate: async (
     ...
     * @throws {RequiredError}
     */
    postV3DbwOrdersMetaDelete: async (
     ...
     * @throws {RequiredError}
     */
    postV3DbwOrdersMetaDetails: async (
     ...
     * @throws {RequiredError}
     */
    postV3DbwOrdersMetaSgtin: async (
     ...
     * @throws {RequiredError}
     */
    postV3DbwOrdersStatusDeliver: async (
      apiOrdersRequestV2: ApiOrdersRequestV2,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'apiOrdersRequestV2' is not null or undefined
     ...
     * @throws {RequiredError}
     */
    postV3DbwOrdersStickers: async (
      type: PostV3DbwOrdersStickersTypeEnum,
      width: PostV3DbwOrdersStickersWidthEnum,
      height: PostV3DbwOrdersStickersHeightEnum,
     ...
     * @throws {RequiredError}
     */
    putV3DbwOrdersOrderIdMetaGtin: async (
      orderId: number,
      ...
      const localVarPath = `/api/v3/dbw/orders/{orderId}/meta/gtin`.replace(
        `{${"orderId"}}`,
        encodeURIComponent(String(orderId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    putV3DbwOrdersOrderIdMetaImei: async (
      orderId: number,
      ...
      const localVarPath = `/api/v3/dbw/orders/{orderId}/meta/imei`.replace(
        `{${"orderId"}}`,
        encodeURIComponent(String(orderId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    putV3DbwOrdersOrderIdMetaUin: async (
      orderId: number,
      ...
      const localVarPath = `/api/v3/dbw/orders/{orderId}/meta/uin`.replace(
        `{${"orderId"}}`,
        encodeURIComponent(String(orderId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
  ...
  return {
    ...
    async getV3DbwOrders(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GetV3DbwOrdersResponse200>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getV3DbwOrders(
        limit,
        next,
        dateFrom,
        dateTo,
     ...
     * @throws {RequiredError}
     */
    async getV3DbwOrdersNew(
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GetV3DbwOrdersNewResponse200>
    > {
     ...
     * @throws {RequiredError}
     */
    async patchV3DbwOrdersOrderIdCancel(
      orderId: number,
      options?: RawAxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.patchV3DbwOrdersOrderIdCancel(
          orderId,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
     ...
     * @throws {RequiredError}
     */
    async patchV3DbwOrdersOrderIdConfirm(
      orderId: number,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.patchV3DbwOrdersOrderIdConfirm(
          orderId,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
     ...
     * @throws {RequiredError}
     */
    async postV3DbwOrdersClient(
      ordersRequestAPI: OrdersRequestAPI,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ClientInfoResp>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.postV3DbwOrdersClient(
          ordersRequestAPI,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
    ...
    async postV3DbwOrdersCourier(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<OrderCourierInfoResp>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.postV3DbwOrdersCourier(
          ordersRequestAPI,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
     ...
     * @throws {RequiredError}
     */
    async postV3DbwOrdersDeliveryDate(
      deliveryDatesRequest: DeliveryDatesRequest,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.postV3DbwOrdersDeliveryDate(
          deliveryDatesRequest,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
     ...
     * @throws {RequiredError}
     */
    async postV3DbwOrdersMetaDelete(
      apiOrdersMetaDleteRequestV2: ApiOrdersMetaDleteRequestV2,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<PostV3DbwOrdersMetaDeleteResponse200>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.postV3DbwOrdersMetaDelete(
          apiOrdersMetaDleteRequestV2,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
     ...
     * @throws {RequiredError}
     */
    async postV3DbwOrdersMetaDetails(
      apiOrdersRequestV2: ApiOrdersRequestV2,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.postV3DbwOrdersMetaDetails(
          apiOrdersRequestV2,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
     ...
     * @throws {RequiredError}
     */
    async postV3DbwOrdersMetaSgtin(
      apiOrdersSGTINsSetRequest: ApiOrdersSGTINsSetRequest,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.postV3DbwOrdersMetaSgtin(
          apiOrdersSGTINsSetRequest,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
    ...
    async postV3DbwOrdersStatus(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<PostV3DbwOrdersStatusResponse200>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.postV3DbwOrdersStatus(
          postV3DbwOrdersStatusRequest,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
     ...
     * @throws {RequiredError}
     */
    async postV3DbwOrdersStatusDeliver(
      apiOrdersRequestV2: ApiOrdersRequestV2,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.postV3DbwOrdersStatusDeliver(
          apiOrdersRequestV2,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
    ...
    async postV3DbwOrdersStickers(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<PostV3DbwOrdersStickersResponse200>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.postV3DbwOrdersStickers(
          type,
          width,
          height,
          postV3DbwOrdersStickersRequest,
     ...
     * @throws {RequiredError}
     */
    async putV3DbwOrdersOrderIdMetaGtin(
      orderId: number,
      putV3DbwOrdersOrderIdMetaGtinRequest: PutV3DbwOrdersOrderIdMetaGtinRequest,
      options?: RawAxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.putV3DbwOrdersOrderIdMetaGtin(
          orderId,
          putV3DbwOrdersOrderIdMetaGtinRequest,
          options,
        );
     ...
     * @throws {RequiredError}
     */
    async putV3DbwOrdersOrderIdMetaImei(
      orderId: number,
      putV3DbwOrdersOrderIdMetaImeiRequest: PutV3DbwOrdersOrderIdMetaImeiRequest,
      options?: RawAxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.putV3DbwOrdersOrderIdMetaImei(
          orderId,
          putV3DbwOrdersOrderIdMetaImeiRequest,
          options,
        );
     ...
     * @throws {RequiredError}
     */
    async putV3DbwOrdersOrderIdMetaUin(
      orderId: number,
      putV3DbwOrdersOrderIdMetaUinRequest: PutV3DbwOrdersOrderIdMetaUinRequest,
      options?: RawAxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.putV3DbwOrdersOrderIdMetaUin(
          orderId,
          putV3DbwOrdersOrderIdMetaUinRequest,
          options,
        );
...
export type PostV3DbwOrdersStickersTypeEnum =
  (typeof PostV3DbwOrdersStickersTypeEnum)[keyof typeof PostV3DbwOrdersStickersTypeEnum];
/**
 * @export
 */
...
export type PostV3DbwOrdersStickersWidthEnum =
  (typeof PostV3DbwOrdersStickersWidthEnum)[keyof typeof PostV3DbwOrdersStickersWidthEnum];
/**
 * @export
 */
...
export type PostV3DbwOrdersStickersHeightEnum =
  (typeof PostV3DbwOrdersStickersHeightEnum)[keyof typeof PostV3DbwOrdersStickersHeightEnum];
