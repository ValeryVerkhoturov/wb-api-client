...
func (o *PlanBuilderOption) GetPromotion() PlanBuilderOptionPromotion {
	if o == nil || IsNil(o.Promotion) {
		var ret PlanBuilderOptionPromotion
		return ret
	}
	return *o.Promotion
}
...
// and a boolean to check if the value has been set.
func (o *PlanBuilderOption) GetPromotionOk() (*PlanBuilderOptionPromotion, bool) {
	if o == nil || IsNil(o.Promotion) {
		return nil, false
	}
...
// SetPromotion gets a reference to the given PlanBuilderOptionPromotion and assigns it to the Promotion field.
func (o *PlanBuilderOption) SetPromotion(v PlanBuilderOptionPromotion) {
	o.Promotion = &v
}
