...
один из параметров `from` или `fromID`.
 За один запрос можно получить не более 100 новостей.[Лимит запросов](/openapi/api-information#tag/introduction/Limity-zaprosov) на один аккаунт продавца:
...
| Базовый | 1 ч | 1 запрос | 1 ч | 1 запрос |
	...
	*/
	...
	// GetV2NewsExecute executes the request
	//  @return GetV2NewsResponse200
	GetV2NewsExecute(r ApiGetV2NewsRequest) (*GetV2NewsResponse200, *http.Response, error)
}
...
func (r ApiGetV2NewsRequest) Execute() (*GetV2NewsResponse200, *http.Response, error) {
