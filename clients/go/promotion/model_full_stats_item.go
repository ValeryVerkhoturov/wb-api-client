...
func (o *FullStatsItem) GetBoosterStats() []FullStatsItemBoosterStatsInner {
	if o == nil || IsNil(o.BoosterStats) {
		var ret []FullStatsItemBoosterStatsInner
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FullStatsItem) GetBoosterStatsOk() ([]FullStatsItemBoosterStatsInner, bool) {
	if o == nil || IsNil(o.BoosterStats) {
		return nil, false
	}
...
// SetBoosterStats gets a reference to the given []FullStatsItemBoosterStatsInner and assigns it to the BoosterStats field.
func (o *FullStatsItem) SetBoosterStats(v []FullStatsItemBoosterStatsInner) {
	o.BoosterStats = v
}
