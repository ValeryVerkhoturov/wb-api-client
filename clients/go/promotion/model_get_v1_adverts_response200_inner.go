...
var _ MappedNullable = &GetV1AdvertsResponse200Inner{}

// GetV1AdvertsResponse200Inner struct for GetV1AdvertsResponse200Inner
type GetV1AdvertsResponse200Inner struct {
	// ID медиакампании
...
func NewGetV1AdvertsResponse200Inner() *GetV1AdvertsResponse200Inner {
	this := GetV1AdvertsResponse200Inner{}
	return &this
}

// NewGetV1AdvertsResponse200InnerWithDefaults instantiates a new GetV1AdvertsResponse200Inner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetV1AdvertsResponse200InnerWithDefaults() *GetV1AdvertsResponse200Inner {
	this := GetV1AdvertsResponse200Inner{}
	return &this
}

// GetAdvertId returns the AdvertId field value if set, zero value otherwise.
func (o *GetV1AdvertsResponse200Inner) GetAdvertId() int32 {
...
func (o *GetV1AdvertsResponse200Inner) GetAdvertIdOk() (*int32, bool) {
	if o == nil || IsNil(o.AdvertId) {
		return nil, false
	}
...
func (o *GetV1AdvertsResponse200Inner) HasAdvertId() bool {
	if o != nil && !IsNil(o.AdvertId) {
		return true
	}
...
func (o *GetV1AdvertsResponse200Inner) SetAdvertId(v int32) {
	o.AdvertId = &v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *GetV1AdvertsResponse200Inner) GetName() string {
...
// and a boolean to check if the value has been set.
func (o *GetV1AdvertsResponse200Inner) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *GetV1AdvertsResponse200Inner) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetV1AdvertsResponse200Inner) SetName(v string) {
	o.Name = &v
}

// GetBrand returns the Brand field value if set, zero value otherwise.
func (o *GetV1AdvertsResponse200Inner) GetBrand() string {
...
// and a boolean to check if the value has been set.
func (o *GetV1AdvertsResponse200Inner) GetBrandOk() (*string, bool) {
	if o == nil || IsNil(o.Brand) {
		return nil, false
	}
	return o.Brand, true
...
func (o *GetV1AdvertsResponse200Inner) HasBrand() bool {
	if o != nil && !IsNil(o.Brand) {
		return true
	}
...
func (o *GetV1AdvertsResponse200Inner) SetBrand(v string) {
	o.Brand = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *GetV1AdvertsResponse200Inner) GetType() int32 {
...
// and a boolean to check if the value has been set.
func (o *GetV1AdvertsResponse200Inner) GetTypeOk() (*int32, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *GetV1AdvertsResponse200Inner) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetV1AdvertsResponse200Inner) SetType(v int32) {
	o.Type = &v
}

// GetStatus returns the Status field value if set, zero value otherwise.
func (o *GetV1AdvertsResponse200Inner) GetStatus() int32 {
...
// and a boolean to check if the value has been set.
func (o *GetV1AdvertsResponse200Inner) GetStatusOk() (*int32, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *GetV1AdvertsResponse200Inner) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *GetV1AdvertsResponse200Inner) SetStatus(v int32) {
	o.Status = &v
}
...
func (o *GetV1AdvertsResponse200Inner) HasCreateTime() bool {
	if o != nil && !IsNil(o.CreateTime) {
		return true
	}
...
func (o *GetV1AdvertsResponse200Inner) HasEndTime() bool {
	if o != nil && !IsNil(o.EndTime) {
		return true
	}
...
func (o GetV1AdvertsResponse200Inner) ToMap() (map[string]interface{}, error) {
...
type NullableGetV1AdvertsResponse200Inner struct {
	value *GetV1AdvertsResponse200Inner
	isSet bool
}

func (v NullableGetV1AdvertsResponse200Inner) Get() *GetV1AdvertsResponse200Inner {
	return v.value
}

func (v *NullableGetV1AdvertsResponse200Inner) Set(val *GetV1AdvertsResponse200Inner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetV1AdvertsResponse200Inner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetV1AdvertsResponse200Inner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetV1AdvertsResponse200Inner(val *GetV1AdvertsResponse200Inner) *NullableGetV1AdvertsResponse200Inner {
	return &NullableGetV1AdvertsResponse200Inner{value: val, isSet: true}
}

func (v NullableGetV1AdvertsResponse200Inner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetV1AdvertsResponse200Inner) UnmarshalJSON(src []byte) error {
	v.isSet = true
