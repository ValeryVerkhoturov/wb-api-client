...
type StatsBlok2 struct {
	...
	DailyStats []StatsBlok2DailyStatsInner `json:"daily_stats,omitempty"`
...
func (o *StatsBlok2) GetDailyStats() []StatsBlok2DailyStatsInner {
	if o == nil || IsNil(o.DailyStats) {
		var ret []StatsBlok2DailyStatsInner
		return ret
	}
	return o.DailyStats
}
...
// and a boolean to check if the value has been set.
func (o *StatsBlok2) GetDailyStatsOk() ([]StatsBlok2DailyStatsInner, bool) {
	if o == nil || IsNil(o.DailyStats) {
		return nil, false
	}
...
// SetDailyStats gets a reference to the given []StatsBlok2DailyStatsInner and assigns it to the DailyStats field.
func (o *StatsBlok2) SetDailyStats(v []StatsBlok2DailyStatsInner) {
	o.DailyStats = v
}
