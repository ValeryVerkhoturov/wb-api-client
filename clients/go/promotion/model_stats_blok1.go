...
func (o *StatsBlok1) GetDailyStats() []StatsBlok1DailyStatsInner {
	if o == nil || IsNil(o.DailyStats) {
		var ret []StatsBlok1DailyStatsInner
		return ret
	}
	return o.DailyStats
}
...
// and a boolean to check if the value has been set.
func (o *StatsBlok1) GetDailyStatsOk() ([]StatsBlok1DailyStatsInner, bool) {
	if o == nil || IsNil(o.DailyStats) {
		return nil, false
	}
...
// SetDailyStats gets a reference to the given []StatsBlok1DailyStatsInner and assigns it to the DailyStats field.
func (o *StatsBlok1) SetDailyStats(v []StatsBlok1DailyStatsInner) {
	o.DailyStats = v
}
