...
// checks if the GetV1QuestionsCountResponse200 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetV1QuestionsCountResponse200{}

// GetV1QuestionsCountResponse200 struct for GetV1QuestionsCountResponse200
type GetV1QuestionsCountResponse200 struct {
	// Количество вопросов
...
// NewGetV1QuestionsCountResponse200 instantiates a new GetV1QuestionsCountResponse200 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetV1QuestionsCountResponse200() *GetV1QuestionsCountResponse200 {
	this := GetV1QuestionsCountResponse200{}
	return &this
}

// NewGetV1QuestionsCountResponse200WithDefaults instantiates a new GetV1QuestionsCountResponse200 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetV1QuestionsCountResponse200WithDefaults() *GetV1QuestionsCountResponse200 {
	this := GetV1QuestionsCountResponse200{}
	return &this
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *GetV1QuestionsCountResponse200) GetData() int32 {
...
func (o *GetV1QuestionsCountResponse200) GetDataOk() (*int32, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *GetV1QuestionsCountResponse200) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
func (o *GetV1QuestionsCountResponse200) SetData(v int32) {
	o.Data = &v
}

// GetError returns the Error field value if set, zero value otherwise.
func (o *GetV1QuestionsCountResponse200) GetError() bool {
...
// and a boolean to check if the value has been set.
func (o *GetV1QuestionsCountResponse200) GetErrorOk() (*bool, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
func (o *GetV1QuestionsCountResponse200) HasError() bool {
	if o != nil && !IsNil(o.Error) {
		return true
	}
...
func (o *GetV1QuestionsCountResponse200) SetError(v bool) {
	o.Error = &v
}

// GetErrorText returns the ErrorText field value if set, zero value otherwise.
func (o *GetV1QuestionsCountResponse200) GetErrorText() string {
...
// and a boolean to check if the value has been set.
func (o *GetV1QuestionsCountResponse200) GetErrorTextOk() (*string, bool) {
	if o == nil || IsNil(o.ErrorText) {
		return nil, false
	}
...
func (o *GetV1QuestionsCountResponse200) HasErrorText() bool {
	if o != nil && !IsNil(o.ErrorText) {
		return true
	}
...
func (o *GetV1QuestionsCountResponse200) SetErrorText(v string) {
	o.ErrorText = &v
}
...
func (o *GetV1QuestionsCountResponse200) GetAdditionalErrors() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
func (o *GetV1QuestionsCountResponse200) GetAdditionalErrorsOk() ([]string, bool) {
...
func (o *GetV1QuestionsCountResponse200) HasAdditionalErrors() bool {
	if o != nil && !IsNil(o.AdditionalErrors) {
		return true
	}
...
func (o *GetV1QuestionsCountResponse200) SetAdditionalErrors(v []string) {
	o.AdditionalErrors = v
}

func (o GetV1QuestionsCountResponse200) MarshalJSON() ([]byte, error) {
...
func (o GetV1QuestionsCountResponse200) ToMap() (map[string]interface{}, error) {
...
type NullableGetV1QuestionsCountResponse200 struct {
	value *GetV1QuestionsCountResponse200
	isSet bool
}

func (v NullableGetV1QuestionsCountResponse200) Get() *GetV1QuestionsCountResponse200 {
	return v.value
}

func (v *NullableGetV1QuestionsCountResponse200) Set(val *GetV1QuestionsCountResponse200) {
	v.value = val
	v.isSet = true
}

func (v NullableGetV1QuestionsCountResponse200) IsSet() bool {
	return v.isSet
}

func (v *NullableGetV1QuestionsCountResponse200) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetV1QuestionsCountResponse200(val *GetV1QuestionsCountResponse200) *NullableGetV1QuestionsCountResponse200 {
	return &NullableGetV1QuestionsCountResponse200{value: val, isSet: true}
}

func (v NullableGetV1QuestionsCountResponse200) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetV1QuestionsCountResponse200) UnmarshalJSON(src []byte) error {
	v.isSet = true
