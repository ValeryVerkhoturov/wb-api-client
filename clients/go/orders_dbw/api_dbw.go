...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// GetV3DbwOrdersExecute executes the request
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// GetV3DbwOrdersNewExecute executes the request
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// PatchV3DbwOrdersOrderIdCancelExecute executes the request
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// PatchV3DbwOrdersOrderIdConfirmExecute executes the request
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// PostV3DbwOrdersClientExecute executes the request
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// PostV3DbwOrdersCourierExecute executes the request
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// PostV3DbwOrdersDeliveryDateExecute executes the request
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// PostV3DbwOrdersMetaDeleteExecute executes the request
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// PostV3DbwOrdersMetaDetailsExecute executes the request
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// PostV3DbwOrdersMetaSgtinExecute executes the request
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// PostV3DbwOrdersStatusExecute executes the request
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// PostV3DbwOrdersStatusDeliverExecute executes the request
	//  @return ApiStatusSetResponses
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// PostV3DbwOrdersStickersExecute executes the request
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// PutV3DbwOrdersOrderIdMetaGtinExecute executes the request
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// PutV3DbwOrdersOrderIdMetaImeiExecute executes the request
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// PutV3DbwOrdersOrderIdMetaUinExecute executes the request
	PutV3DbwOrdersOrderIdMetaUinExecute(r ApiPutV3DbwOrdersOrderIdMetaUinRequest) (*http.Response, error)
}
...
func (r ApiGetV3DbwOrdersRequest) Execute() (*GetV3DbwOrdersResponse200, *http.Response, error) {
...
func (r ApiGetV3DbwOrdersNewRequest) Execute() (*GetV3DbwOrdersNewResponse200, *http.Response, error) {
...
func (a *DBWAPIService) PostV3DbwOrdersClientExecute(r ApiPostV3DbwOrdersClientRequest) (*ClientInfoResp, *http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v PostV3DbwOrdersClientResponse400
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (r ApiPostV3DbwOrdersMetaDeleteRequest) Execute() (*PostV3DbwOrdersMetaDeleteResponse200, *http.Response, error) {
...
func (r ApiPostV3DbwOrdersStatusRequest) Execute() (*PostV3DbwOrdersStatusResponse200, *http.Response, error) {
...
func (r ApiPostV3DbwOrdersStickersRequest) Execute() (*PostV3DbwOrdersStickersResponse200, *http.Response, error) {
