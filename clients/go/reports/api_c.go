...
Данный отчёт можно сохранить в [формате таблиц](/knowledge-base/articles/019d49a4-650c-7b04-9596-ba441936f9d3).[Лимит запросов](/openapi/api-information#tag/introduction/Limity-zaprosov) на один аккаунт продавца:
...
| Базовый | 24 ч | 2 запроса | 12 ч | 1 запрос |
	...
	*/
	...
	// PostV1AnalyticsExciseReportExecute executes the request
	//  @return ExciseReportResponse
	PostV1AnalyticsExciseReportExecute(r ApiPostV1AnalyticsExciseReportRequest) (*ExciseReportResponse, *http.Response, error)
}
