...
// checks if the GetV2TagsResponse200 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetV2TagsResponse200{}

// GetV2TagsResponse200 struct for GetV2TagsResponse200
type GetV2TagsResponse200 struct {
	Data *GetV2TagsResponse200Data `json:"data,omitempty"`
	// Флаг ошибки
...
// NewGetV2TagsResponse200 instantiates a new GetV2TagsResponse200 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetV2TagsResponse200() *GetV2TagsResponse200 {
	this := GetV2TagsResponse200{}
	return &this
}

// NewGetV2TagsResponse200WithDefaults instantiates a new GetV2TagsResponse200 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetV2TagsResponse200WithDefaults() *GetV2TagsResponse200 {
	this := GetV2TagsResponse200{}
	return &this
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *GetV2TagsResponse200) GetData() GetV2TagsResponse200Data {
	if o == nil || IsNil(o.Data) {
		var ret GetV2TagsResponse200Data
		return ret
	}
	return *o.Data
}
...
func (o *GetV2TagsResponse200) GetDataOk() (*GetV2TagsResponse200Data, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *GetV2TagsResponse200) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
// SetData gets a reference to the given GetV2TagsResponse200Data and assigns it to the Data field.
func (o *GetV2TagsResponse200) SetData(v GetV2TagsResponse200Data) {
	o.Data = &v
}

// GetError returns the Error field value if set, zero value otherwise.
func (o *GetV2TagsResponse200) GetError() bool {
...
// and a boolean to check if the value has been set.
func (o *GetV2TagsResponse200) GetErrorOk() (*bool, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
func (o *GetV2TagsResponse200) HasError() bool {
	if o != nil && !IsNil(o.Error) {
		return true
	}
...
func (o *GetV2TagsResponse200) SetError(v bool) {
	o.Error = &v
}

// GetErrorText returns the ErrorText field value if set, zero value otherwise.
func (o *GetV2TagsResponse200) GetErrorText() string {
...
// and a boolean to check if the value has been set.
func (o *GetV2TagsResponse200) GetErrorTextOk() (*string, bool) {
	if o == nil || IsNil(o.ErrorText) {
		return nil, false
	}
...
func (o *GetV2TagsResponse200) HasErrorText() bool {
	if o != nil && !IsNil(o.ErrorText) {
		return true
	}
...
func (o *GetV2TagsResponse200) SetErrorText(v string) {
	o.ErrorText = &v
}
...
func (o *GetV2TagsResponse200) GetAdditionalErrors() string {
...
func (o *GetV2TagsResponse200) GetAdditionalErrorsOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetV2TagsResponse200) HasAdditionalErrors() bool {
...
func (o *GetV2TagsResponse200) SetAdditionalErrors(v string) {
	o.AdditionalErrors.Set(&v)
}
// SetAdditionalErrorsNil sets the value for AdditionalErrors to be an explicit nil
func (o *GetV2TagsResponse200) SetAdditionalErrorsNil() {
...
func (o *GetV2TagsResponse200) UnsetAdditionalErrors() {
	o.AdditionalErrors.Unset()
}

func (o GetV2TagsResponse200) MarshalJSON() ([]byte, error) {
...
func (o GetV2TagsResponse200) ToMap() (map[string]interface{}, error) {
...
type NullableGetV2TagsResponse200 struct {
	value *GetV2TagsResponse200
	isSet bool
}

func (v NullableGetV2TagsResponse200) Get() *GetV2TagsResponse200 {
	return v.value
}

func (v *NullableGetV2TagsResponse200) Set(val *GetV2TagsResponse200) {
	v.value = val
	v.isSet = true
}

func (v NullableGetV2TagsResponse200) IsSet() bool {
	return v.isSet
}

func (v *NullableGetV2TagsResponse200) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetV2TagsResponse200(val *GetV2TagsResponse200) *NullableGetV2TagsResponse200 {
	return &NullableGetV2TagsResponse200{value: val, isSet: true}
}

func (v NullableGetV2TagsResponse200) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetV2TagsResponse200) UnmarshalJSON(src []byte) error {
	v.isSet = true
