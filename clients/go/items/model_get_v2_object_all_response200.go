...
// checks if the GetV2ObjectAllResponse200 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetV2ObjectAllResponse200{}

// GetV2ObjectAllResponse200 struct for GetV2ObjectAllResponse200
type GetV2ObjectAllResponse200 struct {
	// Предметы
	Data []GetV2ObjectAllResponse200DataInner `json:"data,omitempty"`
	// Флаг наличия ошибки
...
// NewGetV2ObjectAllResponse200 instantiates a new GetV2ObjectAllResponse200 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetV2ObjectAllResponse200() *GetV2ObjectAllResponse200 {
	this := GetV2ObjectAllResponse200{}
	return &this
}

// NewGetV2ObjectAllResponse200WithDefaults instantiates a new GetV2ObjectAllResponse200 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetV2ObjectAllResponse200WithDefaults() *GetV2ObjectAllResponse200 {
	this := GetV2ObjectAllResponse200{}
	return &this
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *GetV2ObjectAllResponse200) GetData() []GetV2ObjectAllResponse200DataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetV2ObjectAllResponse200DataInner
		return ret
	}
	return o.Data
}
...
func (o *GetV2ObjectAllResponse200) GetDataOk() ([]GetV2ObjectAllResponse200DataInner, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *GetV2ObjectAllResponse200) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
// SetData gets a reference to the given []GetV2ObjectAllResponse200DataInner and assigns it to the Data field.
func (o *GetV2ObjectAllResponse200) SetData(v []GetV2ObjectAllResponse200DataInner) {
	o.Data = v
}

// GetError returns the Error field value if set, zero value otherwise.
func (o *GetV2ObjectAllResponse200) GetError() bool {
...
// and a boolean to check if the value has been set.
func (o *GetV2ObjectAllResponse200) GetErrorOk() (*bool, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
func (o *GetV2ObjectAllResponse200) HasError() bool {
	if o != nil && !IsNil(o.Error) {
		return true
	}
...
func (o *GetV2ObjectAllResponse200) SetError(v bool) {
	o.Error = &v
}

// GetErrorText returns the ErrorText field value if set, zero value otherwise.
func (o *GetV2ObjectAllResponse200) GetErrorText() string {
...
// and a boolean to check if the value has been set.
func (o *GetV2ObjectAllResponse200) GetErrorTextOk() (*string, bool) {
	if o == nil || IsNil(o.ErrorText) {
		return nil, false
	}
...
func (o *GetV2ObjectAllResponse200) HasErrorText() bool {
	if o != nil && !IsNil(o.ErrorText) {
		return true
	}
...
func (o *GetV2ObjectAllResponse200) SetErrorText(v string) {
	o.ErrorText = &v
}
...
func (o *GetV2ObjectAllResponse200) GetAdditionalErrors() string {
...
func (o *GetV2ObjectAllResponse200) GetAdditionalErrorsOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetV2ObjectAllResponse200) HasAdditionalErrors() bool {
...
func (o *GetV2ObjectAllResponse200) SetAdditionalErrors(v string) {
	o.AdditionalErrors.Set(&v)
}
// SetAdditionalErrorsNil sets the value for AdditionalErrors to be an explicit nil
func (o *GetV2ObjectAllResponse200) SetAdditionalErrorsNil() {
...
func (o *GetV2ObjectAllResponse200) UnsetAdditionalErrors() {
	o.AdditionalErrors.Unset()
}

func (o GetV2ObjectAllResponse200) MarshalJSON() ([]byte, error) {
...
func (o GetV2ObjectAllResponse200) ToMap() (map[string]interface{}, error) {
...
type NullableGetV2ObjectAllResponse200 struct {
	value *GetV2ObjectAllResponse200
	isSet bool
}

func (v NullableGetV2ObjectAllResponse200) Get() *GetV2ObjectAllResponse200 {
	return v.value
}

func (v *NullableGetV2ObjectAllResponse200) Set(val *GetV2ObjectAllResponse200) {
	v.value = val
	v.isSet = true
}

func (v NullableGetV2ObjectAllResponse200) IsSet() bool {
	return v.isSet
}

func (v *NullableGetV2ObjectAllResponse200) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetV2ObjectAllResponse200(val *GetV2ObjectAllResponse200) *NullableGetV2ObjectAllResponse200 {
	return &NullableGetV2ObjectAllResponse200{value: val, isSet: true}
}

func (v NullableGetV2ObjectAllResponse200) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetV2ObjectAllResponse200) UnmarshalJSON(src []byte) error {
	v.isSet = true
