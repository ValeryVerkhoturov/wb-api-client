...
// checks if the GetV2DirectoryKindsResponse200 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetV2DirectoryKindsResponse200{}

// GetV2DirectoryKindsResponse200 struct for GetV2DirectoryKindsResponse200
type GetV2DirectoryKindsResponse200 struct {
...
// NewGetV2DirectoryKindsResponse200 instantiates a new GetV2DirectoryKindsResponse200 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetV2DirectoryKindsResponse200() *GetV2DirectoryKindsResponse200 {
	this := GetV2DirectoryKindsResponse200{}
	return &this
}

// NewGetV2DirectoryKindsResponse200WithDefaults instantiates a new GetV2DirectoryKindsResponse200 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetV2DirectoryKindsResponse200WithDefaults() *GetV2DirectoryKindsResponse200 {
	this := GetV2DirectoryKindsResponse200{}
	return &this
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *GetV2DirectoryKindsResponse200) GetData() []string {
...
func (o *GetV2DirectoryKindsResponse200) GetDataOk() ([]string, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *GetV2DirectoryKindsResponse200) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
func (o *GetV2DirectoryKindsResponse200) SetData(v []string) {
	o.Data = v
}

// GetError returns the Error field value if set, zero value otherwise.
func (o *GetV2DirectoryKindsResponse200) GetError() bool {
...
// and a boolean to check if the value has been set.
func (o *GetV2DirectoryKindsResponse200) GetErrorOk() (*bool, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
func (o *GetV2DirectoryKindsResponse200) HasError() bool {
	if o != nil && !IsNil(o.Error) {
		return true
	}
...
func (o *GetV2DirectoryKindsResponse200) SetError(v bool) {
	o.Error = &v
}

// GetErrorText returns the ErrorText field value if set, zero value otherwise.
func (o *GetV2DirectoryKindsResponse200) GetErrorText() string {
...
// and a boolean to check if the value has been set.
func (o *GetV2DirectoryKindsResponse200) GetErrorTextOk() (*string, bool) {
	if o == nil || IsNil(o.ErrorText) {
		return nil, false
	}
...
func (o *GetV2DirectoryKindsResponse200) HasErrorText() bool {
	if o != nil && !IsNil(o.ErrorText) {
		return true
	}
...
func (o *GetV2DirectoryKindsResponse200) SetErrorText(v string) {
	o.ErrorText = &v
}
...
func (o *GetV2DirectoryKindsResponse200) GetAdditionalErrors() string {
...
func (o *GetV2DirectoryKindsResponse200) GetAdditionalErrorsOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetV2DirectoryKindsResponse200) HasAdditionalErrors() bool {
...
func (o *GetV2DirectoryKindsResponse200) SetAdditionalErrors(v string) {
	o.AdditionalErrors.Set(&v)
}

// SetAdditionalErrorsNil sets the value for AdditionalErrors to be an explicit nil
func (o *GetV2DirectoryKindsResponse200) SetAdditionalErrorsNil() {
...
func (o *GetV2DirectoryKindsResponse200) UnsetAdditionalErrors() {
	o.AdditionalErrors.Unset()
}

func (o GetV2DirectoryKindsResponse200) MarshalJSON() ([]byte, error) {
...
func (o GetV2DirectoryKindsResponse200) ToMap() (map[string]interface{}, error) {
...
type NullableGetV2DirectoryKindsResponse200 struct {
	value *GetV2DirectoryKindsResponse200
	isSet bool
}

func (v NullableGetV2DirectoryKindsResponse200) Get() *GetV2DirectoryKindsResponse200 {
	return v.value
}

func (v *NullableGetV2DirectoryKindsResponse200) Set(val *GetV2DirectoryKindsResponse200) {
	v.value = val
	v.isSet = true
}

func (v NullableGetV2DirectoryKindsResponse200) IsSet() bool {
	return v.isSet
}

func (v *NullableGetV2DirectoryKindsResponse200) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetV2DirectoryKindsResponse200(val *GetV2DirectoryKindsResponse200) *NullableGetV2DirectoryKindsResponse200 {
	return &NullableGetV2DirectoryKindsResponse200{value: val, isSet: true}
}

func (v NullableGetV2DirectoryKindsResponse200) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetV2DirectoryKindsResponse200) UnmarshalJSON(src []byte) error {
	v.isSet = true
