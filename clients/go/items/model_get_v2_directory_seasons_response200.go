...
// checks if the GetV2DirectorySeasonsResponse200 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetV2DirectorySeasonsResponse200{}

// GetV2DirectorySeasonsResponse200 struct for GetV2DirectorySeasonsResponse200
type GetV2DirectorySeasonsResponse200 struct {
...
// NewGetV2DirectorySeasonsResponse200 instantiates a new GetV2DirectorySeasonsResponse200 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetV2DirectorySeasonsResponse200() *GetV2DirectorySeasonsResponse200 {
	this := GetV2DirectorySeasonsResponse200{}
	return &this
}

// NewGetV2DirectorySeasonsResponse200WithDefaults instantiates a new GetV2DirectorySeasonsResponse200 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetV2DirectorySeasonsResponse200WithDefaults() *GetV2DirectorySeasonsResponse200 {
	this := GetV2DirectorySeasonsResponse200{}
	return &this
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *GetV2DirectorySeasonsResponse200) GetData() []string {
...
func (o *GetV2DirectorySeasonsResponse200) GetDataOk() ([]string, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *GetV2DirectorySeasonsResponse200) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
func (o *GetV2DirectorySeasonsResponse200) SetData(v []string) {
	o.Data = v
}

// GetError returns the Error field value if set, zero value otherwise.
func (o *GetV2DirectorySeasonsResponse200) GetError() bool {
...
// and a boolean to check if the value has been set.
func (o *GetV2DirectorySeasonsResponse200) GetErrorOk() (*bool, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
func (o *GetV2DirectorySeasonsResponse200) HasError() bool {
	if o != nil && !IsNil(o.Error) {
		return true
	}
...
func (o *GetV2DirectorySeasonsResponse200) SetError(v bool) {
	o.Error = &v
}

// GetErrorText returns the ErrorText field value if set, zero value otherwise.
func (o *GetV2DirectorySeasonsResponse200) GetErrorText() string {
...
// and a boolean to check if the value has been set.
func (o *GetV2DirectorySeasonsResponse200) GetErrorTextOk() (*string, bool) {
	if o == nil || IsNil(o.ErrorText) {
		return nil, false
	}
...
func (o *GetV2DirectorySeasonsResponse200) HasErrorText() bool {
	if o != nil && !IsNil(o.ErrorText) {
		return true
	}
...
func (o *GetV2DirectorySeasonsResponse200) SetErrorText(v string) {
	o.ErrorText = &v
}
...
func (o *GetV2DirectorySeasonsResponse200) GetAdditionalErrors() string {
...
func (o *GetV2DirectorySeasonsResponse200) GetAdditionalErrorsOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetV2DirectorySeasonsResponse200) HasAdditionalErrors() bool {
...
func (o *GetV2DirectorySeasonsResponse200) SetAdditionalErrors(v string) {
	o.AdditionalErrors.Set(&v)
}
// SetAdditionalErrorsNil sets the value for AdditionalErrors to be an explicit nil
func (o *GetV2DirectorySeasonsResponse200) SetAdditionalErrorsNil() {
...
func (o *GetV2DirectorySeasonsResponse200) UnsetAdditionalErrors() {
	o.AdditionalErrors.Unset()
}

func (o GetV2DirectorySeasonsResponse200) MarshalJSON() ([]byte, error) {
...
func (o GetV2DirectorySeasonsResponse200) ToMap() (map[string]interface{}, error) {
...
type NullableGetV2DirectorySeasonsResponse200 struct {
	value *GetV2DirectorySeasonsResponse200
	isSet bool
}

func (v NullableGetV2DirectorySeasonsResponse200) Get() *GetV2DirectorySeasonsResponse200 {
	return v.value
}

func (v *NullableGetV2DirectorySeasonsResponse200) Set(val *GetV2DirectorySeasonsResponse200) {
	v.value = val
	v.isSet = true
}

func (v NullableGetV2DirectorySeasonsResponse200) IsSet() bool {
	return v.isSet
}

func (v *NullableGetV2DirectorySeasonsResponse200) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetV2DirectorySeasonsResponse200(val *GetV2DirectorySeasonsResponse200) *NullableGetV2DirectorySeasonsResponse200 {
	return &NullableGetV2DirectorySeasonsResponse200{value: val, isSet: true}
}

func (v NullableGetV2DirectorySeasonsResponse200) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetV2DirectorySeasonsResponse200) UnmarshalJSON(src []byte) error {
	v.isSet = true
