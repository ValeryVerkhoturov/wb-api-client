...
// checks if the PostV2BarcodesResponse200 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostV2BarcodesResponse200{}

// PostV2BarcodesResponse200 struct for PostV2BarcodesResponse200
type PostV2BarcodesResponse200 struct {
...
// NewPostV2BarcodesResponse200 instantiates a new PostV2BarcodesResponse200 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPostV2BarcodesResponse200() *PostV2BarcodesResponse200 {
	this := PostV2BarcodesResponse200{}
	return &this
}

// NewPostV2BarcodesResponse200WithDefaults instantiates a new PostV2BarcodesResponse200 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPostV2BarcodesResponse200WithDefaults() *PostV2BarcodesResponse200 {
	this := PostV2BarcodesResponse200{}
	return &this
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *PostV2BarcodesResponse200) GetData() []string {
...
func (o *PostV2BarcodesResponse200) GetDataOk() ([]string, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *PostV2BarcodesResponse200) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
func (o *PostV2BarcodesResponse200) SetData(v []string) {
	o.Data = v
}

// GetError returns the Error field value if set, zero value otherwise.
func (o *PostV2BarcodesResponse200) GetError() bool {
...
// and a boolean to check if the value has been set.
func (o *PostV2BarcodesResponse200) GetErrorOk() (*bool, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
func (o *PostV2BarcodesResponse200) HasError() bool {
	if o != nil && !IsNil(o.Error) {
		return true
	}
...
func (o *PostV2BarcodesResponse200) SetError(v bool) {
	o.Error = &v
}

// GetErrorText returns the ErrorText field value if set, zero value otherwise.
func (o *PostV2BarcodesResponse200) GetErrorText() string {
...
// and a boolean to check if the value has been set.
func (o *PostV2BarcodesResponse200) GetErrorTextOk() (*string, bool) {
	if o == nil || IsNil(o.ErrorText) {
		return nil, false
	}
...
func (o *PostV2BarcodesResponse200) HasErrorText() bool {
	if o != nil && !IsNil(o.ErrorText) {
		return true
	}
...
func (o *PostV2BarcodesResponse200) SetErrorText(v string) {
	o.ErrorText = &v
}
...
func (o *PostV2BarcodesResponse200) GetAdditionalErrors() string {
...
func (o *PostV2BarcodesResponse200) GetAdditionalErrorsOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PostV2BarcodesResponse200) HasAdditionalErrors() bool {
...
func (o *PostV2BarcodesResponse200) SetAdditionalErrors(v string) {
	o.AdditionalErrors.Set(&v)
}
// SetAdditionalErrorsNil sets the value for AdditionalErrors to be an explicit nil
func (o *PostV2BarcodesResponse200) SetAdditionalErrorsNil() {
...
func (o *PostV2BarcodesResponse200) UnsetAdditionalErrors() {
	o.AdditionalErrors.Unset()
}

func (o PostV2BarcodesResponse200) MarshalJSON() ([]byte, error) {
...
func (o PostV2BarcodesResponse200) ToMap() (map[string]interface{}, error) {
...
type NullablePostV2BarcodesResponse200 struct {
	value *PostV2BarcodesResponse200
	isSet bool
}

func (v NullablePostV2BarcodesResponse200) Get() *PostV2BarcodesResponse200 {
	return v.value
}

func (v *NullablePostV2BarcodesResponse200) Set(val *PostV2BarcodesResponse200) {
	v.value = val
	v.isSet = true
}

func (v NullablePostV2BarcodesResponse200) IsSet() bool {
	return v.isSet
}

func (v *NullablePostV2BarcodesResponse200) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostV2BarcodesResponse200(val *PostV2BarcodesResponse200) *NullablePostV2BarcodesResponse200 {
	return &NullablePostV2BarcodesResponse200{value: val, isSet: true}
}

func (v NullablePostV2BarcodesResponse200) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostV2BarcodesResponse200) UnmarshalJSON(src []byte) error {
	v.isSet = true
