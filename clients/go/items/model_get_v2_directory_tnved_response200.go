...
// checks if the GetV2DirectoryTnvedResponse200 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetV2DirectoryTnvedResponse200{}

// GetV2DirectoryTnvedResponse200 struct for GetV2DirectoryTnvedResponse200
type GetV2DirectoryTnvedResponse200 struct {
	// Данные
	Data []GetV2DirectoryTnvedResponse200DataInner `json:"data,omitempty"`
	// Флаг наличия ошибки
...
// NewGetV2DirectoryTnvedResponse200 instantiates a new GetV2DirectoryTnvedResponse200 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetV2DirectoryTnvedResponse200() *GetV2DirectoryTnvedResponse200 {
	this := GetV2DirectoryTnvedResponse200{}
	return &this
}

// NewGetV2DirectoryTnvedResponse200WithDefaults instantiates a new GetV2DirectoryTnvedResponse200 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetV2DirectoryTnvedResponse200WithDefaults() *GetV2DirectoryTnvedResponse200 {
	this := GetV2DirectoryTnvedResponse200{}
	return &this
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *GetV2DirectoryTnvedResponse200) GetData() []GetV2DirectoryTnvedResponse200DataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetV2DirectoryTnvedResponse200DataInner
		return ret
	}
	return o.Data
}
...
func (o *GetV2DirectoryTnvedResponse200) GetDataOk() ([]GetV2DirectoryTnvedResponse200DataInner, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *GetV2DirectoryTnvedResponse200) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
// SetData gets a reference to the given []GetV2DirectoryTnvedResponse200DataInner and assigns it to the Data field.
func (o *GetV2DirectoryTnvedResponse200) SetData(v []GetV2DirectoryTnvedResponse200DataInner) {
	o.Data = v
}

// GetError returns the Error field value if set, zero value otherwise.
func (o *GetV2DirectoryTnvedResponse200) GetError() bool {
...
// and a boolean to check if the value has been set.
func (o *GetV2DirectoryTnvedResponse200) GetErrorOk() (*bool, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
func (o *GetV2DirectoryTnvedResponse200) HasError() bool {
	if o != nil && !IsNil(o.Error) {
		return true
	}
...
func (o *GetV2DirectoryTnvedResponse200) SetError(v bool) {
	o.Error = &v
}

// GetErrorText returns the ErrorText field value if set, zero value otherwise.
func (o *GetV2DirectoryTnvedResponse200) GetErrorText() string {
...
// and a boolean to check if the value has been set.
func (o *GetV2DirectoryTnvedResponse200) GetErrorTextOk() (*string, bool) {
	if o == nil || IsNil(o.ErrorText) {
		return nil, false
	}
...
func (o *GetV2DirectoryTnvedResponse200) HasErrorText() bool {
	if o != nil && !IsNil(o.ErrorText) {
		return true
	}
...
func (o *GetV2DirectoryTnvedResponse200) SetErrorText(v string) {
	o.ErrorText = &v
}
...
func (o *GetV2DirectoryTnvedResponse200) GetAdditionalErrors() string {
...
func (o *GetV2DirectoryTnvedResponse200) GetAdditionalErrorsOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetV2DirectoryTnvedResponse200) HasAdditionalErrors() bool {
...
func (o *GetV2DirectoryTnvedResponse200) UnsetAdditionalErrors() {
...
func (o GetV2DirectoryTnvedResponse200) ToMap() (map[string]interface{}, error) {
...
type NullableGetV2DirectoryTnvedResponse200 struct {
	value *GetV2DirectoryTnvedResponse200
	isSet bool
}

func (v NullableGetV2DirectoryTnvedResponse200) Get() *GetV2DirectoryTnvedResponse200 {
	return v.value
}

func (v *NullableGetV2DirectoryTnvedResponse200) Set(val *GetV2DirectoryTnvedResponse200) {
	v.value = val
	v.isSet = true
}

func (v NullableGetV2DirectoryTnvedResponse200) IsSet() bool {
	return v.isSet
}

func (v *NullableGetV2DirectoryTnvedResponse200) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetV2DirectoryTnvedResponse200(val *GetV2DirectoryTnvedResponse200) *NullableGetV2DirectoryTnvedResponse200 {
	return &NullableGetV2DirectoryTnvedResponse200{value: val, isSet: true}
}

func (v NullableGetV2DirectoryTnvedResponse200) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetV2DirectoryTnvedResponse200) UnmarshalJSON(src []byte) error {
	v.isSet = true
