...
// checks if the PostV3MediaSaveResponse200 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostV3MediaSaveResponse200{}

// PostV3MediaSaveResponse200 struct for PostV3MediaSaveResponse200
type PostV3MediaSaveResponse200 struct {
...
// NewPostV3MediaSaveResponse200 instantiates a new PostV3MediaSaveResponse200 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPostV3MediaSaveResponse200() *PostV3MediaSaveResponse200 {
	this := PostV3MediaSaveResponse200{}
	return &this
}

// NewPostV3MediaSaveResponse200WithDefaults instantiates a new PostV3MediaSaveResponse200 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPostV3MediaSaveResponse200WithDefaults() *PostV3MediaSaveResponse200 {
	this := PostV3MediaSaveResponse200{}
	return &this
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *PostV3MediaSaveResponse200) GetData() map[string]interface{} {
...
func (o *PostV3MediaSaveResponse200) GetDataOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Data) {
...
func (o *PostV3MediaSaveResponse200) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
func (o *PostV3MediaSaveResponse200) SetData(v map[string]interface{}) {
	o.Data = v
}

// GetError returns the Error field value if set, zero value otherwise.
func (o *PostV3MediaSaveResponse200) GetError() bool {
...
// and a boolean to check if the value has been set.
func (o *PostV3MediaSaveResponse200) GetErrorOk() (*bool, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
func (o *PostV3MediaSaveResponse200) HasError() bool {
	if o != nil && !IsNil(o.Error) {
		return true
	}
...
func (o *PostV3MediaSaveResponse200) SetError(v bool) {
	o.Error = &v
}

// GetErrorText returns the ErrorText field value if set, zero value otherwise.
func (o *PostV3MediaSaveResponse200) GetErrorText() string {
...
// and a boolean to check if the value has been set.
func (o *PostV3MediaSaveResponse200) GetErrorTextOk() (*string, bool) {
	if o == nil || IsNil(o.ErrorText) {
		return nil, false
	}
...
func (o *PostV3MediaSaveResponse200) HasErrorText() bool {
	if o != nil && !IsNil(o.ErrorText) {
		return true
	}
...
func (o *PostV3MediaSaveResponse200) SetErrorText(v string) {
	o.ErrorText = &v
}
...
func (o *PostV3MediaSaveResponse200) GetAdditionalErrors() map[string]interface{} {
	if o == nil {
		var ret map[string]interface{}
		return ret
	}
...
func (o *PostV3MediaSaveResponse200) GetAdditionalErrorsOk() (map[string]interface{}, bool) {
...
func (o *PostV3MediaSaveResponse200) HasAdditionalErrors() bool {
	if o != nil && !IsNil(o.AdditionalErrors) {
		return true
	}
...
func (o *PostV3MediaSaveResponse200) SetAdditionalErrors(v map[string]interface{}) {
	o.AdditionalErrors = v
}

func (o PostV3MediaSaveResponse200) MarshalJSON() ([]byte, error) {
...
func (o PostV3MediaSaveResponse200) ToMap() (map[string]interface{}, error) {
...
type NullablePostV3MediaSaveResponse200 struct {
	value *PostV3MediaSaveResponse200
	isSet bool
}

func (v NullablePostV3MediaSaveResponse200) Get() *PostV3MediaSaveResponse200 {
	return v.value
}

func (v *NullablePostV3MediaSaveResponse200) Set(val *PostV3MediaSaveResponse200) {
	v.value = val
	v.isSet = true
}

func (v NullablePostV3MediaSaveResponse200) IsSet() bool {
	return v.isSet
}

func (v *NullablePostV3MediaSaveResponse200) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostV3MediaSaveResponse200(val *PostV3MediaSaveResponse200) *NullablePostV3MediaSaveResponse200 {
	return &NullablePostV3MediaSaveResponse200{value: val, isSet: true}
}

func (v NullablePostV3MediaSaveResponse200) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostV3MediaSaveResponse200) UnmarshalJSON(src []byte) error {
	v.isSet = true
