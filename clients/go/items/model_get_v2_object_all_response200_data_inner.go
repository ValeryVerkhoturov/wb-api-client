...
// checks if the GetV2ObjectAllResponse200DataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetV2ObjectAllResponse200DataInner{}

// GetV2ObjectAllResponse200DataInner struct for GetV2ObjectAllResponse200DataInner
type GetV2ObjectAllResponse200DataInner struct {
	// ID предмета
...
// NewGetV2ObjectAllResponse200DataInner instantiates a new GetV2ObjectAllResponse200DataInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetV2ObjectAllResponse200DataInner() *GetV2ObjectAllResponse200DataInner {
	this := GetV2ObjectAllResponse200DataInner{}
	return &this
}

// NewGetV2ObjectAllResponse200DataInnerWithDefaults instantiates a new GetV2ObjectAllResponse200DataInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetV2ObjectAllResponse200DataInnerWithDefaults() *GetV2ObjectAllResponse200DataInner {
	this := GetV2ObjectAllResponse200DataInner{}
	return &this
}

// GetSubjectID returns the SubjectID field value if set, zero value otherwise.
func (o *GetV2ObjectAllResponse200DataInner) GetSubjectID() int32 {
...
func (o *GetV2ObjectAllResponse200DataInner) GetSubjectIDOk() (*int32, bool) {
	if o == nil || IsNil(o.SubjectID) {
		return nil, false
	}
...
func (o *GetV2ObjectAllResponse200DataInner) HasSubjectID() bool {
	if o != nil && !IsNil(o.SubjectID) {
		return true
	}
...
func (o *GetV2ObjectAllResponse200DataInner) SetSubjectID(v int32) {
	o.SubjectID = &v
}

// GetParentID returns the ParentID field value if set, zero value otherwise.
func (o *GetV2ObjectAllResponse200DataInner) GetParentID() int32 {
...
// and a boolean to check if the value has been set.
func (o *GetV2ObjectAllResponse200DataInner) GetParentIDOk() (*int32, bool) {
	if o == nil || IsNil(o.ParentID) {
		return nil, false
	}
...
func (o *GetV2ObjectAllResponse200DataInner) HasParentID() bool {
	if o != nil && !IsNil(o.ParentID) {
		return true
	}
...
func (o *GetV2ObjectAllResponse200DataInner) SetParentID(v int32) {
	o.ParentID = &v
}

// GetSubjectName returns the SubjectName field value if set, zero value otherwise.
func (o *GetV2ObjectAllResponse200DataInner) GetSubjectName() string {
...
// and a boolean to check if the value has been set.
func (o *GetV2ObjectAllResponse200DataInner) GetSubjectNameOk() (*string, bool) {
	if o == nil || IsNil(o.SubjectName) {
		return nil, false
	}
...
func (o *GetV2ObjectAllResponse200DataInner) HasSubjectName() bool {
	if o != nil && !IsNil(o.SubjectName) {
		return true
	}
...
func (o *GetV2ObjectAllResponse200DataInner) SetSubjectName(v string) {
	o.SubjectName = &v
}

// GetParentName returns the ParentName field value if set, zero value otherwise.
func (o *GetV2ObjectAllResponse200DataInner) GetParentName() string {
...
// and a boolean to check if the value has been set.
func (o *GetV2ObjectAllResponse200DataInner) GetParentNameOk() (*string, bool) {
	if o == nil || IsNil(o.ParentName) {
		return nil, false
	}
...
func (o *GetV2ObjectAllResponse200DataInner) HasParentName() bool {
	if o != nil && !IsNil(o.ParentName) {
		return true
	}
...
func (o *GetV2ObjectAllResponse200DataInner) SetParentName(v string) {
	o.ParentName = &v
}
...
func (o GetV2ObjectAllResponse200DataInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetV2ObjectAllResponse200DataInner struct {
	value *GetV2ObjectAllResponse200DataInner
	isSet bool
}

func (v NullableGetV2ObjectAllResponse200DataInner) Get() *GetV2ObjectAllResponse200DataInner {
	return v.value
}

func (v *NullableGetV2ObjectAllResponse200DataInner) Set(val *GetV2ObjectAllResponse200DataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetV2ObjectAllResponse200DataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetV2ObjectAllResponse200DataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetV2ObjectAllResponse200DataInner(val *GetV2ObjectAllResponse200DataInner) *NullableGetV2ObjectAllResponse200DataInner {
	return &NullableGetV2ObjectAllResponse200DataInner{value: val, isSet: true}
}

func (v NullableGetV2ObjectAllResponse200DataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetV2ObjectAllResponse200DataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
