...
// checks if the Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner{}

// Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner struct for Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner
type Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner struct {
...
// NewHttp409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner instantiates a new Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewHttp409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner() *Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner {
	this := Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner{}
	return &this
}

// NewHttp409SupplyDeliverErrorDataOrdersInnerMetaDetailsInnerWithDefaults instantiates a new Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewHttp409SupplyDeliverErrorDataOrdersInnerMetaDetailsInnerWithDefaults() *Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner {
	this := Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner{}
	return &this
}

// GetKey returns the Key field value if set, zero value otherwise.
func (o *Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) GetKey() string {
...
func (o *Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) GetKeyOk() (*string, bool) {
	if o == nil || IsNil(o.Key) {
		return nil, false
	}
	return o.Key, true
...
func (o *Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) HasKey() bool {
	if o != nil && !IsNil(o.Key) {
		return true
	}
...
func (o *Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) SetKey(v string) {
	o.Key = &v
}

// GetValue returns the Value field value if set, zero value otherwise.
func (o *Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) GetValue() string {
...
// and a boolean to check if the value has been set.
func (o *Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) GetValueOk() (*string, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
func (o *Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) HasValue() bool {
	if o != nil && !IsNil(o.Value) {
		return true
	}
...
func (o *Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) SetValue(v string) {
	o.Value = &v
}

// GetDecision returns the Decision field value if set, zero value otherwise.
func (o *Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) GetDecision() string {
...
// and a boolean to check if the value has been set.
func (o *Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) GetDecisionOk() (*string, bool) {
	if o == nil || IsNil(o.Decision) {
		return nil, false
	}
...
func (o *Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) HasDecision() bool {
	if o != nil && !IsNil(o.Decision) {
		return true
	}
...
func (o *Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) SetDecision(v string) {
	o.Decision = &v
}

func (o Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) MarshalJSON() ([]byte, error) {
...
func (o Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) ToMap() (map[string]interface{}, error) {
...
type NullableHttp409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner struct {
	value *Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner
	isSet bool
}

func (v NullableHttp409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) Get() *Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner {
	return v.value
}

func (v *NullableHttp409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) Set(val *Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableHttp409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableHttp409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHttp409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner(val *Http409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) *NullableHttp409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner {
	return &NullableHttp409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner{value: val, isSet: true}
}

func (v NullableHttp409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHttp409SupplyDeliverErrorDataOrdersInnerMetaDetailsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
