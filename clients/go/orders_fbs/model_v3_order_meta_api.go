...
func (o *V3OrderMetaAPI) GetMetaDetails() []V3ArchiveOrderMetaDetailsInner {
...
// and a boolean to check if the value has been set.
func (o *V3OrderMetaAPI) GetMetaDetailsOk() ([]V3ArchiveOrderMetaDetailsInner, bool) {
	if o == nil || IsNil(o.MetaDetails) {
		return nil, false
	}
...
func (o *V3OrderMetaAPI) SetMetaDetails(v []V3ArchiveOrderMetaDetailsInner) {
	o.MetaDetails = v
}
