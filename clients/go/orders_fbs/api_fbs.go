...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// DeleteV3OrdersOrderIdMetaExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// DeleteV3PassesPassIdExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// DeleteV3SuppliesSupplyIdExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// DeleteV3SuppliesSupplyIdTrbxExecute executes the request
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// GetV3FbsDictionariesCountriesOksmExecute executes the request
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// GetV3FbsOrdersArchiveExecute executes the request
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// GetV3FbsShippingPointsExecute executes the request
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// GetV3FbsSuppliesSupplyIdStickersSpotExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// GetV3OrdersExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// GetV3OrdersNewExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// GetV3PassesExecute executes the request
	//  @return []Pass
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// GetV3PassesOfficesExecute executes the request
	//  @return []PassOffice
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// GetV3SuppliesExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// GetV3SuppliesOrdersReshipmentExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// GetV3SuppliesSupplyIdExecute executes the request
	//  @return Supply
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// GetV3SuppliesSupplyIdBarcodeExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// GetV3SuppliesSupplyIdOrderIdsExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// GetV3SuppliesSupplyIdTrbxExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// PatchV3OrdersOrderIdCancelExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// PatchV3SuppliesSupplyIdDeliverExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// PatchV3SuppliesSupplyIdOrdersExecute executes the request
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// PostV3FbsSuppliesSpotListExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// PostV3OrdersClientExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// PostV3OrdersMetaExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// PostV3OrdersStatusExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// PostV3OrdersStatusHistoryExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// PostV3OrdersStickersExecute executes the request
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// PostV3OrdersStickersCrossBorderExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// PostV3PassesExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// PostV3SuppliesExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// PostV3SuppliesSupplyIdTrbxExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// PostV3SuppliesSupplyIdTrbxStickersExecute executes the request
...
Один запрос с кодами ответов `4XX` учитывается как 10 запросов
	...
	*/
	...
	// PutV3FbsSuppliesSupplyIdSpotExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// PutV3OrdersOrderIdMetaCustomsDeclarationExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// PutV3OrdersOrderIdMetaExpirationExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// PutV3OrdersOrderIdMetaGtinExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// PutV3OrdersOrderIdMetaImeiExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// PutV3OrdersOrderIdMetaSgtinExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// PutV3OrdersOrderIdMetaUinExecute executes the request
...
В [песочнице](https://dev.wildberries.ru/sandbox) — максимум 1 запрос в секунду суммарно для всех методов **Маркетплейса**.
	...
	*/
	...
	// PutV3PassesPassIdExecute executes the request
	PutV3PassesPassIdExecute(r ApiPutV3PassesPassIdRequest) (*http.Response, error)
}
...
func (r ApiGetV3OrdersRequest) Execute() (*GetV3OrdersResponse200, *http.Response, error) {
...
func (r ApiGetV3OrdersNewRequest) Execute() (*GetV3OrdersNewResponse200, *http.Response, error) {
...
func (r ApiGetV3SuppliesRequest) Execute() (*GetV3SuppliesResponse200, *http.Response, error) {
...
func (r ApiGetV3SuppliesOrdersReshipmentRequest) Execute() (*GetV3SuppliesOrdersReshipmentResponse200, *http.Response, error) {
...
func (r ApiGetV3SuppliesSupplyIdBarcodeRequest) Execute() (*GetV3SuppliesSupplyIdBarcodeResponse200, *http.Response, error) {
...
func (r ApiPatchV3FbsSuppliesShippingMethodRequest) PatchV3FbsSuppliesShippingMethodRequest(patchV3FbsSuppliesShippingMethodRequest PatchV3FbsSuppliesShippingMethodRequest) ApiPatchV3FbsSuppliesShippingMethodRequest {
	r.patchV3FbsSuppliesShippingMethodRequest = &patchV3FbsSuppliesShippingMethodRequest
	return r
}
...
func (a *FBSAPIService) PatchV3FbsSuppliesShippingMethodExecute(r ApiPatchV3FbsSuppliesShippingMethodRequest) (*UpdateSuppliesResponse, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.patchV3FbsSuppliesShippingMethodRequest == nil {
		return localVarReturnValue, nil, reportError("patchV3FbsSuppliesShippingMethodRequest is required and must be specified")
	}
...
func (a *FBSAPIService) PatchV3SuppliesSupplyIdDeliverExecute(r ApiPatchV3SuppliesSupplyIdDeliverRequest) (*http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 409 {
			var v Http409SupplyDeliverError
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarHTTPResponse, newErr
...
func (r ApiPostV3OrdersStatusRequest) Execute() (*PostV3OrdersStatusResponse200, *http.Response, error) {
...
func (r ApiPostV3OrdersStatusHistoryRequest) Execute() (*PostV3OrdersStatusHistoryResponse200, *http.Response, error) {
...
func (r ApiPostV3OrdersStickersRequest) Execute() (*PostV3OrdersStickersResponse200, *http.Response, error) {
...
func (r ApiPostV3OrdersStickersCrossBorderRequest) Execute() (*PostV3OrdersStickersCrossBorderResponse200, *http.Response, error) {
...
func (r ApiPostV3PassesRequest) Execute() (*PostV3PassesResponse201, *http.Response, error) {
...
func (r ApiPostV3SuppliesRequest) Execute() (*PostV3SuppliesResponse201, *http.Response, error) {
...
func (r ApiPostV3SuppliesSupplyIdTrbxRequest) Execute() (*PostV3SuppliesSupplyIdTrbxResponse201, *http.Response, error) {
...
func (r ApiPostV3SuppliesSupplyIdTrbxStickersRequest) Execute() (*PostV3SuppliesSupplyIdTrbxStickersResponse200, *http.Response, error) {
