...
// checks if the PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner{}

// PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner struct for PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner
...
// NewPostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner instantiates a new PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner() *PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner {
	this := PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner{}
	return &this
}

// NewPostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInnerWithDefaults instantiates a new PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInnerWithDefaults() *PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner {
	this := PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner{}
	return &this
}

// GetDate returns the Date field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner) GetDate() string {
...
func (o *PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner) GetDateOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner) HasDate() bool {
...
func (o *PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner) UnsetDate() {
	o.Date.Unset()
}

// GetCode returns the Code field value if set, zero value otherwise.
func (o *PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner) GetCode() string {
...
// and a boolean to check if the value has been set.
func (o *PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner) GetCodeOk() (*string, bool) {
	if o == nil || IsNil(o.Code) {
		return nil, false
	}
	return o.Code, true
...
func (o *PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner) HasCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner) SetCode(v string) {
	o.Code = &v
}
...
func (o PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner) ToMap() (map[string]interface{}, error) {
...
type NullablePostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner struct {
	value *PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner
	isSet bool
}

func (v NullablePostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner) Get() *PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner {
	return v.value
}

func (v *NullablePostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner) Set(val *PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner(val *PostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner) *NullablePostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner {
	return &NullablePostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner{value: val, isSet: true}
}

func (v NullablePostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostV3OrdersStatusHistoryResponse200OrdersInnerStatusesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
