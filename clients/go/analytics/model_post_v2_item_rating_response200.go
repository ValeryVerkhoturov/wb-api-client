...
var _ MappedNullable = &PostV2ItemRatingResponse200{}
...
// NewPostV2ItemRatingResponse200WithDefaults instantiates a new PostV2ItemRatingResponse200 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPostV2ItemRatingResponse200WithDefaults() *PostV2ItemRatingResponse200 {
	this := PostV2ItemRatingResponse200{}
	return &this
}
...
type NullablePostV2ItemRatingResponse200 struct {
	value *PostV2ItemRatingResponse200
	isSet bool
}

func (v NullablePostV2ItemRatingResponse200) Get() *PostV2ItemRatingResponse200 {
	return v.value
}

func (v *NullablePostV2ItemRatingResponse200) Set(val *PostV2ItemRatingResponse200) {
	v.value = val
	v.isSet = true
}

func (v NullablePostV2ItemRatingResponse200) IsSet() bool {
	return v.isSet
}

func (v *NullablePostV2ItemRatingResponse200) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostV2ItemRatingResponse200(val *PostV2ItemRatingResponse200) *NullablePostV2ItemRatingResponse200 {
	return &NullablePostV2ItemRatingResponse200{value: val, isSet: true}
}

func (v NullablePostV2ItemRatingResponse200) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostV2ItemRatingResponse200) UnmarshalJSON(src []byte) error {
	v.isSet = true
