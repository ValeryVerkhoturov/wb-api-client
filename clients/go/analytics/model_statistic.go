...
func (o *Statistic) GetPeriod() StatisticPeriod {
	if o == nil {
...
func (o *Statistic) GetPeriodOk() (*StatisticPeriod, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Statistic) SetPeriod(v StatisticPeriod) {
	o.Period = v
}
