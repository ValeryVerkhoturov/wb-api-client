...
func (o *StatisticsPast) GetPeriod() StatisticPeriod {
	if o == nil {
...
func (o *StatisticsPast) GetPeriodOk() (*StatisticPeriod, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *StatisticsPast) SetPeriod(v StatisticPeriod) {
	o.Period = v
}
