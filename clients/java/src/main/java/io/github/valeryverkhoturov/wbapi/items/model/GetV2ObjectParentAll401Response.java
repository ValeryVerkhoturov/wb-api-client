...
public class GetV2ObjectParentAll401Response {
  ...
  public GetV2ObjectParentAll401Response statusText(
  ...
  public GetV2ObjectParentAll401Response timestamp(
  ...
  public boolean equals(Object o) {
    ...
    GetV2ObjectParentAll401Response getV2ObjectParentAll401Response =
        (GetV2ObjectParentAll401Response) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!GetV2ObjectParentAll401Response.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in GetV2ObjectParentAll401Response is not found in the empty JSON string",
                GetV2ObjectParentAll401Response.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!GetV2ObjectParentAll401Response.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `GetV2ObjectParentAll401Response` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!GetV2ObjectParentAll401Response.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'GetV2ObjectParentAll401Response' and its
        // subtypes
      }
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<GetV2ObjectParentAll401Response>() {
            @Override
            public void write(JsonWriter out, GetV2ObjectParentAll401Response value)
                throws IOException {
