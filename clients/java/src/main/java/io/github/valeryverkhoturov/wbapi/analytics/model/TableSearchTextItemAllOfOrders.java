...
public class TableSearchTextItemAllOfOrders {
  ...
  /**
   * Процент, на который показатель заказов выше, чем у карточек других продавцов по поисковому
   * запросу
   *
   * @return percentile
   */
  ...
  public boolean equals(Object o) {
    ...
    TableSearchTextItemAllOfOrders tableSearchTextItemAllOfOrders =
        (TableSearchTextItemAllOfOrders) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!TableSearchTextItemAllOfOrders.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in TableSearchTextItemAllOfOrders is not found in the empty JSON string",
                TableSearchTextItemAllOfOrders.openapiRequiredFields.toString()));
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<TableSearchTextItemAllOfOrders>() {
            @Override
            public void write(JsonWriter out, TableSearchTextItemAllOfOrders value)
                throws IOException {
