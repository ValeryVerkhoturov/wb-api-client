...
public class StatIntervalInterval {
  ...
  public boolean equals(Object o) {
    ...
    StatIntervalInterval statIntervalInterval = (StatIntervalInterval) o;
    return Objects.equals(this.begin, statIntervalInterval.begin) &&
        Objects.equals(this.end, statIntervalInterval.end);
  }
  ...
  public String toString() {
    ...
    sb.append("class StatIntervalInterval {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatIntervalInterval
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatIntervalInterval.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatIntervalInterval is not found in the empty JSON string", StatIntervalInterval.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatIntervalInterval.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatIntervalInterval` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatIntervalInterval.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatIntervalInterval' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatIntervalInterval> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatIntervalInterval.class));

       return (TypeAdapter<T>) new TypeAdapter<StatIntervalInterval>() {
           @Override
           public void write(JsonWriter out, StatIntervalInterval value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatIntervalInterval read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatIntervalInterval given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatIntervalInterval
   * @throws IOException if the JSON string is invalid with respect to StatIntervalInterval
   */
  public static StatIntervalInterval fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatIntervalInterval.class);
  }

  /**
   * Convert an instance of StatIntervalInterval to an JSON string
   *
   * @return JSON string
   */
