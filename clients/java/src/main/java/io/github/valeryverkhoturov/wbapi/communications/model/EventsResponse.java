...
public class EventsResponse {
  ...
  public EventsResponse result(@jakarta.annotation.Nullable EventsResult result) {
    this.result = result;
    return this;
  }
  ...
  public void setResult(@jakarta.annotation.Nullable EventsResult result) {
    this.result = result;
  }

  public EventsResponse errors(@jakarta.annotation.Nullable List<String> errors) {
    this.errors = errors;
    return this;
  }

  public EventsResponse addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.result, eventsResponse.result)
        && Objects.equals(this.errors, eventsResponse.errors);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!EventsResponse.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in EventsResponse is not found in the empty JSON string",
                EventsResponse.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!EventsResponse.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `EventsResponse` properties. JSON: %s",
    ...
    if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
      EventsResult.validateJsonElement(jsonObj.get("result"));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<EventsResponse>() {
            @Override
