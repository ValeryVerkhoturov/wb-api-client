...
public class SwaggerPublicErrorsCursorInput {
  ...
  /**
   * Количество пакетов в ответе maximum: 100
   *
   * @return limit
   */
  @jakarta.annotation.Nullable
  ...
  public SwaggerPublicErrorsCursorInput updatedAt(
  ...
  public boolean equals(Object o) {
    ...
    SwaggerPublicErrorsCursorInput swaggerPublicErrorsCursorInput =
        (SwaggerPublicErrorsCursorInput) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!SwaggerPublicErrorsCursorInput.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in SwaggerPublicErrorsCursorInput is not found in the empty JSON string",
                SwaggerPublicErrorsCursorInput.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!SwaggerPublicErrorsCursorInput.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `SwaggerPublicErrorsCursorInput` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<SwaggerPublicErrorsCursorInput>() {
            @Override
            public void write(JsonWriter out, SwaggerPublicErrorsCursorInput value)
                throws IOException {
