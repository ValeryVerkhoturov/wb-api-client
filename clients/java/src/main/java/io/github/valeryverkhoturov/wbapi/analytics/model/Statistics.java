...
public class Statistics {
  ...
  public Statistics past(@jakarta.annotation.Nullable StatisticsPast past) {
    this.past = past;
    return this;
  }
  ...
  public Statistics comparison(@jakarta.annotation.Nullable StatisticsComparison comparison) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.selected, statistics.selected)
        && Objects.equals(this.past, statistics.past)
        && Objects.equals(this.comparison, statistics.comparison);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!Statistics.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in Statistics is not found in the empty JSON string",
                Statistics.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!Statistics.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `Statistics` properties. JSON: %s",
