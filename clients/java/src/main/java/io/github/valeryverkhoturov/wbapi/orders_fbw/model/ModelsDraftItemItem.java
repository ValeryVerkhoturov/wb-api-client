...
public class ModelsDraftItemItem {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sku, color, quantity, brandName, imgSrc, nmId, subjectName, techSize, title, vendorCode);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelsDraftItemItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelsDraftItemItem is not found in the empty JSON string", ModelsDraftItemItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelsDraftItemItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelsDraftItemItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("imgSrc").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `imgSrc` to be a primitive type in the JSON string but got `%s`", jsonObj.get("imgSrc").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ModelsDraftItemItem>() {
           @Override
