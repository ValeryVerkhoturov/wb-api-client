...
public class TableSizeResponseSizesInner {
  ...
  public TableSizeResponseSizesInner offices(
      @jakarta.annotation.Nullable List<TableOfficeItem> offices) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!TableSizeResponseSizesInner.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in TableSizeResponseSizesInner is not found in the empty JSON string",
                TableSizeResponseSizesInner.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!TableSizeResponseSizesInner.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `TableSizeResponseSizesInner` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<TableSizeResponseSizesInner>() {
            @Override
            public void write(JsonWriter out, TableSizeResponseSizesInner value)
                throws IOException {
