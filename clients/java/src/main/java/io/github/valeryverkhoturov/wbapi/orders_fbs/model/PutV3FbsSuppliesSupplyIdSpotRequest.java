...
public class PutV3FbsSuppliesSupplyIdSpotRequest {
  ...
  public PutV3FbsSuppliesSupplyIdSpotRequest carrierName(
  ...
  public PutV3FbsSuppliesSupplyIdSpotRequest carrierTaxNumber(
  ...
  public PutV3FbsSuppliesSupplyIdSpotRequest carrierCountryCode(
  ...
  public PutV3FbsSuppliesSupplyIdSpotRequest vehicleRegistrationNumber(
  ...
  public PutV3FbsSuppliesSupplyIdSpotRequest trailerRegistrationNumber(
  ...
  public boolean equals(Object o) {
    ...
    PutV3FbsSuppliesSupplyIdSpotRequest putV3FbsSuppliesSupplyIdSpotRequest =
        (PutV3FbsSuppliesSupplyIdSpotRequest) o;
    return Objects.equals(this.carrierName, putV3FbsSuppliesSupplyIdSpotRequest.carrierName)
        && Objects.equals(
            this.carrierTaxNumber, putV3FbsSuppliesSupplyIdSpotRequest.carrierTaxNumber)
        && Objects.equals(
            this.carrierCountryCode, putV3FbsSuppliesSupplyIdSpotRequest.carrierCountryCode)
        && Objects.equals(
            this.vehicleRegistrationNumber,
            putV3FbsSuppliesSupplyIdSpotRequest.vehicleRegistrationNumber)
        && Objects.equals(
            this.trailerRegistrationNumber,
            putV3FbsSuppliesSupplyIdSpotRequest.trailerRegistrationNumber);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PutV3FbsSuppliesSupplyIdSpotRequest.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in PutV3FbsSuppliesSupplyIdSpotRequest is not found in the empty JSON string",
                PutV3FbsSuppliesSupplyIdSpotRequest.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PutV3FbsSuppliesSupplyIdSpotRequest.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `PutV3FbsSuppliesSupplyIdSpotRequest` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PutV3FbsSuppliesSupplyIdSpotRequest.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'PutV3FbsSuppliesSupplyIdSpotRequest' and its
        // subtypes
      }
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<PutV3FbsSuppliesSupplyIdSpotRequest>() {
            @Override
            public void write(JsonWriter out, PutV3FbsSuppliesSupplyIdSpotRequest value)
                throws IOException {
