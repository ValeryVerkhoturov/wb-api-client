...
public class PostV2CardsUpdateRequestInnerSizesInner {
  ...
  public PostV2CardsUpdateRequestInnerSizesInner chrtID(
  ...
  public PostV2CardsUpdateRequestInnerSizesInner techSize(
  ...
  public PostV2CardsUpdateRequestInnerSizesInner wbSize(
  ...
  public PostV2CardsUpdateRequestInnerSizesInner skus(
  ...
  public boolean equals(Object o) {
    ...
    PostV2CardsUpdateRequestInnerSizesInner postV2CardsUpdateRequestInnerSizesInner =
        (PostV2CardsUpdateRequestInnerSizesInner) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PostV2CardsUpdateRequestInnerSizesInner.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in PostV2CardsUpdateRequestInnerSizesInner is not found in the empty JSON string",
                PostV2CardsUpdateRequestInnerSizesInner.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PostV2CardsUpdateRequestInnerSizesInner.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `PostV2CardsUpdateRequestInnerSizesInner` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PostV2CardsUpdateRequestInnerSizesInner.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'PostV2CardsUpdateRequestInnerSizesInner' and its
        // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<PostV2CardsUpdateRequestInnerSizesInner> thisAdapter =
          gson.getDelegateAdapter(
              this, TypeToken.get(PostV2CardsUpdateRequestInnerSizesInner.class));

      return (TypeAdapter<T>)
          new TypeAdapter<PostV2CardsUpdateRequestInnerSizesInner>() {
            @Override
            public void write(JsonWriter out, PostV2CardsUpdateRequestInnerSizesInner value)
                throws IOException {
   ...
   *     PostV2CardsUpdateRequestInnerSizesInner
   */
  public static PostV2CardsUpdateRequestInnerSizesInner fromJson(String jsonString)
      throws IOException {
