...
public class OpenapiSellerLimitsResponseDataTariff {
  ...
  public OpenapiSellerLimitsResponseDataTariff perUnitLimit(@jakarta.annotation.Nonnull Integer perUnitLimit) {
  ...
  public OpenapiSellerLimitsResponseDataTariff remaining(@jakarta.annotation.Nonnull Integer remaining) {
  ...
  public OpenapiSellerLimitsResponseDataTariff totalLimit(@jakarta.annotation.Nonnull Integer totalLimit) {
  ...
  public OpenapiSellerLimitsResponseDataTariff unlimited(@jakarta.annotation.Nonnull Boolean unlimited) {
  ...
  public boolean equals(Object o) {
    ...
    OpenapiSellerLimitsResponseDataTariff openapiSellerLimitsResponseDataTariff = (OpenapiSellerLimitsResponseDataTariff) o;
   ...
   * @throws IOException if the JSON Element is invalid with respect to OpenapiSellerLimitsResponseDataTariff
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OpenapiSellerLimitsResponseDataTariff.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OpenapiSellerLimitsResponseDataTariff is not found in the empty JSON string", OpenapiSellerLimitsResponseDataTariff.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OpenapiSellerLimitsResponseDataTariff.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OpenapiSellerLimitsResponseDataTariff` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OpenapiSellerLimitsResponseDataTariff.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OpenapiSellerLimitsResponseDataTariff' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<OpenapiSellerLimitsResponseDataTariff>() {
           @Override
           public void write(JsonWriter out, OpenapiSellerLimitsResponseDataTariff value) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to OpenapiSellerLimitsResponseDataTariff
   */
  public static OpenapiSellerLimitsResponseDataTariff fromJson(String jsonString) throws IOException {
