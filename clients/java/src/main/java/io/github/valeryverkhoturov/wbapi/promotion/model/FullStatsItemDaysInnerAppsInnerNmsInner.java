...
public class FullStatsItemDaysInnerAppsInnerNmsInner {
  ...
  public FullStatsItemDaysInnerAppsInnerNmsInner canceled(@jakarta.annotation.Nonnull Integer canceled) {
  ...
  public FullStatsItemDaysInnerAppsInnerNmsInner clicks(@jakarta.annotation.Nonnull Integer clicks) {
    this.clicks = clicks;
    return this;
  }
  ...
  public FullStatsItemDaysInnerAppsInnerNmsInner orders(@jakarta.annotation.Nonnull Integer orders) {
    this.orders = orders;
    return this;
  }
  ...
  public FullStatsItemDaysInnerAppsInnerNmsInner sumPrice(@jakarta.annotation.Nonnull BigDecimal sumPrice) {
  ...
  public boolean equals(Object o) {
    ...
    FullStatsItemDaysInnerAppsInnerNmsInner fullStatsItemDaysInnerAppsInnerNmsInner = (FullStatsItemDaysInnerAppsInnerNmsInner) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(atbs, canceled, clicks, cpc, cr, ctr, name, nmId, orders, shks, sum, sumPrice, views);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FullStatsItemDaysInnerAppsInnerNmsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FullStatsItemDaysInnerAppsInnerNmsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FullStatsItemDaysInnerAppsInnerNmsInner is not found in the empty JSON string", FullStatsItemDaysInnerAppsInnerNmsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FullStatsItemDaysInnerAppsInnerNmsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FullStatsItemDaysInnerAppsInnerNmsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FullStatsItemDaysInnerAppsInnerNmsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FullStatsItemDaysInnerAppsInnerNmsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FullStatsItemDaysInnerAppsInnerNmsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FullStatsItemDaysInnerAppsInnerNmsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<FullStatsItemDaysInnerAppsInnerNmsInner>() {
           @Override
           public void write(JsonWriter out, FullStatsItemDaysInnerAppsInnerNmsInner value) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to FullStatsItemDaysInnerAppsInnerNmsInner
   */
  public static FullStatsItemDaysInnerAppsInnerNmsInner fromJson(String jsonString) throws IOException {
