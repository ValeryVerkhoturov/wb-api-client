...
public class PostV1FeedbacksOrderReturnRequest {
  ...
  public PostV1FeedbacksOrderReturnRequest feedbackId(
  ...
  public boolean equals(Object o) {
    ...
    PostV1FeedbacksOrderReturnRequest postV1FeedbacksOrderReturnRequest =
        (PostV1FeedbacksOrderReturnRequest) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PostV1FeedbacksOrderReturnRequest.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in PostV1FeedbacksOrderReturnRequest is not found in the empty JSON string",
                PostV1FeedbacksOrderReturnRequest.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PostV1FeedbacksOrderReturnRequest.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `PostV1FeedbacksOrderReturnRequest` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PostV1FeedbacksOrderReturnRequest.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'PostV1FeedbacksOrderReturnRequest' and its
        // subtypes
      }
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<PostV1FeedbacksOrderReturnRequest>() {
            @Override
            public void write(JsonWriter out, PostV1FeedbacksOrderReturnRequest value)
                throws IOException {
