...
import io.github.valeryverkhoturov.wbapi.dbs.model.OrderDBSAddress;
...
public class OrderDBS {
  ...
  public OrderDBS convertedCurrencyCode(@jakarta.annotation.Nullable Integer convertedCurrencyCode) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(address, deliveryType, options, orderUid, groupId, article, colorCode, rid, createdAt, skus, id, warehouseId, nmId, chrtId, scanPrice, price, convertedPrice, currencyCode, convertedCurrencyCode, convertedFinalPrice, finalPrice, cargoType, comment, isZeroOrder, wbStickerId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderDBS.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderDBS is not found in the empty JSON string", OrderDBS.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrderDBS.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrderDBS` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrderDBS>() {
           @Override
