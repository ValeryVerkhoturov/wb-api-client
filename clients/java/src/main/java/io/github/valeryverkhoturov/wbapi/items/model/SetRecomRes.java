...
public class SetRecomRes {
  ...
  /**
   * Есть ли ошибки: - &#x60;false&#x60; — ошибок нет. Запрос полностью успешен - &#x60;true&#x60; —
   * ошибки есть
   *
   * @return isError
   */
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!SetRecomRes.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in SetRecomRes is not found in the empty JSON string",
                SetRecomRes.openapiRequiredFields.toString()));
      }
    }
