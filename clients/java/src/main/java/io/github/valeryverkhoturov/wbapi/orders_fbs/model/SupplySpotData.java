...
public class SupplySpotData {
  ...
  public SupplySpotData vehicleRegistrationNumber(@jakarta.annotation.Nonnull String vehicleRegistrationNumber) {
  ...
  public SupplySpotData trailerRegistrationNumber(@jakarta.annotation.Nullable String trailerRegistrationNumber) {
  ...
  public SupplySpotData errorCode(@jakarta.annotation.Nullable ErrorCodeEnum errorCode) {
  ...
  public boolean equals(Object o) {
    ...
    SupplySpotData supplySpotData = (SupplySpotData) o;
    return Objects.equals(this.status, supplySpotData.status) &&
        Objects.equals(this.carrierName, supplySpotData.carrierName) &&
        Objects.equals(this.carrierTaxNumber, supplySpotData.carrierTaxNumber) &&
        Objects.equals(this.carrierCountryCode, supplySpotData.carrierCountryCode) &&
        Objects.equals(this.vehicleRegistrationNumber, supplySpotData.vehicleRegistrationNumber) &&
        Objects.equals(this.trailerRegistrationNumber, supplySpotData.trailerRegistrationNumber) &&
        Objects.equals(this.errorCode, supplySpotData.errorCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class SupplySpotData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SupplySpotData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SupplySpotData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SupplySpotData is not found in the empty JSON string", SupplySpotData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SupplySpotData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SupplySpotData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SupplySpotData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SupplySpotData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SupplySpotData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SupplySpotData.class));

       return (TypeAdapter<T>) new TypeAdapter<SupplySpotData>() {
           @Override
           public void write(JsonWriter out, SupplySpotData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SupplySpotData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SupplySpotData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SupplySpotData
   * @throws IOException if the JSON string is invalid with respect to SupplySpotData
   */
  public static SupplySpotData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SupplySpotData.class);
  }

  /**
   * Convert an instance of SupplySpotData to an JSON string
   *
   * @return JSON string
   */
