...
import io.github.valeryverkhoturov.wbapi.promotion.model.StatsBlok1DailyStatsInner;
...
public class StatsBlok1 {
  ...
  public StatsBlok1 dailyStats(@jakarta.annotation.Nullable List<StatsBlok1DailyStatsInner> dailyStats) {
  ...
  public void setDailyStats(@jakarta.annotation.Nullable List<StatsBlok1DailyStatsInner> dailyStats) {
    this.dailyStats = dailyStats;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(itemId, itemName, categoryName, advertType, place, views, clicks, cr, ctr, dateFrom, dateTo, subjectName, atbs, orders, price, cpc, status, dailyStats, expenses, cr1, cr2);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatsBlok1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatsBlok1 is not found in the empty JSON string", StatsBlok1.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatsBlok1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatsBlok1` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StatsBlok1>() {
           @Override
