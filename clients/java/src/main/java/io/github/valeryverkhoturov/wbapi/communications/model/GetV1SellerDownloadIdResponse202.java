...
public class GetV1SellerDownloadIdResponse202 {
  ...
  public boolean equals(Object o) {
    ...
    GetV1SellerDownloadIdResponse202 getV1SellerDownloadIdResponse202 =
        (GetV1SellerDownloadIdResponse202) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!GetV1SellerDownloadIdResponse202.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in GetV1SellerDownloadIdResponse202 is not found in the empty JSON string",
                GetV1SellerDownloadIdResponse202.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!GetV1SellerDownloadIdResponse202.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `GetV1SellerDownloadIdResponse202` properties. JSON: %s",
    ...
    if (!jsonObj.get("moderationState").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
              ...
              jsonObj.get("moderationState").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!GetV1SellerDownloadIdResponse202.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'GetV1SellerDownloadIdResponse202' and its
        // subtypes
      }
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<GetV1SellerDownloadIdResponse202>() {
            @Override
            public void write(JsonWriter out, GetV1SellerDownloadIdResponse202 value)
                throws IOException {
