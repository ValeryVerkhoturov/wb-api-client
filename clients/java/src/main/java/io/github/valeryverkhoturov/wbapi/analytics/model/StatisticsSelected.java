...
public class StatisticsSelected {
  ...
  public StatisticsSelected avgOrdersCountPerDay(@jakarta.annotation.Nonnull BigDecimal avgOrdersCountPerDay) {
  ...
  public StatisticsSelected shareOrderPercent(@jakarta.annotation.Nonnull BigDecimal shareOrderPercent) {
  ...
  public StatisticsSelected timeToReady(@jakarta.annotation.Nonnull StatisticTimeToReady timeToReady) {
  ...
  public StatisticsSelected localizationPercent(@jakarta.annotation.Nonnull Integer localizationPercent) {
  ...
  public StatisticsSelected conversions(@jakarta.annotation.Nonnull StatisticConversions conversions) {
  ...
  public boolean equals(Object o) {
    ...
    StatisticsSelected statisticsSelected = (StatisticsSelected) o;
    return Objects.equals(this.period, statisticsSelected.period) &&
        Objects.equals(this.openCount, statisticsSelected.openCount) &&
        Objects.equals(this.cartCount, statisticsSelected.cartCount) &&
        Objects.equals(this.orderCount, statisticsSelected.orderCount) &&
        Objects.equals(this.orderSum, statisticsSelected.orderSum) &&
        Objects.equals(this.buyoutCount, statisticsSelected.buyoutCount) &&
        Objects.equals(this.buyoutSum, statisticsSelected.buyoutSum) &&
        Objects.equals(this.cancelCount, statisticsSelected.cancelCount) &&
        Objects.equals(this.cancelSum, statisticsSelected.cancelSum) &&
        Objects.equals(this.avgPrice, statisticsSelected.avgPrice) &&
        Objects.equals(this.avgOrdersCountPerDay, statisticsSelected.avgOrdersCountPerDay) &&
        Objects.equals(this.shareOrderPercent, statisticsSelected.shareOrderPercent) &&
        Objects.equals(this.addToWishlist, statisticsSelected.addToWishlist) &&
        Objects.equals(this.timeToReady, statisticsSelected.timeToReady) &&
        Objects.equals(this.localizationPercent, statisticsSelected.localizationPercent) &&
        Objects.equals(this.wbClub, statisticsSelected.wbClub) &&
        Objects.equals(this.conversions, statisticsSelected.conversions);
  }
  ...
  public String toString() {
    ...
    sb.append("class StatisticsSelected {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StatisticsSelected
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatisticsSelected.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatisticsSelected is not found in the empty JSON string", StatisticsSelected.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatisticsSelected.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatisticsSelected` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatisticsSelected.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatisticsSelected' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatisticsSelected> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatisticsSelected.class));

       return (TypeAdapter<T>) new TypeAdapter<StatisticsSelected>() {
           @Override
           public void write(JsonWriter out, StatisticsSelected value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StatisticsSelected read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StatisticsSelected given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StatisticsSelected
   * @throws IOException if the JSON string is invalid with respect to StatisticsSelected
   */
  public static StatisticsSelected fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatisticsSelected.class);
  }

  /**
   * Convert an instance of StatisticsSelected to an JSON string
   *
   * @return JSON string
   */
