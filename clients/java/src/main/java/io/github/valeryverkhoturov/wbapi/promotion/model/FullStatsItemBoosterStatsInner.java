...
public class FullStatsItemBoosterStatsInner {
  ...
  public boolean equals(Object o) {
    ...
    FullStatsItemBoosterStatsInner fullStatsItemBoosterStatsInner =
        (FullStatsItemBoosterStatsInner) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!FullStatsItemBoosterStatsInner.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in FullStatsItemBoosterStatsInner is not found in the empty JSON string",
                FullStatsItemBoosterStatsInner.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!FullStatsItemBoosterStatsInner.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `FullStatsItemBoosterStatsInner` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<FullStatsItemBoosterStatsInner>() {
            @Override
            public void write(JsonWriter out, FullStatsItemBoosterStatsInner value)
                throws IOException {
