 ...
 */
@JsonAdapter(PositionCluster.Adapter.class)
public enum PositionCluster {
  ...
  public static PositionCluster fromValue(String value) {
    for (PositionCluster b : PositionCluster.values()) {
  ...
  public static class Adapter extends TypeAdapter<PositionCluster> {
    @Override
    public void write(final JsonWriter jsonWriter, final PositionCluster enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PositionCluster read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PositionCluster.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PositionCluster.fromValue(value);
  }
}
