...
public class ResponseBodyContentError400 {
  ...
  public ResponseBodyContentError400 additionalErrors(@jakarta.annotation.Nullable Object additionalErrors) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseBodyContentError400.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseBodyContentError400 is not found in the empty JSON string", ResponseBodyContentError400.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResponseBodyContentError400.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseBodyContentError400` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ResponseBodyContentError400>() {
           @Override
           public void write(JsonWriter out, ResponseBodyContentError400 value) throws IOException {
