...
public class PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner {
  ...
  public PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner code(
  ...
  public PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner detail(
  ...
  public boolean equals(Object o) {
    ...
    PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner
        postMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner =
            (PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner) o;
    return Objects.equals(
            this.code,
            postMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner.code)
        && Objects.equals(
            this.detail,
            postMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner.detail);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner
          .openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner is not found in the empty JSON string",
                PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner
                    .openapiRequiredFields
                    .toString()));
      }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner
        ...
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner.class
          .isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes
        // 'PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner' and its
        // subtypes
      }
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<
            ...
            public void write(
                JsonWriter out,
                PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner value)
                throws IOException {
   ...
   * PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner given an JSON
   * string
   *
   ...
   *     PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner
   */
  public static PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner
      fromJson(String jsonString) throws IOException {
    return JSON.getGson()
        .fromJson(
            jsonString,
            PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner.class);
  }

  /**
   * Convert an instance of
   * PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner to an JSON string
   *
   * @return JSON string
   */
