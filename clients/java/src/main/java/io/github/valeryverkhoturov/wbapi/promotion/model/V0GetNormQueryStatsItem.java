...
public class V0GetNormQueryStatsItem {
  ...
  public V0GetNormQueryStatsItem stats(
      @jakarta.annotation.Nullable List<V0GetNormQueryStatsItemStat> stats) {
    this.stats = stats;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!V0GetNormQueryStatsItem.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in V0GetNormQueryStatsItem is not found in the empty JSON string",
                V0GetNormQueryStatsItem.openapiRequiredFields.toString()));
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<V0GetNormQueryStatsItem>() {
            @Override
