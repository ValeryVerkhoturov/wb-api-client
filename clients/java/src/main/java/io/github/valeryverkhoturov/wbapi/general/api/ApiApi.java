...
public class ApiApi {
     ...
     * @param fromID ID новости, начиная с которой — включая её — нужно получить список новостей (optional)
     ...
     */
    public okhttp3.Call getV2NewsCall(LocalDate from, Integer fromID, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getV2NewsValidateBeforeCall(LocalDate from, Integer fromID, final ApiCallback _callback) throws ApiException {
     ...
     */
    public ApiResponse<GetV2NewsResponse200> getV2NewsWithHttpInfo(LocalDate from, Integer fromID) throws ApiException {
    ...
    /**
     * Получение новостей портала продавцов (asynchronously)
     * Метод позволяет получать новости портала продавцов.  Для получения успешного ответа необходимо указать один из параметров &#x60;from&#x60; или &#x60;fromID&#x60;.  За один запрос можно получить не более 100 новостей.[Лимит запросов](/openapi/api-information#tag/introduction/Limity-zaprosov) на один аккаунт продавца: | Тип | Период | Лимит | Интервал | Всплеск | | --- | --- | --- | --- | --- | | Персональный | 1 мин | 1 запрос | 1 мин | 10 запросов | | Сервисный | 1 мин | 1 запрос | 1 мин | 10 запросов | | Базовый с секретом | 1 мин | 1 запрос | 1 мин | 10 запросов | | Базовый | 1 ч | 1 запрос | 1 ч | 1 запрос |
     * @param from Дата, от которой необходимо выдать новости (optional)
     * @param fromID ID новости, начиная с которой — включая её — нужно получить список новостей (optional)
     ...
     */
    public okhttp3.Call getV2NewsAsync(LocalDate from, Integer fromID, final ApiCallback<GetV2NewsResponse200> _callback) throws ApiException {
