...
public class PostV2CardsUploadAddResponse413 {
  ...
  public PostV2CardsUploadAddResponse413 statusText(
  ...
  public boolean equals(Object o) {
    ...
    PostV2CardsUploadAddResponse413 postV2CardsUploadAddResponse413 =
        (PostV2CardsUploadAddResponse413) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PostV2CardsUploadAddResponse413.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in PostV2CardsUploadAddResponse413 is not found in the empty JSON string",
                PostV2CardsUploadAddResponse413.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PostV2CardsUploadAddResponse413.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `PostV2CardsUploadAddResponse413` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PostV2CardsUploadAddResponse413.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'PostV2CardsUploadAddResponse413' and its
        // subtypes
      }
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<PostV2CardsUploadAddResponse413>() {
            @Override
            public void write(JsonWriter out, PostV2CardsUploadAddResponse413 value)
                throws IOException {
