...
public class TableSizeResponseSizesInnerMetrics {
  ...
  public TableSizeResponseSizesInnerMetrics addAvgOrdersByMonthItem(
      FloatGraphByPeriodItem avgOrdersByMonthItem) {
  ...
  /**
   * Упущенные заказы, шт. Особые случаи: 1. Значение меньше &#x60;0&#x60; и не равно &#x60;-2&#x60;
   * — значение не рассчитано 2. Значение &#x60;-2&#x60; — нулевое значение
   *
  ...
  /**
   * Упущенные заказы, сумма. Особые случаи: 1. Значение меньше &#x60;0&#x60; и не равно
   * &#x60;-2&#x60; — значение не рассчитано 2. Значение &#x60;-2&#x60; — нулевое значение
   *
  ...
  /**
   * Упущенные выкупы, шт. Особые случаи: 1. Значение меньше &#x60;0&#x60; и не равно &#x60;-2&#x60;
   * — значение не рассчитано 2. Значение &#x60;-2&#x60; — нулевое значение
   *
  ...
  /**
   * Упущенные выкупы, сумма. Особые случаи: 1. Значение меньше &#x60;0&#x60; и не равно
   * &#x60;-2&#x60; — значение не рассчитано 2. Значение &#x60;-2&#x60; — нулевое значение
   *
  ...
  public boolean equals(Object o) {
    ...
    TableSizeResponseSizesInnerMetrics tableSizeResponseSizesInnerMetrics =
        (TableSizeResponseSizesInnerMetrics) o;
    return Objects.equals(this.ordersCount, tableSizeResponseSizesInnerMetrics.ordersCount)
        ...
        && Objects.equals(
            this.avgOrdersByMonth, tableSizeResponseSizesInnerMetrics.avgOrdersByMonth)
        ...
        && Objects.equals(
            this.avgStockTurnover, tableSizeResponseSizesInnerMetrics.avgStockTurnover)
        ...
        && Objects.equals(
            this.officeMissingTime, tableSizeResponseSizesInnerMetrics.officeMissingTime)
        ...
        && Objects.equals(
            this.lostBuyoutsCount, tableSizeResponseSizesInnerMetrics.lostBuyoutsCount)
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!TableSizeResponseSizesInnerMetrics.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in TableSizeResponseSizesInnerMetrics is not found in the empty JSON string",
                TableSizeResponseSizesInnerMetrics.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!TableSizeResponseSizesInnerMetrics.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `TableSizeResponseSizesInnerMetrics` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!TableSizeResponseSizesInnerMetrics.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'TableSizeResponseSizesInnerMetrics' and its
        // subtypes
      }
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<TableSizeResponseSizesInnerMetrics>() {
            @Override
            public void write(JsonWriter out, TableSizeResponseSizesInnerMetrics value)
                throws IOException {
