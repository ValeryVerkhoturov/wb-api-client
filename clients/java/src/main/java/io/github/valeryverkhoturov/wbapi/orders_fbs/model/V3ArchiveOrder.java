...
import io.github.valeryverkhoturov.wbapi.orders_fbs.model.V3ArchiveOrderCrossBorder;
import io.github.valeryverkhoturov.wbapi.orders_fbs.model.V3ArchiveOrderMetaDetailsInner;
import io.github.valeryverkhoturov.wbapi.orders_fbs.model.V3ArchiveOrderOptions;
import io.github.valeryverkhoturov.wbapi.orders_fbs.model.V3ArchiveOrderPriceInfo;
import io.github.valeryverkhoturov.wbapi.orders_fbs.model.V3ArchiveOrderProduct;
import io.github.valeryverkhoturov.wbapi.orders_fbs.model.V3ArchiveOrderStatus;
...
public class V3ArchiveOrder {
  ...
  public V3ArchiveOrder crossBorder(@jakarta.annotation.Nullable V3ArchiveOrderCrossBorder crossBorder) {
  ...
  public V3ArchiveOrder metaDetails(@jakarta.annotation.Nonnull List<V3ArchiveOrderMetaDetailsInner> metaDetails) {
  ...
  public void setMetaDetails(@jakarta.annotation.Nonnull List<V3ArchiveOrderMetaDetailsInner> metaDetails) {
    this.metaDetails = metaDetails;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cargoType, colorCode, createdAt, crossBorder, crossBorderType, id, isZeroOrder, metaDetails, options, orderUid, priceInfo, product, rid, scanPrice, status, stickerId, supplyId, warehouseId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!V3ArchiveOrder.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V3ArchiveOrder is not found in the empty JSON string", V3ArchiveOrder.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!V3ArchiveOrder.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V3ArchiveOrder` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("crossBorderType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `crossBorderType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("crossBorderType").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<V3ArchiveOrder>() {
           @Override
