...
import io.github.valeryverkhoturov.wbapi.promotion.model.StatsBlok2DailyStatsInner;
...
public class StatsBlok2 {
  ...
  public StatsBlok2 dailyStats(@jakarta.annotation.Nullable List<StatsBlok2DailyStatsInner> dailyStats) {
  ...
  public void setDailyStats(@jakarta.annotation.Nullable List<StatsBlok2DailyStatsInner> dailyStats) {
    this.dailyStats = dailyStats;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StatsBlok2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatsBlok2 is not found in the empty JSON string", StatsBlok2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StatsBlok2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StatsBlok2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StatsBlok2>() {
           @Override
