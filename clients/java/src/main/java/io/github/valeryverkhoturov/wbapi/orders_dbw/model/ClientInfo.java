...
public class ClientInfo {
  ...
  /**
   * Номер телефона для связи с покупателем: - если в поле &#x60;phoneCode&#x60; не указан
   * добавочный код, вы можете позвонить покупателю по указанному номеру. Дополнительные номера
   * телефонов для связи без кодов указаны в поле &#x60;additionalPhones&#x60; - если в поле
   * &#x60;phoneCode&#x60; указан добавочный код, используйте его, чтобы связаться с покупателем по
   * указанному номеру и добавочному коду
   *
   * @return phone
   */
  @jakarta.annotation.Nullable
  ...
  public ClientInfo additionalPhoneCodes(
      @jakarta.annotation.Nullable List<Integer> additionalPhoneCodes) {
   ...
   * из &#x60;phoneCode&#x60;. Пустое значение указывает, коды ещё не назначены
   *
  ...
  /**
   * Добавочный код. Используйте, чтобы связаться с покупателем по номеру из &#x60;phone&#x60;. Если
   * код не указан, вы можете связаться с покупателем без кода
   *
   * @return phoneCode
   */
  @jakarta.annotation.Nullable
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ClientInfo.openapiRequiredFields
        ...
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in ClientInfo is not found in the empty JSON string",
                ClientInfo.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ClientInfo.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `ClientInfo` properties. JSON: %s",
