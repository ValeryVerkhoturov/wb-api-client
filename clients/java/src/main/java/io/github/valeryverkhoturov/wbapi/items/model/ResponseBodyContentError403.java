...
public class ResponseBodyContentError403 {
  ...
  public ResponseBodyContentError403 additionalErrors(
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ResponseBodyContentError403.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in ResponseBodyContentError403 is not found in the empty JSON string",
                ResponseBodyContentError403.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ResponseBodyContentError403.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `ResponseBodyContentError403` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<ResponseBodyContentError403>() {
            @Override
            public void write(JsonWriter out, ResponseBodyContentError403 value)
                throws IOException {
