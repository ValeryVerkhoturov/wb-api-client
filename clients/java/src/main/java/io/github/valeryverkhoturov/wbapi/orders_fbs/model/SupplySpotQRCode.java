...
public class SupplySpotQRCode {
  ...
  public boolean equals(Object o) {
    ...
    SupplySpotQRCode supplySpotQRCode = (SupplySpotQRCode) o;
    return Objects.equals(this.qrCode, supplySpotQRCode.qrCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class SupplySpotQRCode {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SupplySpotQRCode
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SupplySpotQRCode.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SupplySpotQRCode is not found in the empty JSON string", SupplySpotQRCode.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SupplySpotQRCode.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SupplySpotQRCode` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SupplySpotQRCode.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SupplySpotQRCode' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SupplySpotQRCode> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SupplySpotQRCode.class));

       return (TypeAdapter<T>) new TypeAdapter<SupplySpotQRCode>() {
           @Override
           public void write(JsonWriter out, SupplySpotQRCode value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SupplySpotQRCode read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SupplySpotQRCode given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SupplySpotQRCode
   * @throws IOException if the JSON string is invalid with respect to SupplySpotQRCode
   */
  public static SupplySpotQRCode fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SupplySpotQRCode.class);
  }

  /**
   * Convert an instance of SupplySpotQRCode to an JSON string
   *
   * @return JSON string
   */
