...
public class V0GetDailyLimitsResponse {
  ...
  public V0GetDailyLimitsResponse addAdvertsItem(V0DailyLimitAdvert advertsItem) {
  ...
  public boolean equals(Object o) {
    ...
    V0GetDailyLimitsResponse v0GetDailyLimitsResponse = (V0GetDailyLimitsResponse) o;
    return Objects.equals(this.adverts, v0GetDailyLimitsResponse.adverts);
  }
  ...
  public String toString() {
    ...
    sb.append("class V0GetDailyLimitsResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to V0GetDailyLimitsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!V0GetDailyLimitsResponse.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in V0GetDailyLimitsResponse is not found in the empty JSON string",
                V0GetDailyLimitsResponse.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!V0GetDailyLimitsResponse.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `V0GetDailyLimitsResponse` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!V0GetDailyLimitsResponse.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'V0GetDailyLimitsResponse' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<V0GetDailyLimitsResponse> thisAdapter =
          gson.getDelegateAdapter(this, TypeToken.get(V0GetDailyLimitsResponse.class));

      return (TypeAdapter<T>)
          new TypeAdapter<V0GetDailyLimitsResponse>() {
            @Override
            public void write(JsonWriter out, V0GetDailyLimitsResponse value) throws IOException {
              JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              elementAdapter.write(out, obj);
            }

            @Override
            public V0GetDailyLimitsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of V0GetDailyLimitsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of V0GetDailyLimitsResponse
   * @throws IOException if the JSON string is invalid with respect to V0GetDailyLimitsResponse
   */
  public static V0GetDailyLimitsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V0GetDailyLimitsResponse.class);
  }

  /**
   * Convert an instance of V0GetDailyLimitsResponse to an JSON string
   *
   * @return JSON string
   */
