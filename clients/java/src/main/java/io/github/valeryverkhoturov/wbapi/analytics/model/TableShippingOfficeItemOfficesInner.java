...
public class TableShippingOfficeItemOfficesInner {
  ...
  public boolean equals(Object o) {
    ...
    TableShippingOfficeItemOfficesInner tableShippingOfficeItemOfficesInner =
        (TableShippingOfficeItemOfficesInner) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!TableShippingOfficeItemOfficesInner.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in TableShippingOfficeItemOfficesInner is not found in the empty JSON string",
                TableShippingOfficeItemOfficesInner.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!TableShippingOfficeItemOfficesInner.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `TableShippingOfficeItemOfficesInner` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!TableShippingOfficeItemOfficesInner.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'TableShippingOfficeItemOfficesInner' and its
        // subtypes
      }
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<TableShippingOfficeItemOfficesInner>() {
            @Override
            public void write(JsonWriter out, TableShippingOfficeItemOfficesInner value)
                throws IOException {
