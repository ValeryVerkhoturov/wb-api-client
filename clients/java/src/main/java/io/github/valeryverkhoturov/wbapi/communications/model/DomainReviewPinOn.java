...
/**
 * Gets or Sets domain.ReviewPinOn
 */
@JsonAdapter(DomainReviewPinOn.Adapter.class)
public enum DomainReviewPinOn {
  ...
  DomainReviewPinOn(String value) {
    this.value = value;
  }
  ...
  public static DomainReviewPinOn fromValue(String value) {
    for (DomainReviewPinOn b : DomainReviewPinOn.values()) {
  ...
  public static class Adapter extends TypeAdapter<DomainReviewPinOn> {
    @Override
    public void write(final JsonWriter jsonWriter, final DomainReviewPinOn enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DomainReviewPinOn read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DomainReviewPinOn.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DomainReviewPinOn.fromValue(value);
  }
}
