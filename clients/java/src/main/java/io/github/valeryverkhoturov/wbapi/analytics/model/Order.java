...
public class Order {
   ...
   * &#x60;cancel&#x60; — отменён - &#x60;return&#x60; — возвращён - &#x60;returnDefective&#x60; —
  ...
  /**
   * Тип отмены (при &#x60;\&quot;status\&quot;:\&quot;cancel\&quot;&#x60;): - &#x60;app&#x60; —
   * отказ до получения - &#x60;receipt&#x60; — отказ при получении - &#x60;expire&#x60; — истёк
   * срок получения - &#x60;other&#x60; — техническая отмена
   */
  ...
  public enum CancelTypeEnum {
    ...
    public static class Adapter extends TypeAdapter<CancelTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final CancelTypeEnum enumeration)
          throws IOException {
        jsonWriter.value(enumeration.getValue());
      }
  ...
  /**
   * Дата и время текущего статуса. При &#x60;\&quot;status\&quot;:\&quot;created\&quot;&#x60;
   * возвращается значение поля &#x60;createdAt&#x60;
   *
   * @return updatedAt
   */
  @jakarta.annotation.Nonnull
  ...
  /**
   * Федеральный округ склада. Если склад не в России, возвращается страна. [На данный
   * момент](https://dev.wildberries.ru/release-notes?id&#x3D;570) для складов WB может быть только
   * &#x60;\&quot;\&quot;&#x60;
   *
  ...
  public String toString() {
    ...
    sb.append("    destinationDistrict: ")
        .append(toIndentedString(destinationDistrict))
        .append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    if ((jsonObj.get("cancelType") != null && !jsonObj.get("cancelType").isJsonNull())
      ...
      throw new IllegalArgumentException(
          String.format(
              "Expected the field `cancelType` to be a primitive type in the JSON string but got `%s`",
              jsonObj.get("cancelType").toString()));
    }
    ...
    if (!jsonObj.get("destinationDistrict").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
              ...
              jsonObj.get("destinationDistrict").toString()));
    }
  }
