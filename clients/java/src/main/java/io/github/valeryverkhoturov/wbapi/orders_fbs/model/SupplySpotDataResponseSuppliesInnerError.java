...
public class SupplySpotDataResponseSuppliesInnerError {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!SupplySpotDataResponseSuppliesInnerError.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in SupplySpotDataResponseSuppliesInnerError is not found in the empty JSON string",
                SupplySpotDataResponseSuppliesInnerError.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!SupplySpotDataResponseSuppliesInnerError.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `SupplySpotDataResponseSuppliesInnerError` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!SupplySpotDataResponseSuppliesInnerError.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'SupplySpotDataResponseSuppliesInnerError' and
        // its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<SupplySpotDataResponseSuppliesInnerError> thisAdapter =
          gson.getDelegateAdapter(
              this, TypeToken.get(SupplySpotDataResponseSuppliesInnerError.class));

      return (TypeAdapter<T>)
          new TypeAdapter<SupplySpotDataResponseSuppliesInnerError>() {
            @Override
            public void write(JsonWriter out, SupplySpotDataResponseSuppliesInnerError value)
                throws IOException {
   ...
   *     SupplySpotDataResponseSuppliesInnerError
   */
  public static SupplySpotDataResponseSuppliesInnerError fromJson(String jsonString)
      throws IOException {
