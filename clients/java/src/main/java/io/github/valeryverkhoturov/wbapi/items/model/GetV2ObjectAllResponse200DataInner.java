...
public class GetV2ObjectAllResponse200DataInner {
  ...
  public GetV2ObjectAllResponse200DataInner subjectID(
  ...
  public GetV2ObjectAllResponse200DataInner parentID(
      @jakarta.annotation.Nullable Integer parentID) {
  ...
  public GetV2ObjectAllResponse200DataInner subjectName(
  ...
  public GetV2ObjectAllResponse200DataInner parentName(
      @jakarta.annotation.Nullable String parentName) {
  ...
  public boolean equals(Object o) {
    ...
    GetV2ObjectAllResponse200DataInner getV2ObjectAllResponse200DataInner =
        (GetV2ObjectAllResponse200DataInner) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!GetV2ObjectAllResponse200DataInner.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in GetV2ObjectAllResponse200DataInner is not found in the empty JSON string",
                GetV2ObjectAllResponse200DataInner.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!GetV2ObjectAllResponse200DataInner.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `GetV2ObjectAllResponse200DataInner` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!GetV2ObjectAllResponse200DataInner.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'GetV2ObjectAllResponse200DataInner' and its
        // subtypes
      }
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<GetV2ObjectAllResponse200DataInner>() {
            @Override
            public void write(JsonWriter out, GetV2ObjectAllResponse200DataInner value)
                throws IOException {
