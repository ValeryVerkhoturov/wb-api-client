...
public class GetV2ObjectAllResponse200DataInner {
  ...
  public GetV2ObjectAllResponse200DataInner() {
  }

  public GetV2ObjectAllResponse200DataInner subjectID(@jakarta.annotation.Nullable Integer subjectID) {
  ...
  public GetV2ObjectAllResponse200DataInner parentID(@jakarta.annotation.Nullable Integer parentID) {
  ...
  public GetV2ObjectAllResponse200DataInner subjectName(@jakarta.annotation.Nullable String subjectName) {
  ...
  public GetV2ObjectAllResponse200DataInner parentName(@jakarta.annotation.Nullable String parentName) {
  ...
  public boolean equals(Object o) {
    ...
    GetV2ObjectAllResponse200DataInner getV2ObjectAllResponse200DataInner = (GetV2ObjectAllResponse200DataInner) o;
    return Objects.equals(this.subjectID, getV2ObjectAllResponse200DataInner.subjectID) &&
        Objects.equals(this.parentID, getV2ObjectAllResponse200DataInner.parentID) &&
        Objects.equals(this.subjectName, getV2ObjectAllResponse200DataInner.subjectName) &&
        Objects.equals(this.parentName, getV2ObjectAllResponse200DataInner.parentName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subjectID, parentID, subjectName, parentName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetV2ObjectAllResponse200DataInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetV2ObjectAllResponse200DataInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetV2ObjectAllResponse200DataInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetV2ObjectAllResponse200DataInner is not found in the empty JSON string", GetV2ObjectAllResponse200DataInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetV2ObjectAllResponse200DataInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetV2ObjectAllResponse200DataInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetV2ObjectAllResponse200DataInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetV2ObjectAllResponse200DataInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetV2ObjectAllResponse200DataInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetV2ObjectAllResponse200DataInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GetV2ObjectAllResponse200DataInner>() {
           @Override
           public void write(JsonWriter out, GetV2ObjectAllResponse200DataInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetV2ObjectAllResponse200DataInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetV2ObjectAllResponse200DataInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetV2ObjectAllResponse200DataInner
   * @throws IOException if the JSON string is invalid with respect to GetV2ObjectAllResponse200DataInner
   */
  public static GetV2ObjectAllResponse200DataInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetV2ObjectAllResponse200DataInner.class);
  }

  /**
   * Convert an instance of GetV2ObjectAllResponse200DataInner to an JSON string
   *
   * @return JSON string
   */
