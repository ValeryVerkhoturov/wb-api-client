...
public class V2GetConfigResponse {
  ...
  /**
   * Шаг ставки в разменных единицах — 0,01 от базовой валюты [аккаунта
   * продавца](https://cmp.wildberries.ru/campaigns/finances) для CPM-кампаний
   *
   * @return cpmStep
   */
  @jakarta.annotation.Nonnull
  ...
  /**
   * Шаг ставки в разменных единицах — 0,01 от базовой валюты [аккаунта
   * продавца](https://cmp.wildberries.ru/campaigns/finances) для кампаний CPC
   *
   * @return cpcStep
   */
  @jakarta.annotation.Nonnull
   ...
   * [аккаунта продавца](https://cmp.wildberries.ru/campaigns/finances). Например, минимальная сумма
   * пополнения бюджета при &#x60;\&quot;minTopUp\&quot;: 10000&#x60; и
   * &#x60;\&quot;currency\&quot;: \&quot;UZS\&quot;&#x60; — 100 узбекских сум
   *
   * @return minTopUp
   */
  @jakarta.annotation.Nonnull
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!V2GetConfigResponse.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in V2GetConfigResponse is not found in the empty JSON string",
                V2GetConfigResponse.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!V2GetConfigResponse.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `V2GetConfigResponse` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<V2GetConfigResponse>() {
            @Override
