...
public class GetUsersResponseUsersInnerAccessInner {
  ...
  public GetUsersResponseUsersInnerAccessInner disabled(@jakarta.annotation.Nonnull Boolean disabled) {
  ...
  public boolean equals(Object o) {
    ...
    GetUsersResponseUsersInnerAccessInner getUsersResponseUsersInnerAccessInner = (GetUsersResponseUsersInnerAccessInner) o;
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetUsersResponseUsersInnerAccessInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetUsersResponseUsersInnerAccessInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetUsersResponseUsersInnerAccessInner is not found in the empty JSON string", GetUsersResponseUsersInnerAccessInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetUsersResponseUsersInnerAccessInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetUsersResponseUsersInnerAccessInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetUsersResponseUsersInnerAccessInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetUsersResponseUsersInnerAccessInner' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetUsersResponseUsersInnerAccessInner>() {
           @Override
           public void write(JsonWriter out, GetUsersResponseUsersInnerAccessInner value) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to GetUsersResponseUsersInnerAccessInner
   */
  public static GetUsersResponseUsersInnerAccessInner fromJson(String jsonString) throws IOException {
