...
public class SalesReportListRes {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.reportId, salesReportListRes.reportId)
        ...
        && Objects.equals(
            this.cashbackCommissionChangeSum, salesReportListRes.cashbackCommissionChangeSum)
  ...
  public String toString() {
    ...
    sb.append("    additionalPaymentSum: ")
        .append(toIndentedString(additionalPaymentSum))
        .append("\n");
    sb.append("    cashbackAmountSum: ").append(toIndentedString(cashbackAmountSum)).append("\n");
    sb.append("    cashbackDiscountSum: ")
        .append(toIndentedString(cashbackDiscountSum))
        .append("\n");
    sb.append("    cashbackCommissionChangeSum: ")
        .append(toIndentedString(cashbackCommissionChangeSum))
        .append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!SalesReportListRes.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in SalesReportListRes is not found in the empty JSON string",
                SalesReportListRes.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!SalesReportListRes.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `SalesReportListRes` properties. JSON: %s",
    ...
    if (!jsonObj.get("bankPaymentSum").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
              ...
              jsonObj.get("bankPaymentSum").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<SalesReportListRes>() {
            @Override
