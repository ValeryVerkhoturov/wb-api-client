...
public class ModelsErrorTableListPublicRespV2 {
  ...
  public ModelsErrorTableListPublicRespV2 addItemsItem(
      ModelsErrorTableListPublicRespV2Item itemsItem) {
    if (this.items == null) {
  ...
  public boolean equals(Object o) {
    ...
    ModelsErrorTableListPublicRespV2 modelsErrorTableListPublicRespV2 =
        (ModelsErrorTableListPublicRespV2) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ModelsErrorTableListPublicRespV2.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in ModelsErrorTableListPublicRespV2 is not found in the empty JSON string",
                ModelsErrorTableListPublicRespV2.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ModelsErrorTableListPublicRespV2.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `ModelsErrorTableListPublicRespV2` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!ModelsErrorTableListPublicRespV2.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'ModelsErrorTableListPublicRespV2' and its
        // subtypes
      }
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<ModelsErrorTableListPublicRespV2>() {
            @Override
            public void write(JsonWriter out, ModelsErrorTableListPublicRespV2 value)
                throws IOException {
