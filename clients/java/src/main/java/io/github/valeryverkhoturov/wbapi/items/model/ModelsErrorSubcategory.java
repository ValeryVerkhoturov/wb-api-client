...
public class ModelsErrorSubcategory {
  ...
  public boolean equals(Object o) {
    ...
    ModelsErrorSubcategory modelsErrorSubcategory = (ModelsErrorSubcategory) o;
    return Objects.equals(this.id, modelsErrorSubcategory.id) &&
        Objects.equals(this.name, modelsErrorSubcategory.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModelsErrorSubcategory {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModelsErrorSubcategory
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelsErrorSubcategory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModelsErrorSubcategory is not found in the empty JSON string", ModelsErrorSubcategory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelsErrorSubcategory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModelsErrorSubcategory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsErrorSubcategory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsErrorSubcategory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsErrorSubcategory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsErrorSubcategory.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsErrorSubcategory>() {
           @Override
           public void write(JsonWriter out, ModelsErrorSubcategory value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelsErrorSubcategory read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ModelsErrorSubcategory given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModelsErrorSubcategory
   * @throws IOException if the JSON string is invalid with respect to ModelsErrorSubcategory
   */
  public static ModelsErrorSubcategory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsErrorSubcategory.class);
  }

  /**
   * Convert an instance of ModelsErrorSubcategory to an JSON string
   *
   * @return JSON string
   */
