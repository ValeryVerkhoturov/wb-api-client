...
public class EventMessage {
  ...
  public EventMessage attachments(@jakarta.annotation.Nullable EventAttachments attachments) {
   ...
   */
  @jakarta.annotation.Nullable
  public EventAttachments getAttachments() {
    return attachments;
  }

  public void setAttachments(@jakarta.annotation.Nullable EventAttachments attachments) {
    this.attachments = attachments;
  }

  public EventMessage text(@jakarta.annotation.Nullable String text) {
    this.text = text;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attachments, eventMessage.attachments)
        && Objects.equals(this.text, eventMessage.text);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!EventMessage.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in EventMessage is not found in the empty JSON string",
                EventMessage.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!EventMessage.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `EventMessage` properties. JSON: %s",
    ...
    if (jsonObj.get("attachments") != null && !jsonObj.get("attachments").isJsonNull()) {
      EventAttachments.validateJsonElement(jsonObj.get("attachments"));
    }
