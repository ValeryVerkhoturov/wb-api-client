...
public class ResponseItemListAdditionalErrorsOneOf1 {
  ...
  public boolean equals(Object o) {
    ...
    ResponseItemListAdditionalErrorsOneOf1 responseItemListAdditionalErrorsOneOf1 =
        (ResponseItemListAdditionalErrorsOneOf1) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ResponseItemListAdditionalErrorsOneOf1.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in ResponseItemListAdditionalErrorsOneOf1 is not found in the empty JSON string",
                ResponseItemListAdditionalErrorsOneOf1.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ResponseItemListAdditionalErrorsOneOf1.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `ResponseItemListAdditionalErrorsOneOf1` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!ResponseItemListAdditionalErrorsOneOf1.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'ResponseItemListAdditionalErrorsOneOf1' and its
        // subtypes
      }
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<ResponseItemListAdditionalErrorsOneOf1>() {
            @Override
            public void write(JsonWriter out, ResponseItemListAdditionalErrorsOneOf1 value)
                throws IOException {
   ...
   *     ResponseItemListAdditionalErrorsOneOf1
   */
  public static ResponseItemListAdditionalErrorsOneOf1 fromJson(String jsonString)
      throws IOException {
