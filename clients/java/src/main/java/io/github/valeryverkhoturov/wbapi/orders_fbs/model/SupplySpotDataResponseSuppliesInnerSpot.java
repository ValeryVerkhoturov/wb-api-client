...
public class SupplySpotDataResponseSuppliesInnerSpot {
  /**
   * Статус СПОТ: - &#x60;pending&#x60; — ожидается результат формирования ДОПП — документа о
   * предстоящей поставке - &#x60;completed&#x60; — ДОПП успешно сформирован. Можно [получить
   * QR-код](./orders-fbs#tag/fbsSupplies/operation/getV3FbsSuppliesSupplyIdStickersSpot) -
  ...
  /**
   * Код ошибки от сервиса формирования ДОПП — документа о предстоящей поставке. Возвращается при
   * &#x60;\&quot;status\&quot;: \&quot;failed\&quot;&#x60;. Чтобы исправить ошибку, проверьте
   * данные СПОТ и [добавьте их в
   * поставку](./orders-fbs#tag/fbsSupplies/operation/getV3FbsSuppliesSupplyIdSpot) ещё раз
   */
  ...
  /**
   * Код страны перевозчика по
   * [ОКСМ](./orders-fbs#tag/fbsSupplies/operation/getV3FbsDictionariesCountriesOksm)
   *
  ...
  public SupplySpotDataResponseSuppliesInnerSpot trailerRegistrationNumber(
      @jakarta.annotation.Nullable String trailerRegistrationNumber) {
  ...
  public void setTrailerRegistrationNumber(
      @jakarta.annotation.Nullable String trailerRegistrationNumber) {
    this.trailerRegistrationNumber = trailerRegistrationNumber;
  }

  public SupplySpotDataResponseSuppliesInnerSpot errorCode(
      @jakarta.annotation.Nullable ErrorCodeEnum errorCode) {
  ...
  public boolean equals(Object o) {
    ...
    SupplySpotDataResponseSuppliesInnerSpot supplySpotDataResponseSuppliesInnerSpot =
        (SupplySpotDataResponseSuppliesInnerSpot) o;
    return Objects.equals(this.status, supplySpotDataResponseSuppliesInnerSpot.status)
        ...
        && Objects.equals(
            this.carrierTaxNumber, supplySpotDataResponseSuppliesInnerSpot.carrierTaxNumber)
        && Objects.equals(
            this.carrierCountryCode, supplySpotDataResponseSuppliesInnerSpot.carrierCountryCode)
        && Objects.equals(
            this.vehicleRegistrationNumber,
            supplySpotDataResponseSuppliesInnerSpot.vehicleRegistrationNumber)
        && Objects.equals(
            this.trailerRegistrationNumber,
            supplySpotDataResponseSuppliesInnerSpot.trailerRegistrationNumber)
  ...
  public String toString() {
    ...
    sb.append("    vehicleRegistrationNumber: ")
        .append(toIndentedString(vehicleRegistrationNumber))
        .append("\n");
    sb.append("    trailerRegistrationNumber: ")
        .append(toIndentedString(trailerRegistrationNumber))
        .append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!SupplySpotDataResponseSuppliesInnerSpot.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in SupplySpotDataResponseSuppliesInnerSpot is not found in the empty JSON string",
                SupplySpotDataResponseSuppliesInnerSpot.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!SupplySpotDataResponseSuppliesInnerSpot.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `SupplySpotDataResponseSuppliesInnerSpot` properties. JSON: %s",
    ...
    if (!jsonObj.get("vehicleRegistrationNumber").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
              ...
              jsonObj.get("vehicleRegistrationNumber").toString()));
    }
    if ((jsonObj.get("trailerRegistrationNumber") != null
            && !jsonObj.get("trailerRegistrationNumber").isJsonNull())
        && !jsonObj.get("trailerRegistrationNumber").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
              "Expected the field `trailerRegistrationNumber` to be a primitive type in the JSON string but got `%s`",
              jsonObj.get("trailerRegistrationNumber").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!SupplySpotDataResponseSuppliesInnerSpot.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'SupplySpotDataResponseSuppliesInnerSpot' and its
        // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<SupplySpotDataResponseSuppliesInnerSpot> thisAdapter =
          gson.getDelegateAdapter(
              this, TypeToken.get(SupplySpotDataResponseSuppliesInnerSpot.class));

      return (TypeAdapter<T>)
          new TypeAdapter<SupplySpotDataResponseSuppliesInnerSpot>() {
            @Override
            public void write(JsonWriter out, SupplySpotDataResponseSuppliesInnerSpot value)
                throws IOException {
   ...
   *     SupplySpotDataResponseSuppliesInnerSpot
   */
  public static SupplySpotDataResponseSuppliesInnerSpot fromJson(String jsonString)
      throws IOException {
