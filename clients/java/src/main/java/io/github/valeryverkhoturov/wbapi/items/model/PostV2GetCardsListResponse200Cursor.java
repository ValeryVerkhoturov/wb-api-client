...
public class PostV2GetCardsListResponse200Cursor {
  ...
  public PostV2GetCardsListResponse200Cursor updatedAt(
  ...
  public boolean equals(Object o) {
    ...
    PostV2GetCardsListResponse200Cursor postV2GetCardsListResponse200Cursor =
        (PostV2GetCardsListResponse200Cursor) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PostV2GetCardsListResponse200Cursor.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in PostV2GetCardsListResponse200Cursor is not found in the empty JSON string",
                PostV2GetCardsListResponse200Cursor.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PostV2GetCardsListResponse200Cursor.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `PostV2GetCardsListResponse200Cursor` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PostV2GetCardsListResponse200Cursor.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'PostV2GetCardsListResponse200Cursor' and its
        // subtypes
      }
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<PostV2GetCardsListResponse200Cursor>() {
            @Override
            public void write(JsonWriter out, PostV2GetCardsListResponse200Cursor value)
                throws IOException {
