...
public class V0BidRecommendationCPCLevels {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!V0BidRecommendationCPCLevels.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in V0BidRecommendationCPCLevels is not found in the empty JSON string",
                V0BidRecommendationCPCLevels.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!V0BidRecommendationCPCLevels.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `V0BidRecommendationCPCLevels` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<V0BidRecommendationCPCLevels>() {
            @Override
            public void write(JsonWriter out, V0BidRecommendationCPCLevels value)
                throws IOException {
