...
import io.github.valeryverkhoturov.wbapi.promotion.model.PostV1BidsMinResponse200BidsInner;
...
public class PostV1BidsMinResponse200 {
  ...
  public PostV1BidsMinResponse200 bids(@jakarta.annotation.Nonnull List<PostV1BidsMinResponse200BidsInner> bids) {
    this.bids = bids;
    return this;
  }

  public PostV1BidsMinResponse200 addBidsItem(PostV1BidsMinResponse200BidsInner bidsItem) {
    if (this.bids == null) {
  ...
  public boolean equals(Object o) {
    ...
    PostV1BidsMinResponse200 postV1BidsMinResponse200 = (PostV1BidsMinResponse200) o;
    return Objects.equals(this.bids, postV1BidsMinResponse200.bids);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostV1BidsMinResponse200 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PostV1BidsMinResponse200
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PostV1BidsMinResponse200.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PostV1BidsMinResponse200 is not found in the empty JSON string", PostV1BidsMinResponse200.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PostV1BidsMinResponse200.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PostV1BidsMinResponse200` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PostV1BidsMinResponse200.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PostV1BidsMinResponse200' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PostV1BidsMinResponse200> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PostV1BidsMinResponse200.class));

       return (TypeAdapter<T>) new TypeAdapter<PostV1BidsMinResponse200>() {
           @Override
           public void write(JsonWriter out, PostV1BidsMinResponse200 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PostV1BidsMinResponse200 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PostV1BidsMinResponse200 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PostV1BidsMinResponse200
   * @throws IOException if the JSON string is invalid with respect to PostV1BidsMinResponse200
   */
  public static PostV1BidsMinResponse200 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PostV1BidsMinResponse200.class);
  }

  /**
   * Convert an instance of PostV1BidsMinResponse200 to an JSON string
   *
   * @return JSON string
   */
