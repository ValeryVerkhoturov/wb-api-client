...
public class Pass {
  ...
  public int hashCode() {
    return Objects.hash(
        firstName, dateEnd, lastName, carModel, carNumber, officeName, officeAddress, officeId, id);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!Pass.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in Pass is not found in the empty JSON string",
                Pass.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!Pass.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `Pass` properties. JSON: %s",
    ...
    if ((jsonObj.get("carModel") != null && !jsonObj.get("carModel").isJsonNull())
        && !jsonObj.get("carModel").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
              "Expected the field `carModel` to be a primitive type in the JSON string but got `%s`",
              jsonObj.get("carModel").toString()));
    }
    if ((jsonObj.get("carNumber") != null && !jsonObj.get("carNumber").isJsonNull())
        && !jsonObj.get("carNumber").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
    ...
    if ((jsonObj.get("officeAddress") != null && !jsonObj.get("officeAddress").isJsonNull())
        && !jsonObj.get("officeAddress").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
              "Expected the field `officeAddress` to be a primitive type in the JSON string but got `%s`",
              jsonObj.get("officeAddress").toString()));
    }
  }
