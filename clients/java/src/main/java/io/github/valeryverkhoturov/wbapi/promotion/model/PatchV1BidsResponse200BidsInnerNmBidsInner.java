...
public class PatchV1BidsResponse200BidsInnerNmBidsInner {
  ...
  /**
   * Место размещения: - &#x60;search&#x60; — в поиске - &#x60;recommendations&#x60;— в
   * рекомендациях
   *
   * @return placement
   */
  ...
  public boolean equals(Object o) {
    ...
    PatchV1BidsResponse200BidsInnerNmBidsInner patchV1BidsResponse200BidsInnerNmBidsInner =
        (PatchV1BidsResponse200BidsInnerNmBidsInner) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PatchV1BidsResponse200BidsInnerNmBidsInner.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in PatchV1BidsResponse200BidsInnerNmBidsInner is not found in the empty JSON string",
                PatchV1BidsResponse200BidsInnerNmBidsInner.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PatchV1BidsResponse200BidsInnerNmBidsInner.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `PatchV1BidsResponse200BidsInnerNmBidsInner` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PatchV1BidsResponse200BidsInnerNmBidsInner.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'PatchV1BidsResponse200BidsInnerNmBidsInner' and
        // its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<PatchV1BidsResponse200BidsInnerNmBidsInner> thisAdapter =
          gson.getDelegateAdapter(
              this, TypeToken.get(PatchV1BidsResponse200BidsInnerNmBidsInner.class));

      return (TypeAdapter<T>)
          new TypeAdapter<PatchV1BidsResponse200BidsInnerNmBidsInner>() {
            @Override
            public void write(JsonWriter out, PatchV1BidsResponse200BidsInnerNmBidsInner value)
                throws IOException {
            ...
            @Override
            public PatchV1BidsResponse200BidsInnerNmBidsInner read(JsonReader in)
                throws IOException {
   ...
   *     PatchV1BidsResponse200BidsInnerNmBidsInner
   */
  public static PatchV1BidsResponse200BidsInnerNmBidsInner fromJson(String jsonString)
      throws IOException {
