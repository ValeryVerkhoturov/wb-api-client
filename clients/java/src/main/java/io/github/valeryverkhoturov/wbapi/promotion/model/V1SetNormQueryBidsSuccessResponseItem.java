...
public class V1SetNormQueryBidsSuccessResponseItem {
  ...
  public boolean equals(Object o) {
    ...
    V1SetNormQueryBidsSuccessResponseItem v1SetNormQueryBidsSuccessResponseItem =
        (V1SetNormQueryBidsSuccessResponseItem) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!V1SetNormQueryBidsSuccessResponseItem.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in V1SetNormQueryBidsSuccessResponseItem is not found in the empty JSON string",
                V1SetNormQueryBidsSuccessResponseItem.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!V1SetNormQueryBidsSuccessResponseItem.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `V1SetNormQueryBidsSuccessResponseItem` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!V1SetNormQueryBidsSuccessResponseItem.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'V1SetNormQueryBidsSuccessResponseItem' and its
        // subtypes
      }
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<V1SetNormQueryBidsSuccessResponseItem>() {
            @Override
            public void write(JsonWriter out, V1SetNormQueryBidsSuccessResponseItem value)
                throws IOException {
   ...
   *     V1SetNormQueryBidsSuccessResponseItem
   */
  public static V1SetNormQueryBidsSuccessResponseItem fromJson(String jsonString)
      throws IOException {
