...
public class StatDate {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dates, statDate.dates) && Objects.equals(this.stats, statDate.stats);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!StatDate.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in StatDate is not found in the empty JSON string",
                StatDate.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!StatDate.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `StatDate` properties. JSON: %s",
