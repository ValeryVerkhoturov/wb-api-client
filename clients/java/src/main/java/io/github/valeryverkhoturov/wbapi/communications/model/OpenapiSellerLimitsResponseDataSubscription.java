...
public class OpenapiSellerLimitsResponseDataSubscription {
  ...
  public boolean equals(Object o) {
    ...
    OpenapiSellerLimitsResponseDataSubscription openapiSellerLimitsResponseDataSubscription =
        (OpenapiSellerLimitsResponseDataSubscription) o;
    return Objects.equals(
            this.perUnitLimit, openapiSellerLimitsResponseDataSubscription.perUnitLimit)
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!OpenapiSellerLimitsResponseDataSubscription.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in OpenapiSellerLimitsResponseDataSubscription is not found in the empty JSON string",
                OpenapiSellerLimitsResponseDataSubscription.openapiRequiredFields.toString()));
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!OpenapiSellerLimitsResponseDataSubscription.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'OpenapiSellerLimitsResponseDataSubscription' and
        // its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<OpenapiSellerLimitsResponseDataSubscription> thisAdapter =
          gson.getDelegateAdapter(
              this, TypeToken.get(OpenapiSellerLimitsResponseDataSubscription.class));

      return (TypeAdapter<T>)
          new TypeAdapter<OpenapiSellerLimitsResponseDataSubscription>() {
            @Override
            public void write(JsonWriter out, OpenapiSellerLimitsResponseDataSubscription value)
                throws IOException {
            ...
            @Override
            public OpenapiSellerLimitsResponseDataSubscription read(JsonReader in)
                throws IOException {
   ...
   *     OpenapiSellerLimitsResponseDataSubscription
   */
  public static OpenapiSellerLimitsResponseDataSubscription fromJson(String jsonString)
      throws IOException {
