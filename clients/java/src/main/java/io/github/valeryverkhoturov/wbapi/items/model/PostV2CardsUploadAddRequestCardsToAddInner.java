...
public class PostV2CardsUploadAddRequestCardsToAddInner {
  ...
  public PostV2CardsUploadAddRequestCardsToAddInner brand(
  ...
  public PostV2CardsUploadAddRequestCardsToAddInner vendorCode(
  ...
  public PostV2CardsUploadAddRequestCardsToAddInner kizMarked(
  ...
  public PostV2CardsUploadAddRequestCardsToAddInner wholesale(
  ...
  public PostV2CardsUploadAddRequestCardsToAddInner title(
  ...
  public PostV2CardsUploadAddRequestCardsToAddInner dimensions(
      @jakarta.annotation.Nullable
          PostV2CardsUploadAddRequestCardsToAddInnerDimensions dimensions) {
  ...
  public PostV2CardsUploadAddRequestCardsToAddInner sizes(
      @jakarta.annotation.Nullable
          List<PostV2CardsUploadAddRequestCardsToAddInnerSizesInner> sizes) {
    this.sizes = sizes;
    return this;
  }

  public PostV2CardsUploadAddRequestCardsToAddInner addSizesItem(
      PostV2CardsUploadAddRequestCardsToAddInnerSizesInner sizesItem) {
    if (this.sizes == null) {
  ...
  public PostV2CardsUploadAddRequestCardsToAddInner characteristics(
      @jakarta.annotation.Nullable
  ...
  public PostV2CardsUploadAddRequestCardsToAddInner addCharacteristicsItem(
  ...
  public boolean equals(Object o) {
    ...
    PostV2CardsUploadAddRequestCardsToAddInner postV2CardsUploadAddRequestCardsToAddInner =
        (PostV2CardsUploadAddRequestCardsToAddInner) o;
    return Objects.equals(this.brand, postV2CardsUploadAddRequestCardsToAddInner.brand)
        ...
        && Objects.equals(
            this.characteristics, postV2CardsUploadAddRequestCardsToAddInner.characteristics)
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PostV2CardsUploadAddRequestCardsToAddInner.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in PostV2CardsUploadAddRequestCardsToAddInner is not found in the empty JSON string",
                PostV2CardsUploadAddRequestCardsToAddInner.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PostV2CardsUploadAddRequestCardsToAddInner.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `PostV2CardsUploadAddRequestCardsToAddInner` properties. JSON: %s",
    ...
    if (jsonObj.get("dimensions") != null && !jsonObj.get("dimensions").isJsonNull()) {
      PostV2CardsUploadAddRequestCardsToAddInnerDimensions.validateJsonElement(
    ...
    if (jsonObj.get("sizes") != null && !jsonObj.get("sizes").isJsonNull()) {
      ...
      if (jsonArraysizes != null) {
        ...
        for (int i = 0; i < jsonArraysizes.size(); i++) {
          PostV2CardsUploadAddRequestCardsToAddInnerSizesInner.validateJsonElement(
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PostV2CardsUploadAddRequestCardsToAddInner.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'PostV2CardsUploadAddRequestCardsToAddInner' and
        // its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<PostV2CardsUploadAddRequestCardsToAddInner> thisAdapter =
          gson.getDelegateAdapter(
              this, TypeToken.get(PostV2CardsUploadAddRequestCardsToAddInner.class));

      return (TypeAdapter<T>)
          new TypeAdapter<PostV2CardsUploadAddRequestCardsToAddInner>() {
            @Override
            public void write(JsonWriter out, PostV2CardsUploadAddRequestCardsToAddInner value)
                throws IOException {
            ...
            @Override
            public PostV2CardsUploadAddRequestCardsToAddInner read(JsonReader in)
                throws IOException {
   ...
   *     PostV2CardsUploadAddRequestCardsToAddInner
   */
  public static PostV2CardsUploadAddRequestCardsToAddInner fromJson(String jsonString)
      throws IOException {
