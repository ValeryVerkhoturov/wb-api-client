...
public class CountriesOKSMListCountriesInner {
  ...
  public boolean equals(Object o) {
    ...
    CountriesOKSMListCountriesInner countriesOKSMListCountriesInner =
        (CountriesOKSMListCountriesInner) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CountriesOKSMListCountriesInner.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in CountriesOKSMListCountriesInner is not found in the empty JSON string",
                CountriesOKSMListCountriesInner.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!CountriesOKSMListCountriesInner.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `CountriesOKSMListCountriesInner` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!CountriesOKSMListCountriesInner.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'CountriesOKSMListCountriesInner' and its
        // subtypes
      }
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<CountriesOKSMListCountriesInner>() {
            @Override
            public void write(JsonWriter out, CountriesOKSMListCountriesInner value)
                throws IOException {
