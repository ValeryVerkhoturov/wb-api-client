...
public class AcquiringReportListRes {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!AcquiringReportListRes.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in AcquiringReportListRes is not found in the empty JSON string",
                AcquiringReportListRes.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!AcquiringReportListRes.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `AcquiringReportListRes` properties. JSON: %s",
    ...
    if (!jsonObj.get("acquiringFeeVatSum").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
              ...
              jsonObj.get("acquiringFeeVatSum").toString()));
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<AcquiringReportListRes>() {
            @Override
