...
public class UpdateSuppliesShippingMethodResponse {
  ...
  public UpdateSuppliesShippingMethodResponse addResultsItem(
      UpdatedSuppliesShippingMethod resultsItem) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSuppliesShippingMethodResponse updateSuppliesShippingMethodResponse =
        (UpdateSuppliesShippingMethodResponse) o;
    return Objects.equals(this.results, updateSuppliesShippingMethodResponse.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSuppliesShippingMethodResponse {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!UpdateSuppliesShippingMethodResponse.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in UpdateSuppliesShippingMethodResponse is not found in the empty JSON string",
                UpdateSuppliesShippingMethodResponse.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!UpdateSuppliesShippingMethodResponse.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `UpdateSuppliesShippingMethodResponse` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!UpdateSuppliesShippingMethodResponse.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'UpdateSuppliesShippingMethodResponse' and its
        // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<UpdateSuppliesShippingMethodResponse> thisAdapter =
          gson.getDelegateAdapter(this, TypeToken.get(UpdateSuppliesShippingMethodResponse.class));

      return (TypeAdapter<T>)
          new TypeAdapter<UpdateSuppliesShippingMethodResponse>() {
            @Override
            public void write(JsonWriter out, UpdateSuppliesShippingMethodResponse value)
                throws IOException {
            ...
            @Override
            public UpdateSuppliesShippingMethodResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSuppliesShippingMethodResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSuppliesShippingMethodResponse
   * @throws IOException if the JSON string is invalid with respect to
   *     UpdateSuppliesShippingMethodResponse
   */
  public static UpdateSuppliesShippingMethodResponse fromJson(String jsonString)
      throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSuppliesShippingMethodResponse.class);
  }

  /**
   * Convert an instance of UpdateSuppliesShippingMethodResponse to an JSON string
   *
   * @return JSON string
   */
