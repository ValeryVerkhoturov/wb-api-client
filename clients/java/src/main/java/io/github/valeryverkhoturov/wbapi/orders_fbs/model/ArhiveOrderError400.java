...
public class ArhiveOrderError400 {
  ...
  public ArhiveOrderError400 errors(
      @jakarta.annotation.Nullable List<ArhiveOrderError400ErrorsInner> errors) {
    this.errors = errors;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ArhiveOrderError400.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in ArhiveOrderError400 is not found in the empty JSON string",
                ArhiveOrderError400.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ArhiveOrderError400.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `ArhiveOrderError400` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<ArhiveOrderError400>() {
            @Override
