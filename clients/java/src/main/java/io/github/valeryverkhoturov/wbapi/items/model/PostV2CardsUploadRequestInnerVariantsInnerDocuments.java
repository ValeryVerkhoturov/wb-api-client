...
public class PostV2CardsUploadRequestInnerVariantsInnerDocuments {
  ...
  public PostV2CardsUploadRequestInnerVariantsInnerDocuments items(
      @jakarta.annotation.Nullable List<DocumentsRequest> items) {
    this.items = items;
    return this;
  }

  public PostV2CardsUploadRequestInnerVariantsInnerDocuments addItemsItem(
  ...
  public PostV2CardsUploadRequestInnerVariantsInnerDocuments excludeDocuments(
  ...
  public boolean equals(Object o) {
    ...
    PostV2CardsUploadRequestInnerVariantsInnerDocuments
        postV2CardsUploadRequestInnerVariantsInnerDocuments =
            (PostV2CardsUploadRequestInnerVariantsInnerDocuments) o;
    return Objects.equals(this.items, postV2CardsUploadRequestInnerVariantsInnerDocuments.items)
        && Objects.equals(
            this.excludeDocuments,
            postV2CardsUploadRequestInnerVariantsInnerDocuments.excludeDocuments);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PostV2CardsUploadRequestInnerVariantsInnerDocuments.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in PostV2CardsUploadRequestInnerVariantsInnerDocuments is not found in the empty JSON string",
                PostV2CardsUploadRequestInnerVariantsInnerDocuments.openapiRequiredFields
                    .toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PostV2CardsUploadRequestInnerVariantsInnerDocuments.openapiFields.contains(
          entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `PostV2CardsUploadRequestInnerVariantsInnerDocuments` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PostV2CardsUploadRequestInnerVariantsInnerDocuments.class.isAssignableFrom(
          type.getRawType())) {
        return null; // this class only serializes
        // 'PostV2CardsUploadRequestInnerVariantsInnerDocuments' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<PostV2CardsUploadRequestInnerVariantsInnerDocuments> thisAdapter =
          gson.getDelegateAdapter(
              this, TypeToken.get(PostV2CardsUploadRequestInnerVariantsInnerDocuments.class));

      return (TypeAdapter<T>)
          new TypeAdapter<PostV2CardsUploadRequestInnerVariantsInnerDocuments>() {
            @Override
            public void write(
                JsonWriter out, PostV2CardsUploadRequestInnerVariantsInnerDocuments value)
                throws IOException {
            ...
            @Override
            public PostV2CardsUploadRequestInnerVariantsInnerDocuments read(JsonReader in)
                throws IOException {
   ...
   *     PostV2CardsUploadRequestInnerVariantsInnerDocuments
   */
  public static PostV2CardsUploadRequestInnerVariantsInnerDocuments fromJson(String jsonString)
      throws IOException {
    return JSON.getGson()
        .fromJson(jsonString, PostV2CardsUploadRequestInnerVariantsInnerDocuments.class);
  }
