...
public class GetV1PromotionCount403Response {
  ...
  public GetV1PromotionCount403Response timestamp(
  ...
  public boolean equals(Object o) {
    ...
    GetV1PromotionCount403Response getV1PromotionCount403Response =
        (GetV1PromotionCount403Response) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!GetV1PromotionCount403Response.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in GetV1PromotionCount403Response is not found in the empty JSON string",
                GetV1PromotionCount403Response.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!GetV1PromotionCount403Response.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `GetV1PromotionCount403Response` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<GetV1PromotionCount403Response>() {
            @Override
            public void write(JsonWriter out, GetV1PromotionCount403Response value)
                throws IOException {
