...
import io.github.valeryverkhoturov.wbapi.analytics.model.CommonInfo;
import io.github.valeryverkhoturov.wbapi.analytics.model.PositionInfo;
import io.github.valeryverkhoturov.wbapi.analytics.model.TableGroupItem;
import io.github.valeryverkhoturov.wbapi.analytics.model.VisibilityInfo;
...
public class MainResponse {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MainResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MainResponse is not found in the empty JSON string", MainResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MainResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MainResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MainResponse>() {
           @Override
