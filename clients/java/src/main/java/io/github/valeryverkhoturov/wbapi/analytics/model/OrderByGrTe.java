...
public class OrderByGrTe {
  ...
  public OrderByGrTe field(@jakarta.annotation.Nonnull FieldEnum field) {
    this.field = field;
    return this;
  }
  ...
  public OrderByGrTe mode(@jakarta.annotation.Nonnull ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrderByGrTe orderByGrTe = (OrderByGrTe) o;
    return Objects.equals(this.field, orderByGrTe.field)
        && Objects.equals(this.mode, orderByGrTe.mode);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderByGrTe
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!OrderByGrTe.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in OrderByGrTe is not found in the empty JSON string",
                OrderByGrTe.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!OrderByGrTe.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `OrderByGrTe` properties. JSON: %s",
                entry.getKey(), jsonElement.toString()));
      }
    }

    // check to make sure all required properties/fields are present in the JSON string
    for (String requiredField : OrderByGrTe.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!OrderByGrTe.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'OrderByGrTe' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<OrderByGrTe> thisAdapter =
          gson.getDelegateAdapter(this, TypeToken.get(OrderByGrTe.class));

      return (TypeAdapter<T>)
          new TypeAdapter<OrderByGrTe>() {
            @Override
            public void write(JsonWriter out, OrderByGrTe value) throws IOException {
              JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              elementAdapter.write(out, obj);
            }

            @Override
            public OrderByGrTe read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrderByGrTe given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderByGrTe
   * @throws IOException if the JSON string is invalid with respect to OrderByGrTe
   */
  public static OrderByGrTe fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderByGrTe.class);
  }

  /**
   * Convert an instance of OrderByGrTe to an JSON string
   *
   * @return JSON string
   */
