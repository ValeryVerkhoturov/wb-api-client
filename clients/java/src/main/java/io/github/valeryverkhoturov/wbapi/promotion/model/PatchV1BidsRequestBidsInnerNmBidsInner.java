...
public class PatchV1BidsRequestBidsInnerNmBidsInner {
  ...
  public enum PlacementEnum {
    ...
    public static class Adapter extends TypeAdapter<PlacementEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final PlacementEnum enumeration)
          throws IOException {
  ...
  public PatchV1BidsRequestBidsInnerNmBidsInner bidKopecks(
  ...
  public PatchV1BidsRequestBidsInnerNmBidsInner placement(
      @jakarta.annotation.Nonnull PlacementEnum placement) {
  ...
  public boolean equals(Object o) {
    ...
    PatchV1BidsRequestBidsInnerNmBidsInner patchV1BidsRequestBidsInnerNmBidsInner =
        (PatchV1BidsRequestBidsInnerNmBidsInner) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PatchV1BidsRequestBidsInnerNmBidsInner.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in PatchV1BidsRequestBidsInnerNmBidsInner is not found in the empty JSON string",
                PatchV1BidsRequestBidsInnerNmBidsInner.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PatchV1BidsRequestBidsInnerNmBidsInner.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `PatchV1BidsRequestBidsInnerNmBidsInner` properties. JSON: %s",
    ...
    if (!jsonObj.get("placement").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
              ...
              jsonObj.get("placement").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PatchV1BidsRequestBidsInnerNmBidsInner.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'PatchV1BidsRequestBidsInnerNmBidsInner' and its
        // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<PatchV1BidsRequestBidsInnerNmBidsInner> thisAdapter =
          gson.getDelegateAdapter(
              this, TypeToken.get(PatchV1BidsRequestBidsInnerNmBidsInner.class));

      return (TypeAdapter<T>)
          new TypeAdapter<PatchV1BidsRequestBidsInnerNmBidsInner>() {
            @Override
            public void write(JsonWriter out, PatchV1BidsRequestBidsInnerNmBidsInner value)
                throws IOException {
   ...
   *     PatchV1BidsRequestBidsInnerNmBidsInner
   */
  public static PatchV1BidsRequestBidsInnerNmBidsInner fromJson(String jsonString)
      throws IOException {
