...
public class PostV2CardsUpdateResponse413 {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PostV2CardsUpdateResponse413.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in PostV2CardsUpdateResponse413 is not found in the empty JSON string",
                PostV2CardsUpdateResponse413.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PostV2CardsUpdateResponse413.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `PostV2CardsUpdateResponse413` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<PostV2CardsUpdateResponse413>() {
            @Override
            public void write(JsonWriter out, PostV2CardsUpdateResponse413 value)
                throws IOException {
