...
public class PostV1BidsMinResponse200BidsInner {
  ...
  public PostV1BidsMinResponse200BidsInner addBidsItem(
      PostV1BidsMinResponse200BidsInnerBidsInner bidsItem) {
    if (this.bids == null) {
  ...
  public boolean equals(Object o) {
    ...
    PostV1BidsMinResponse200BidsInner postV1BidsMinResponse200BidsInner =
        (PostV1BidsMinResponse200BidsInner) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PostV1BidsMinResponse200BidsInner.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in PostV1BidsMinResponse200BidsInner is not found in the empty JSON string",
                PostV1BidsMinResponse200BidsInner.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PostV1BidsMinResponse200BidsInner.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `PostV1BidsMinResponse200BidsInner` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PostV1BidsMinResponse200BidsInner.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'PostV1BidsMinResponse200BidsInner' and its
        // subtypes
      }
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<PostV1BidsMinResponse200BidsInner>() {
            @Override
            public void write(JsonWriter out, PostV1BidsMinResponse200BidsInner value)
                throws IOException {
