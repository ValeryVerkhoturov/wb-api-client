...
public class History {
  ...
  public String toString() {
    ...
    sb.append("    addToCartConversion: ")
        .append(toIndentedString(addToCartConversion))
        .append("\n");
    sb.append("    cartToOrderConversion: ")
        .append(toIndentedString(cartToOrderConversion))
        .append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!History.openapiRequiredFields
        ...
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in History is not found in the empty JSON string",
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!History.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `History` properties. JSON: %s",
