...
public class PostV3SalesFunnelProductsHistoryResponse200Inner {
  ...
  public boolean equals(Object o) {
    ...
    PostV3SalesFunnelProductsHistoryResponse200Inner
        postV3SalesFunnelProductsHistoryResponse200Inner =
            (PostV3SalesFunnelProductsHistoryResponse200Inner) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PostV3SalesFunnelProductsHistoryResponse200Inner.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in PostV3SalesFunnelProductsHistoryResponse200Inner is not found in the empty JSON string",
                PostV3SalesFunnelProductsHistoryResponse200Inner.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PostV3SalesFunnelProductsHistoryResponse200Inner.openapiFields.contains(
          entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `PostV3SalesFunnelProductsHistoryResponse200Inner` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PostV3SalesFunnelProductsHistoryResponse200Inner.class.isAssignableFrom(
          type.getRawType())) {
        return null; // this class only serializes
        // 'PostV3SalesFunnelProductsHistoryResponse200Inner' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<PostV3SalesFunnelProductsHistoryResponse200Inner> thisAdapter =
          gson.getDelegateAdapter(
              this, TypeToken.get(PostV3SalesFunnelProductsHistoryResponse200Inner.class));

      return (TypeAdapter<T>)
          new TypeAdapter<PostV3SalesFunnelProductsHistoryResponse200Inner>() {
            @Override
            public void write(
                JsonWriter out, PostV3SalesFunnelProductsHistoryResponse200Inner value)
                throws IOException {
            ...
            @Override
            public PostV3SalesFunnelProductsHistoryResponse200Inner read(JsonReader in)
                throws IOException {
   ...
   *     PostV3SalesFunnelProductsHistoryResponse200Inner
   */
  public static PostV3SalesFunnelProductsHistoryResponse200Inner fromJson(String jsonString)
      throws IOException {
    return JSON.getGson()
        .fromJson(jsonString, PostV3SalesFunnelProductsHistoryResponse200Inner.class);
  }
