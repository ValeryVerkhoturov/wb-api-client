...
public class GetUsersResponseUsersInner {
  ...
  /**
   * Роль пользователя: * &#x60;user&#x60; — пользователь, который активировал доступ * &#x60;
  ...
  public GetUsersResponseUsersInner inviteeInfo(
      @jakarta.annotation.Nullable GetUsersResponseUsersInnerInviteeInfo inviteeInfo) {
  ...
  public GetUsersResponseUsersInner addAccessItem(
      GetUsersResponseUsersInnerAccessInner accessItem) {
    if (this.access == null) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!GetUsersResponseUsersInner.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in GetUsersResponseUsersInner is not found in the empty JSON string",
                GetUsersResponseUsersInner.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!GetUsersResponseUsersInner.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `GetUsersResponseUsersInner` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<GetUsersResponseUsersInner>() {
            @Override
