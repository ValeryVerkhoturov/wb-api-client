...
public class ApiClient {
  ...
  private void init() {
    ...
    setUserAgent("ValeryVerkhoturov/wb-api-client/java");
  ...
  /**
   * Store the WB bearer JWT wrapped in a {@link SecretString} so it redacts under toString().
   * Internally binds to the existing Supplier&lt;String&gt; path via secret::exposeSecret.
   */
   ...
   * @throws io.github.valeryverkhoturov.wbapi.in_store_pickup.ApiException If fail to deserialize
   *     response body, i.e. cannot read response body or the Content-Type of the response is not
   *     supported.
   */
  @SuppressWarnings("unchecked")
   ...
   * @throws io.github.valeryverkhoturov.wbapi.in_store_pickup.ApiException If fail to serialize the
   *     given object
   */
   ...
   * @throws io.github.valeryverkhoturov.wbapi.in_store_pickup.ApiException If fail to read file
   ...
   * @throws io.github.valeryverkhoturov.wbapi.in_store_pickup.ApiException If fail to execute the
   *     call
   */
   ...
   * @param returnType Return type
   * @return Type
   * @throws io.github.valeryverkhoturov.wbapi.in_store_pickup.ApiException If the response has an
   ...
   * @param uri URI
   * @throws io.github.valeryverkhoturov.wbapi.in_store_pickup.ApiException If fails to update the
   *     parameters
   */
