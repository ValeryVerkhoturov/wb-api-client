...
public class PostV3OrdersStickersResponse200StickersInner {
  ...
  public PostV3OrdersStickersResponse200StickersInner orderId(
  ...
  public PostV3OrdersStickersResponse200StickersInner partA(
  ...
  public PostV3OrdersStickersResponse200StickersInner partB(
  ...
  public PostV3OrdersStickersResponse200StickersInner barcode(
  ...
  public PostV3OrdersStickersResponse200StickersInner _file(
  ...
  public boolean equals(Object o) {
    ...
    PostV3OrdersStickersResponse200StickersInner postV3OrdersStickersResponse200StickersInner =
        (PostV3OrdersStickersResponse200StickersInner) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PostV3OrdersStickersResponse200StickersInner.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in PostV3OrdersStickersResponse200StickersInner is not found in the empty JSON string",
                PostV3OrdersStickersResponse200StickersInner.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PostV3OrdersStickersResponse200StickersInner.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `PostV3OrdersStickersResponse200StickersInner` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PostV3OrdersStickersResponse200StickersInner.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'PostV3OrdersStickersResponse200StickersInner'
        // and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<PostV3OrdersStickersResponse200StickersInner> thisAdapter =
          gson.getDelegateAdapter(
              this, TypeToken.get(PostV3OrdersStickersResponse200StickersInner.class));

      return (TypeAdapter<T>)
          new TypeAdapter<PostV3OrdersStickersResponse200StickersInner>() {
            @Override
            public void write(JsonWriter out, PostV3OrdersStickersResponse200StickersInner value)
                throws IOException {
            ...
            @Override
            public PostV3OrdersStickersResponse200StickersInner read(JsonReader in)
                throws IOException {
   ...
   *     PostV3OrdersStickersResponse200StickersInner
   */
  public static PostV3OrdersStickersResponse200StickersInner fromJson(String jsonString)
      throws IOException {
