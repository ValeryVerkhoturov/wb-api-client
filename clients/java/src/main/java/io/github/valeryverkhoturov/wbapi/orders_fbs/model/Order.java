...
public class Order {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(address, scanPrice, deliveryType, supplyId, orderUid, article, colorCode, rid, createdAt, offices, skus, id, warehouseId, officeId, nmId, chrtId, price, convertedPrice, currencyCode, convertedCurrencyCode, cargoType, crossBorderType, comment, isZeroOrder, options);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("supplyId") != null && !jsonObj.get("supplyId").isJsonNull()) && !jsonObj.get("supplyId").isJsonPrimitive()) {
