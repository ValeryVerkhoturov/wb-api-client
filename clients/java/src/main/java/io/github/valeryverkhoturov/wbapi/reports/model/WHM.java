...
import io.github.valeryverkhoturov.wbapi.reports.model.WHMData;
...
public class WHM {
  ...
  public boolean equals(Object o) {
    ...
    WHM WHM = (WHM) o;
    return Objects.equals(this.data, WHM.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WHM
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WHM.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WHM is not found in the empty JSON string", WHM.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WHM.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WHM` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WHM.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WHM' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WHM> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WHM.class));

       return (TypeAdapter<T>) new TypeAdapter<WHM>() {
           @Override
           public void write(JsonWriter out, WHM value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WHM read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WHM given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WHM
   * @throws IOException if the JSON string is invalid with respect to WHM
   */
  public static WHM fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WHM.class);
  }

  /**
   * Convert an instance of WHM to an JSON string
   *
   * @return JSON string
   */
