...
public class GetAdvertsAdvertsInner {
  ...
  public GetAdvertsAdvertsInner nmSettings(
      @jakarta.annotation.Nullable List<AdvertNMsSettings> nmSettings) {
  ...
  public int hashCode() {
    return Objects.hash(
        bidType, currency, id, nmSettings, settings, restrictions, status, timestamps);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!GetAdvertsAdvertsInner.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in GetAdvertsAdvertsInner is not found in the empty JSON string",
                GetAdvertsAdvertsInner.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!GetAdvertsAdvertsInner.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `GetAdvertsAdvertsInner` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<GetAdvertsAdvertsInner>() {
            @Override
