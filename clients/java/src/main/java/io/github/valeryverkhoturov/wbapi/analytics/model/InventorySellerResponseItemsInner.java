...
public class InventorySellerResponseItemsInner {
  ...
  public InventorySellerResponseItemsInner warehouseId(@jakarta.annotation.Nonnull Long warehouseId) {
  ...
  public InventorySellerResponseItemsInner warehouseName(@jakarta.annotation.Nonnull String warehouseName) {
  ...
  public InventorySellerResponseItemsInner regionName(@jakarta.annotation.Nonnull String regionName) {
  ...
  public boolean equals(Object o) {
    ...
    InventorySellerResponseItemsInner inventorySellerResponseItemsInner = (InventorySellerResponseItemsInner) o;
   ...
   * @throws IOException if the JSON Element is invalid with respect to InventorySellerResponseItemsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InventorySellerResponseItemsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InventorySellerResponseItemsInner is not found in the empty JSON string", InventorySellerResponseItemsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InventorySellerResponseItemsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InventorySellerResponseItemsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InventorySellerResponseItemsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InventorySellerResponseItemsInner' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<InventorySellerResponseItemsInner>() {
           @Override
           public void write(JsonWriter out, InventorySellerResponseItemsInner value) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to InventorySellerResponseItemsInner
   */
