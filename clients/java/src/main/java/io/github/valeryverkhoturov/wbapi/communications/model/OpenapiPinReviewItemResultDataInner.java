...
public class OpenapiPinReviewItemResultDataInner {
  ...
  public enum PinMethodEnum {
    ...
    public static class Adapter extends TypeAdapter<PinMethodEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final PinMethodEnum enumeration)
          throws IOException {
  ...
  public enum PinOnEnum {
    ...
    public static class Adapter extends TypeAdapter<PinOnEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final PinOnEnum enumeration)
          throws IOException {
        jsonWriter.value(enumeration.getValue());
      }
  ...
  public OpenapiPinReviewItemResultDataInner errors(
      @jakarta.annotation.Nullable List<OpenapiResultErr> errors) {
    this.errors = errors;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    OpenapiPinReviewItemResultDataInner openapiPinReviewItemResultDataInner =
        (OpenapiPinReviewItemResultDataInner) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!OpenapiPinReviewItemResultDataInner.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in OpenapiPinReviewItemResultDataInner is not found in the empty JSON string",
                OpenapiPinReviewItemResultDataInner.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!OpenapiPinReviewItemResultDataInner.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `OpenapiPinReviewItemResultDataInner` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!OpenapiPinReviewItemResultDataInner.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'OpenapiPinReviewItemResultDataInner' and its
        // subtypes
      }
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<OpenapiPinReviewItemResultDataInner>() {
            @Override
            public void write(JsonWriter out, OpenapiPinReviewItemResultDataInner value)
                throws IOException {
