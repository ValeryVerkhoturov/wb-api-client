...
import io.github.valeryverkhoturov.wbapi.analytics.model.TableItemItemStMetrics;
...
public class TableItemItemSt {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(nmID, isDeleted, subjectName, name, vendorCode, brandName, mainPhoto, hasSizes, metrics);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TableItemItemSt.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TableItemItemSt is not found in the empty JSON string", TableItemItemSt.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TableItemItemSt.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TableItemItemSt` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TableItemItemSt>() {
           @Override
