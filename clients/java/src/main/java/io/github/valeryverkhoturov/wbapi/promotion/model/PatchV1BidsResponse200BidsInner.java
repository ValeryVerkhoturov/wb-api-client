...
public class PatchV1BidsResponse200BidsInner {
  ...
  public PatchV1BidsResponse200BidsInner addNmBidsItem(
      PatchV1BidsResponse200BidsInnerNmBidsInner nmBidsItem) {
    if (this.nmBids == null) {
  ...
  public boolean equals(Object o) {
    ...
    PatchV1BidsResponse200BidsInner patchV1BidsResponse200BidsInner =
        (PatchV1BidsResponse200BidsInner) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PatchV1BidsResponse200BidsInner.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in PatchV1BidsResponse200BidsInner is not found in the empty JSON string",
                PatchV1BidsResponse200BidsInner.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PatchV1BidsResponse200BidsInner.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `PatchV1BidsResponse200BidsInner` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PatchV1BidsResponse200BidsInner.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'PatchV1BidsResponse200BidsInner' and its
        // subtypes
      }
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<PatchV1BidsResponse200BidsInner>() {
            @Override
            public void write(JsonWriter out, PatchV1BidsResponse200BidsInner value)
                throws IOException {
