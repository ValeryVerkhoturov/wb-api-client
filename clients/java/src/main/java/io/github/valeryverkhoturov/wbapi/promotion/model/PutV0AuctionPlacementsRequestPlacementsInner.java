...
public class PutV0AuctionPlacementsRequestPlacementsInner {
  ...
  public PutV0AuctionPlacementsRequestPlacementsInner advertId(
      @jakarta.annotation.Nonnull Long advertId) {
  ...
  public PutV0AuctionPlacementsRequestPlacementsInner placements(
      @jakarta.annotation.Nonnull
  ...
  public boolean equals(Object o) {
    ...
    PutV0AuctionPlacementsRequestPlacementsInner putV0AuctionPlacementsRequestPlacementsInner =
        (PutV0AuctionPlacementsRequestPlacementsInner) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PutV0AuctionPlacementsRequestPlacementsInner.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in PutV0AuctionPlacementsRequestPlacementsInner is not found in the empty JSON string",
                PutV0AuctionPlacementsRequestPlacementsInner.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PutV0AuctionPlacementsRequestPlacementsInner.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `PutV0AuctionPlacementsRequestPlacementsInner` properties. JSON: %s",
    ...
    for (String requiredField :
        PutV0AuctionPlacementsRequestPlacementsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PutV0AuctionPlacementsRequestPlacementsInner.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'PutV0AuctionPlacementsRequestPlacementsInner'
        // and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<PutV0AuctionPlacementsRequestPlacementsInner> thisAdapter =
          gson.getDelegateAdapter(
              this, TypeToken.get(PutV0AuctionPlacementsRequestPlacementsInner.class));

      return (TypeAdapter<T>)
          new TypeAdapter<PutV0AuctionPlacementsRequestPlacementsInner>() {
            @Override
            public void write(JsonWriter out, PutV0AuctionPlacementsRequestPlacementsInner value)
                throws IOException {
            ...
            @Override
            public PutV0AuctionPlacementsRequestPlacementsInner read(JsonReader in)
                throws IOException {
   ...
   *     PutV0AuctionPlacementsRequestPlacementsInner
   */
  public static PutV0AuctionPlacementsRequestPlacementsInner fromJson(String jsonString)
      throws IOException {
