...
public class WbClubMetricsDynamic {
  ...
  public WbClubMetricsDynamic() {
  }

  public WbClubMetricsDynamic orderCount(@jakarta.annotation.Nonnull Integer orderCount) {
  ...
  public WbClubMetricsDynamic orderSum(@jakarta.annotation.Nonnull Integer orderSum) {
  ...
  public WbClubMetricsDynamic buyoutSum(@jakarta.annotation.Nonnull Integer buyoutSum) {
  ...
  public WbClubMetricsDynamic buyoutCount(@jakarta.annotation.Nonnull Integer buyoutCount) {
  ...
  public WbClubMetricsDynamic cancelSum(@jakarta.annotation.Nonnull Integer cancelSum) {
  ...
  public WbClubMetricsDynamic cancelCount(@jakarta.annotation.Nonnull Integer cancelCount) {
  ...
  public WbClubMetricsDynamic avgPrice(@jakarta.annotation.Nonnull Integer avgPrice) {
  ...
  public WbClubMetricsDynamic buyoutPercent(@jakarta.annotation.Nonnull Integer buyoutPercent) {
  ...
  public WbClubMetricsDynamic avgOrderCountPerDay(@jakarta.annotation.Nonnull BigDecimal avgOrderCountPerDay) {
  ...
  public boolean equals(Object o) {
    ...
    WbClubMetricsDynamic wbClubMetricsDynamic = (WbClubMetricsDynamic) o;
    return Objects.equals(this.orderCount, wbClubMetricsDynamic.orderCount) &&
        Objects.equals(this.orderSum, wbClubMetricsDynamic.orderSum) &&
        Objects.equals(this.buyoutSum, wbClubMetricsDynamic.buyoutSum) &&
        Objects.equals(this.buyoutCount, wbClubMetricsDynamic.buyoutCount) &&
        Objects.equals(this.cancelSum, wbClubMetricsDynamic.cancelSum) &&
        Objects.equals(this.cancelCount, wbClubMetricsDynamic.cancelCount) &&
        Objects.equals(this.avgPrice, wbClubMetricsDynamic.avgPrice) &&
        Objects.equals(this.buyoutPercent, wbClubMetricsDynamic.buyoutPercent) &&
        Objects.equals(this.avgOrderCountPerDay, wbClubMetricsDynamic.avgOrderCountPerDay);
  }
  ...
  public String toString() {
    ...
    sb.append("class WbClubMetricsDynamic {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WbClubMetricsDynamic
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WbClubMetricsDynamic.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WbClubMetricsDynamic is not found in the empty JSON string", WbClubMetricsDynamic.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WbClubMetricsDynamic.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WbClubMetricsDynamic` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WbClubMetricsDynamic.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WbClubMetricsDynamic.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WbClubMetricsDynamic' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WbClubMetricsDynamic> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WbClubMetricsDynamic.class));

       return (TypeAdapter<T>) new TypeAdapter<WbClubMetricsDynamic>() {
           @Override
           public void write(JsonWriter out, WbClubMetricsDynamic value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WbClubMetricsDynamic read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WbClubMetricsDynamic given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WbClubMetricsDynamic
   * @throws IOException if the JSON string is invalid with respect to WbClubMetricsDynamic
   */
  public static WbClubMetricsDynamic fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WbClubMetricsDynamic.class);
  }

  /**
   * Convert an instance of WbClubMetricsDynamic to an JSON string
   *
   * @return JSON string
   */
