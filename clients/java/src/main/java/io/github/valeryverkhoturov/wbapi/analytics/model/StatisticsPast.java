...
public class StatisticsPast {
  ...
  public StatisticsPast avgOrdersCountPerDay(
  ...
  public StatisticsPast shareOrderPercent(
  ...
  public StatisticsPast localizationPercent(
  ...
  /**
   * Локальные заказы в рамках одного региона. [На данный
   * момент](https://dev.wildberries.ru/release-notes?id&#x3D;570) может быть только &#x60;100&#x60;
   *
  ...
  public String toString() {
    ...
    sb.append("    avgOrdersCountPerDay: ")
        .append(toIndentedString(avgOrdersCountPerDay))
        .append("\n");
    ...
    sb.append("    localizationPercent: ")
        .append(toIndentedString(localizationPercent))
        .append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!StatisticsPast.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in StatisticsPast is not found in the empty JSON string",
                StatisticsPast.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!StatisticsPast.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `StatisticsPast` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<StatisticsPast>() {
            @Override
