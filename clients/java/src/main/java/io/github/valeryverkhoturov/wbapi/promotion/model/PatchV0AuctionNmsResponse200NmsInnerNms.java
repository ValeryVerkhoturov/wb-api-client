...
public class PatchV0AuctionNmsResponse200NmsInnerNms {
  ...
  public boolean equals(Object o) {
    ...
    PatchV0AuctionNmsResponse200NmsInnerNms patchV0AuctionNmsResponse200NmsInnerNms =
        (PatchV0AuctionNmsResponse200NmsInnerNms) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PatchV0AuctionNmsResponse200NmsInnerNms.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in PatchV0AuctionNmsResponse200NmsInnerNms is not found in the empty JSON string",
                PatchV0AuctionNmsResponse200NmsInnerNms.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PatchV0AuctionNmsResponse200NmsInnerNms.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `PatchV0AuctionNmsResponse200NmsInnerNms` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PatchV0AuctionNmsResponse200NmsInnerNms.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'PatchV0AuctionNmsResponse200NmsInnerNms' and its
        // subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<PatchV0AuctionNmsResponse200NmsInnerNms> thisAdapter =
          gson.getDelegateAdapter(
              this, TypeToken.get(PatchV0AuctionNmsResponse200NmsInnerNms.class));

      return (TypeAdapter<T>)
          new TypeAdapter<PatchV0AuctionNmsResponse200NmsInnerNms>() {
            @Override
            public void write(JsonWriter out, PatchV0AuctionNmsResponse200NmsInnerNms value)
                throws IOException {
   ...
   *     PatchV0AuctionNmsResponse200NmsInnerNms
   */
  public static PatchV0AuctionNmsResponse200NmsInnerNms fromJson(String jsonString)
      throws IOException {
