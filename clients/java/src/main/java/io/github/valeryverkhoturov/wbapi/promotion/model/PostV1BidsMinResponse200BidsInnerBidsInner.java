...
public class PostV1BidsMinResponse200BidsInnerBidsInner {
  ...
  public boolean equals(Object o) {
    ...
    PostV1BidsMinResponse200BidsInnerBidsInner postV1BidsMinResponse200BidsInnerBidsInner =
        (PostV1BidsMinResponse200BidsInnerBidsInner) o;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PostV1BidsMinResponse200BidsInnerBidsInner.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in PostV1BidsMinResponse200BidsInnerBidsInner is not found in the empty JSON string",
                PostV1BidsMinResponse200BidsInnerBidsInner.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PostV1BidsMinResponse200BidsInnerBidsInner.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `PostV1BidsMinResponse200BidsInnerBidsInner` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PostV1BidsMinResponse200BidsInnerBidsInner.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'PostV1BidsMinResponse200BidsInnerBidsInner' and
        // its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<PostV1BidsMinResponse200BidsInnerBidsInner> thisAdapter =
          gson.getDelegateAdapter(
              this, TypeToken.get(PostV1BidsMinResponse200BidsInnerBidsInner.class));

      return (TypeAdapter<T>)
          new TypeAdapter<PostV1BidsMinResponse200BidsInnerBidsInner>() {
            @Override
            public void write(JsonWriter out, PostV1BidsMinResponse200BidsInnerBidsInner value)
                throws IOException {
            ...
            @Override
            public PostV1BidsMinResponse200BidsInnerBidsInner read(JsonReader in)
                throws IOException {
   ...
   *     PostV1BidsMinResponse200BidsInnerBidsInner
   */
  public static PostV1BidsMinResponse200BidsInnerBidsInner fromJson(String jsonString)
      throws IOException {
