...
public class MediaErrors {
  ...
  public MediaErrors additionalErrors(@jakarta.annotation.Nullable Object additionalErrors) {
  ...
  public MediaErrors data(@jakarta.annotation.Nullable Object data) {
    this.data = data;
    return this;
  }
  ...
  public MediaErrors error(@jakarta.annotation.Nullable Boolean error) {
    this.error = error;
    return this;
  }
  ...
  public MediaErrors errorText(@jakarta.annotation.Nullable String errorText) {
  ...
  public boolean equals(Object o) {
    ...
    MediaErrors mediaErrors = (MediaErrors) o;
    return Objects.equals(this.additionalErrors, mediaErrors.additionalErrors) &&
        Objects.equals(this.data, mediaErrors.data) &&
        Objects.equals(this.error, mediaErrors.error) &&
        Objects.equals(this.errorText, mediaErrors.errorText);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediaErrors
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MediaErrors.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MediaErrors is not found in the empty JSON string", MediaErrors.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MediaErrors.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MediaErrors` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediaErrors.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediaErrors' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediaErrors> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediaErrors.class));

       return (TypeAdapter<T>) new TypeAdapter<MediaErrors>() {
           @Override
           public void write(JsonWriter out, MediaErrors value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediaErrors read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediaErrors given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediaErrors
   * @throws IOException if the JSON string is invalid with respect to MediaErrors
   */
  public static MediaErrors fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediaErrors.class);
  }

  /**
   * Convert an instance of MediaErrors to an JSON string
   *
   * @return JSON string
   */
