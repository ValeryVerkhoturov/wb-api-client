...
public class PostV3SalesFunnelProductsHistoryResponse200InnerProduct {
  ...
  public boolean equals(Object o) {
    ...
    PostV3SalesFunnelProductsHistoryResponse200InnerProduct
        postV3SalesFunnelProductsHistoryResponse200InnerProduct =
            (PostV3SalesFunnelProductsHistoryResponse200InnerProduct) o;
    return Objects.equals(this.nmId, postV3SalesFunnelProductsHistoryResponse200InnerProduct.nmId)
        ...
        && Objects.equals(
            this.vendorCode, postV3SalesFunnelProductsHistoryResponse200InnerProduct.vendorCode)
        && Objects.equals(
            this.brandName, postV3SalesFunnelProductsHistoryResponse200InnerProduct.brandName)
        && Objects.equals(
            this.subjectId, postV3SalesFunnelProductsHistoryResponse200InnerProduct.subjectId)
        && Objects.equals(
            this.subjectName, postV3SalesFunnelProductsHistoryResponse200InnerProduct.subjectName);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PostV3SalesFunnelProductsHistoryResponse200InnerProduct.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in PostV3SalesFunnelProductsHistoryResponse200InnerProduct is not found in the empty JSON string",
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!PostV3SalesFunnelProductsHistoryResponse200InnerProduct.openapiFields.contains(
          entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `PostV3SalesFunnelProductsHistoryResponse200InnerProduct` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!PostV3SalesFunnelProductsHistoryResponse200InnerProduct.class.isAssignableFrom(
          type.getRawType())) {
        return null; // this class only serializes
        // 'PostV3SalesFunnelProductsHistoryResponse200InnerProduct' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<PostV3SalesFunnelProductsHistoryResponse200InnerProduct> thisAdapter =
          gson.getDelegateAdapter(
              this, TypeToken.get(PostV3SalesFunnelProductsHistoryResponse200InnerProduct.class));

      return (TypeAdapter<T>)
          new TypeAdapter<PostV3SalesFunnelProductsHistoryResponse200InnerProduct>() {
            @Override
            public void write(
                JsonWriter out, PostV3SalesFunnelProductsHistoryResponse200InnerProduct value)
                throws IOException {
            ...
            @Override
            public PostV3SalesFunnelProductsHistoryResponse200InnerProduct read(JsonReader in)
                throws IOException {
  ...
  /**
   * Create an instance of PostV3SalesFunnelProductsHistoryResponse200InnerProduct given an JSON
   * string
   *
   ...
   *     PostV3SalesFunnelProductsHistoryResponse200InnerProduct
   */
  public static PostV3SalesFunnelProductsHistoryResponse200InnerProduct fromJson(String jsonString)
      throws IOException {
    return JSON.getGson()
        .fromJson(jsonString, PostV3SalesFunnelProductsHistoryResponse200InnerProduct.class);
  }

  /**
   * Convert an instance of PostV3SalesFunnelProductsHistoryResponse200InnerProduct to an JSON
   * string
   *
   * @return JSON string
   */
