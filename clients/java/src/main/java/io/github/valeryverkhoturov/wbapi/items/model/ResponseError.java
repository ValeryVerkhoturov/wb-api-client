...
public class ResponseError {
  ...
  public ResponseError data(@jakarta.annotation.Nullable Object data) {
    this.data = data;
    return this;
  }
  ...
  public ResponseError error(@jakarta.annotation.Nullable Boolean error) {
    this.error = error;
    return this;
  }
  ...
  public ResponseError errorText(@jakarta.annotation.Nullable String errorText) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, responseError.data)
        && Objects.equals(this.error, responseError.error)
        && Objects.equals(this.errorText, responseError.errorText);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ResponseError.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in ResponseError is not found in the empty JSON string",
                ResponseError.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!ResponseError.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `ResponseError` properties. JSON: %s",
