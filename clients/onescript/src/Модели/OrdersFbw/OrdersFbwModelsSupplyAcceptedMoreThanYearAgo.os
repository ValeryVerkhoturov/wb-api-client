// OrdersFbwModelsSupplyAcceptedMoreThanYearAgo
//
...
// title - Строка - Краткое описание ошибки
Перем title Экспорт;

// detail - Строка - Подробное описание ошибки
Перем detail Экспорт;

// requestId - Строка - ID запроса
Перем requestId Экспорт;

// origin - Строка - Сервис, в котором произошла ошибка
