// OrdersFbwModelsOptionsResultModel
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// result - Массив
Перем result Экспорт;

// requestId - Строка - ID запроса при наличии ошибок
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("result") <> Неопределено Тогда
		result = Значения.Получить("result");
	КонецЕсли;
...
Функция Данные() Экспорт
	...
	Если result <> Неопределено Тогда
		Результат.Вставить("result", ЗначениеДляJSON(result));
	КонецЕсли;
