// OrdersFbwModelsListDraftsResponse
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// total - Число - Общее количество черновиков
Перем total Экспорт;

// drafts - Массив - Список черновиков
Перем drafts Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЕсли;
	Если Значения.Получить("drafts") <> Неопределено Тогда
		drafts = Значения.Получить("drafts");
	КонецЕсли;
КонецПроцедуры
...
Функция Данные() Экспорт
	...
	КонецЕсли;
	Если drafts <> Неопределено Тогда
		Результат.Вставить("drafts", ЗначениеДляJSON(drafts));
	КонецЕсли;
	Возврат Результат;
