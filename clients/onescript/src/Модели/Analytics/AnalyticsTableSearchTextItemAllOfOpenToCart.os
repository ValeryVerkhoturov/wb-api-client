// AnalyticsTableSearchTextItemAllOfOpenToCart
//
...
// current - Число - Текущая конверсия
Перем current Экспорт;

// dynamics - Число - Динамика по сравнению с предыдущим периодом, %
Перем dynamics Экспорт;

// percentile - Число - Процент, на который показатель конверсии в корзину выше, чем у карточек других продавцов по поисковому запросу
