// AnalyticsPostV3SalesFunnelProductsHistoryResponse200Inner
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// product - PostV3SalesFunnelProductsHistoryResponse200_inner_product
Перем product Экспорт;

// history - Массив - Статистика за период
Перем history Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЕсли;
	Если Значения.Получить("history") <> Неопределено Тогда
		history = Значения.Получить("history");
	КонецЕсли;
...
Функция Данные() Экспорт
	...
	Если history <> Неопределено Тогда
		Результат.Вставить("history", ЗначениеДляJSON(history));
	КонецЕсли;
