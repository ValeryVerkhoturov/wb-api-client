// AnalyticsTableSearchTextItemAllOfOpenCard
//
...
// current - Число - Текущее количество переходов
Перем current Экспорт;

// dynamics - Число - Динамика по сравнению с предыдущим периодом, %
Перем dynamics Экспорт;

// percentile - Число - Процент, на который показатель количества открытий карточки товара выше, чем у карточек других продавцов по поисковому запросу
