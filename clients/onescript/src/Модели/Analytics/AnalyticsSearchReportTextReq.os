...
// reportType - Строка - Тип отчёта `SEARCH_QUERIES_PREMIUM_REPORT_TEXT` — Отчёт по текстам поисковых запросов
...
// params - SearchReportTextReq_params
