// AnalyticsPostV2NmReportDownloadsRequest
//
...
// reportType - Строка - Тип отчёта `STOCK\\_HISTORY\\_DAILY\\_CSV` — Отчёт по истории остатков. Данные отчёта обновляются 1 раз в 2 часа
...
// params - InventoryHistoryReportReq_params
