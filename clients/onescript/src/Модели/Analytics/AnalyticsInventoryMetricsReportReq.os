// AnalyticsInventoryMetricsReportReq
//
...
// reportType - Строка - Тип отчёта `STOCK\\_HISTORY\\_REPORT\\_CSV` — Отчёт по статистике остатков. Данные отчёта обновляются 1 раз в 2 часа
...
// params - CommonReportFilters - Параметры отчёта
