// AnalyticsOrderFeedRequestSelectedPeriod
//
...
// start - Дата - Дата и время начала периода. Не ранее 31 суток от текущей даты и не позднее `end`
Перем start Экспорт;

// end - Дата - Дата и время конца периода. Не ранее 31 суток от текущей даты
Перем end Экспорт;
