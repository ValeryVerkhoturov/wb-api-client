// AnalyticsDistributionTableItemFeedbackRating
//
...
// current - Число - Текущий рейтинг
Перем current Экспорт;

// dynamics - Число - Динамика по сравнению с предыдущим периодом, %
Перем dynamics Экспорт;

// percentile - Число - Сколько процентов товаров этого предмета у других продавцов имеют рейтинг ниже, чем у этого товара
