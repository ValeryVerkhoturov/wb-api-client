...
// reportType - Строка - Тип отчёта `GROUPED_HISTORY_REPORT` — Воронка продаж. По предметам, брендам и ярлыкам
...
// params - SalesFunnelGroupReq_params
