// AnalyticsTableShippingOfficeResponse
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// regions - Массив - Множество данных по регионам отгрузки
Перем regions Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("regions") <> Неопределено Тогда
		regions = Значения.Получить("regions");
	КонецЕсли;
...
Функция Данные() Экспорт
	...
	Если regions <> Неопределено Тогда
		Результат.Вставить("regions", ЗначениеДляJSON(regions));
	КонецЕсли;
