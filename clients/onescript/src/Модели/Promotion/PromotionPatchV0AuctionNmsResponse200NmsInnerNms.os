// PromotionPatchV0AuctionNmsResponse200NmsInnerNms
//
// Карточки товаров
//
...
// added - Массив - Добавленные карточки товаров
Перем added Экспорт;

// deleted - Массив - Удалённые карточки товаров
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("added") <> Неопределено Тогда
		added = Значения.Получить("added");
	КонецЕсли;
...
Функция Данные() Экспорт
	...
	Если added <> Неопределено Тогда
		Результат.Вставить("added", ЗначениеДляJSON(added));
	КонецЕсли;
