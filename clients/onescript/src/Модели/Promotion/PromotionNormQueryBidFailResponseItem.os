// PromotionNormQueryBidFailResponseItem
//
...
// normQuery - Строка - Поисковый кластер — это группа похожих поисковых запросов, по которым покупатели находят товары
Перем normQuery Экспорт;

// reason - Строка - Описание причины ошибки
