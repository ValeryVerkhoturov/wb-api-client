// PromotionRequestWithIntervalInterval
//
...
// begin - Дата - Начало запрашиваемого периода
Перем begin Экспорт;

// end - Дата - Конец запрашиваемого периода
Перем end Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("begin") <> Неопределено Тогда
		begin = Значения.Получить("begin");
	КонецЕсли;
...
Функция Данные() Экспорт
	...
	Если begin <> Неопределено Тогда
		Результат.Вставить("begin", ЗначениеДляJSON(begin));
	КонецЕсли;
