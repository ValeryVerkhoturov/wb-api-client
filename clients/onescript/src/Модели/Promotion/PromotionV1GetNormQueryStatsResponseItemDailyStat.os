// PromotionV1GetNormQueryStatsResponseItemDailyStat
//
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЕсли;
	Если Значения.Получить("stat") <> Неопределено Тогда
		stat = Значения.Получить("stat");
	КонецЕсли;
КонецПроцедуры
...
Функция Данные() Экспорт
	...
	КонецЕсли;
	Если stat <> Неопределено Тогда
		Результат.Вставить("stat", ЗначениеДляJSON(stat));
	КонецЕсли;
	Возврат Результат;
