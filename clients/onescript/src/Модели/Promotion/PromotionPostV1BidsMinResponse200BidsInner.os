// PromotionPostV1BidsMinResponse200BidsInner
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// bids - Массив - Список ставок по местам размещения
Перем bids Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("bids") <> Неопределено Тогда
		bids = Значения.Получить("bids");
	КонецЕсли;
...
Функция Данные() Экспорт
	...
	Если bids <> Неопределено Тогда
		Результат.Вставить("bids", ЗначениеДляJSON(bids));
	КонецЕсли;
