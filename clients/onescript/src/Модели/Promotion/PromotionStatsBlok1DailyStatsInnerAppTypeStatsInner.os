// PromotionStatsBlok1DailyStatsInnerAppTypeStatsInner
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// app_type - Число - Тип платформы: - `1` — сайт - `32` — Android - `64` — IOS
Перем app_type Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("app_type") <> Неопределено Тогда
		app_type = Значения.Получить("app_type");
	КонецЕсли;
...
Функция Данные() Экспорт
	...
	Если app_type <> Неопределено Тогда
		Результат.Вставить("app_type", ЗначениеДляJSON(app_type));
	КонецЕсли;
