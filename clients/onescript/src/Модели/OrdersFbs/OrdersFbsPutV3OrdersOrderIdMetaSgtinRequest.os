// OrdersFbsPutV3OrdersOrderIdMetaSgtinRequest
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// sgtins - Массив - Массив кодов маркировки [Честного знака](https://честныйзнак.рф/). Вы [можете передать](https://seller.wildberries.ru/instructions/ru/ru/material/kiz-common-err…
Перем sgtins Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("sgtins") <> Неопределено Тогда
		sgtins = Значения.Получить("sgtins");
	КонецЕсли;
КонецПроцедуры
...
Функция Данные() Экспорт
	...
	Если sgtins <> Неопределено Тогда
		Результат.Вставить("sgtins", ЗначениеДляJSON(sgtins));
	КонецЕсли;
	Возврат Результат;
