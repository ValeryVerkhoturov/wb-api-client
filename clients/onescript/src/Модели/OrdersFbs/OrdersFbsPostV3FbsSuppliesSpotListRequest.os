// OrdersFbsPostV3FbsSuppliesSpotListRequest
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// supplyIds - Массив - Список ID поставок
Перем supplyIds Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("supplyIds") <> Неопределено Тогда
		supplyIds = Значения.Получить("supplyIds");
	КонецЕсли;
КонецПроцедуры
...
Функция Данные() Экспорт
	...
	Если supplyIds <> Неопределено Тогда
		Результат.Вставить("supplyIds", ЗначениеДляJSON(supplyIds));
	КонецЕсли;
	Возврат Результат;
