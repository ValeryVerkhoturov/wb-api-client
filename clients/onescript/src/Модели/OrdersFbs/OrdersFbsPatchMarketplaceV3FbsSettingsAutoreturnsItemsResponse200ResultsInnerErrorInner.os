// OrdersFbsPatchMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner
//
...
// detail - Строка - Дополнительная информация об ошибке: - `Not Found` — ID размера товара не найден или указан ID размера немалогабаритного товара
