...
// spot - SupplySpotDataResponse_supplies_inner_spot
Перем spot Экспорт;

// error - SupplySpotDataResponse_supplies_inner_error
Перем error Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЕсли;
	Если Значения.Получить("spot") <> Неопределено Тогда
		spot = Значения.Получить("spot");
	КонецЕсли;
...
Функция Данные() Экспорт
	...
	КонецЕсли;
	Если spot <> Неопределено Тогда
		Результат.Вставить("spot", ЗначениеДляJSON(spot));
	КонецЕсли;
