// OrdersFbsSupplySpotQRCode
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// qrCode - Строка - QR-код поставки в кодировке base64
Перем qrCode Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("qrCode") <> Неопределено Тогда
		qrCode = Значения.Получить("qrCode");
	КонецЕсли;
КонецПроцедуры
...
Функция Данные() Экспорт
	...
	Если qrCode <> Неопределено Тогда
		Результат.Вставить("qrCode", ЗначениеДляJSON(qrCode));
	КонецЕсли;
	Возврат Результат;
