// OrdersFbsShippingPointsResponse
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// shippingPoints - Массив - Список пунктов отгрузки
Перем shippingPoints Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("shippingPoints") <> Неопределено Тогда
		shippingPoints = Значения.Получить("shippingPoints");
	КонецЕсли;
КонецПроцедуры
...
Функция Данные() Экспорт
	...
	Если shippingPoints <> Неопределено Тогда
		Результат.Вставить("shippingPoints", ЗначениеДляJSON(shippingPoints));
	КонецЕсли;
	Возврат Результат;
