// OrdersFbsPutV3OrdersOrderIdMetaExpirationRequest
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// expiration - Строка - Дата, до которой годен товар. Не менее 30 дней с текущей даты
Перем expiration Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("expiration") <> Неопределено Тогда
		expiration = Значения.Получить("expiration");
	КонецЕсли;
КонецПроцедуры
...
Функция Данные() Экспорт
	...
	Если expiration <> Неопределено Тогда
		Результат.Вставить("expiration", ЗначениеДляJSON(expiration));
	КонецЕсли;
	Возврат Результат;
