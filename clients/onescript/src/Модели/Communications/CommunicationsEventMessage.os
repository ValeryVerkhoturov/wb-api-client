...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("attachments") <> Неопределено Тогда
		attachments = Значения.Получить("attachments");
	КонецЕсли;
...
Функция Данные() Экспорт
	...
	Если attachments <> Неопределено Тогда
		Результат.Вставить("attachments", ЗначениеДляJSON(attachments));
	КонецЕсли;
