// CommunicationsOpenapiSellerLimitsResponseData
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// subscription - openapi_SellerLimitsResponse_data_subscription
Перем subscription Экспорт;

// tariff - openapi_SellerLimitsResponse_data_tariff
Перем tariff Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("subscription") <> Неопределено Тогда
		subscription = Значения.Получить("subscription");
	КонецЕсли;
	Если Значения.Получить("tariff") <> Неопределено Тогда
		tariff = Значения.Получить("tariff");
	КонецЕсли;
КонецПроцедуры
...
Функция Данные() Экспорт
	...
	Если subscription <> Неопределено Тогда
		Результат.Вставить("subscription", ЗначениеДляJSON(subscription));
	КонецЕсли;
	Если tariff <> Неопределено Тогда
		Результат.Вставить("tariff", ЗначениеДляJSON(tariff));
	КонецЕсли;
	Возврат Результат;
