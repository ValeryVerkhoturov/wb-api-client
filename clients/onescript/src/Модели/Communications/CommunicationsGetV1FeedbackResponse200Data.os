// CommunicationsGetV1FeedbackResponse200Data
//
...
// answer - GetV1FeedbackResponse200_data_answer
Перем answer Экспорт;

// state - Строка - Статус отзыва: - `none` - не обработан (новый) - `wbRu` - обработан
Перем state Экспорт;

// productDetails - GetV1FeedbackResponse200_data_productDetails
...
// video - GetV1FeedbackResponse200_data_video
Перем video Экспорт;

// wasViewed - Булево - Просмотрен ли отзыв
Перем wasViewed Экспорт;

// isAbleSupplierFeedbackValuation - Булево - Доступна ли продавцу возможность оставить жалобу на отзыв: - `true`— да - `false` — нет
...
// isAbleSupplierProductValuation - Булево - Доступна ли продавцу возможность сообщить о проблеме с товаром (`true` - доступна, `false` - не доступна)
