// ItemsPostV2CardsUpdateRequestInnerCharacteristicsInner
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// id - Число - ID характеристики
Перем id Экспорт;

// value - Произвольный - Значения характеристики. Тип данных — массив строк или число — зависит от типа характеристики, см. описание поля `charcType` в методе [Характеристики предмета](…
Перем value Экспорт;
