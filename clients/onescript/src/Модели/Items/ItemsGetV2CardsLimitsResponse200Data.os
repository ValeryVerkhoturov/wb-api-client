// ItemsGetV2CardsLimitsResponse200Data
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// freeLimits - Число - Количество бесплатных лимитов
Перем freeLimits Экспорт;

// paidLimits - Число - Количество оплаченных лимитов
Перем paidLimits Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("freeLimits") <> Неопределено Тогда
		freeLimits = Значения.Получить("freeLimits");
	КонецЕсли;
	Если Значения.Получить("paidLimits") <> Неопределено Тогда
		paidLimits = Значения.Получить("paidLimits");
	КонецЕсли;
КонецПроцедуры
...
Функция Данные() Экспорт
	...
	Если freeLimits <> Неопределено Тогда
		Результат.Вставить("freeLimits", ЗначениеДляJSON(freeLimits));
	КонецЕсли;
	Если paidLimits <> Неопределено Тогда
		Результат.Вставить("paidLimits", ЗначениеДляJSON(paidLimits));
	КонецЕсли;
	Возврат Результат;
