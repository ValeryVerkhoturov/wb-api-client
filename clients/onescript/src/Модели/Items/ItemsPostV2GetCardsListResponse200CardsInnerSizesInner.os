// ItemsPostV2GetCardsListResponse200CardsInnerSizesInner
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// chrtID - Число - Числовой ID размера для данного артикула WB
Перем chrtID Экспорт;

// techSize - Строка - Размер товара (А, XXL, 57 и др.)
Перем techSize Экспорт;

// wbSize - Строка - Российский размер товара
Перем wbSize Экспорт;

// skus - Массив - Баркод товара
Перем skus Экспорт;
