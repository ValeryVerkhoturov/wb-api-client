// ItemsPostV2ListGoodsFilterRequest
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// nmList - Массив - Артикулы WB для поиска товара
Перем nmList Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("nmList") <> Неопределено Тогда
		nmList = Значения.Получить("nmList");
	КонецЕсли;
КонецПроцедуры
...
Функция Данные() Экспорт
	...
	Если nmList <> Неопределено Тогда
		Результат.Вставить("nmList", ЗначениеДляJSON(nmList));
	КонецЕсли;
	Возврат Результат;
