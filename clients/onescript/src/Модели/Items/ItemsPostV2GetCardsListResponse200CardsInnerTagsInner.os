// ItemsPostV2GetCardsListResponse200CardsInnerTagsInner
//
...
// name - Строка - Название ярлыка
Перем name Экспорт;

// color - Строка - Цвет ярлыка. Доступные цвета: - `D1CFD7` — серый - `FEE0E0` — красный - `ECDAFF` — фиолетовый - `E4EAFF` — синий - `DEF1DD` — зеленый - `FFECC7` — желтый
Перем color Экспорт;
