// ItemsPostV2GetCardsTrashResponse200
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// cards - Массив - Массив карточек товаров
Перем cards Экспорт;

// cursor - PostV2GetCardsTrashResponse200_cursor
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("cards") <> Неопределено Тогда
		cards = Значения.Получить("cards");
	КонецЕсли;
...
Функция Данные() Экспорт
	...
	Если cards <> Неопределено Тогда
		Результат.Вставить("cards", ЗначениеДляJSON(cards));
	КонецЕсли;
