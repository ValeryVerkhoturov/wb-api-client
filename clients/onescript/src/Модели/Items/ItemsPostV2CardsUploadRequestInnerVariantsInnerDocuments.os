// ItemsPostV2CardsUploadRequestInnerVariantsInnerDocuments
//
// Документы
//
...
// excludeDocuments - Булево - Исключить ли документы из проверки: - `true` — да, не проверять документы при проверке карточки товара. При `true` все значения, переданные в `documents`, будут…
