// ItemsPostV1UploadTaskB2bWholesale200Response
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// id - Число - ID загрузки
Перем id Экспорт;

// alreadyExists - Булево - Дублирование загрузки: `true` — такая загрузка уже есть
Перем alreadyExists Экспорт;

// results - Массив - Результаты обработки запроса
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЕсли;
	Если Значения.Получить("results") <> Неопределено Тогда
		results = Значения.Получить("results");
	КонецЕсли;
КонецПроцедуры
...
Функция Данные() Экспорт
	...
	Если results <> Неопределено Тогда
		Результат.Вставить("results", ЗначениеДляJSON(results));
	КонецЕсли;
	Возврат Результат;
