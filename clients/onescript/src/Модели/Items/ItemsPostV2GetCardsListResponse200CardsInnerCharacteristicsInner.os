// ItemsPostV2GetCardsListResponse200CardsInnerCharacteristicsInner
//
...
// value - Произвольный - Значение характеристики. Тип значения зависит от типа характеристики
Перем value Экспорт;
