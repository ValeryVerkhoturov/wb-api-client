// ItemsPostV2UploadTaskSizeRequest
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// data - Массив - Размеры и цены для них. Максимум 1 000 размеров. Для товаров с поразмерной установкой цен [карантин](https://seller.wildberries.ru/instructions/ru/ru/material/p…
Перем data Экспорт;
