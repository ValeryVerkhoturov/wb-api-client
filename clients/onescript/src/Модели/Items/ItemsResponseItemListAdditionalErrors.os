// ItemsResponseItemListAdditionalErrors
//
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("string") <> Неопределено Тогда
		string = Значения.Получить("string");
	КонецЕсли;
...
Функция Данные() Экспорт
	...
	Если string <> Неопределено Тогда
		Результат.Вставить("string", ЗначениеДляJSON(string));
	КонецЕсли;
