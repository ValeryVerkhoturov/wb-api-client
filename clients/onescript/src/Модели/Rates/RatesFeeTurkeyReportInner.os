// RatesFeeTurkeyReportInner
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// kgvpTurkey - Число - Комиссия для продавцов из Турции, %
Перем kgvpTurkey Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("kgvpTurkey") <> Неопределено Тогда
		kgvpTurkey = Значения.Получить("kgvpTurkey");
	КонецЕсли;
...
Функция Данные() Экспорт
	...
	Если kgvpTurkey <> Неопределено Тогда
		Результат.Вставить("kgvpTurkey", ЗначениеДляJSON(kgvpTurkey));
	КонецЕсли;
