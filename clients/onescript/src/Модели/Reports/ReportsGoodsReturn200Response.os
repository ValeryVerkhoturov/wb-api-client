// ReportsGoodsReturn200Response
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// count - Число - Общее количество возвратов за запрашиваемый период
Перем count Экспорт;

// report - Массив - Отчёт
Перем report Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЕсли;
	Если Значения.Получить("report") <> Неопределено Тогда
		report = Значения.Получить("report");
	КонецЕсли;
КонецПроцедуры
...
Функция Данные() Экспорт
	...
	Если report <> Неопределено Тогда
		Результат.Вставить("report", ЗначениеДляJSON(report));
	КонецЕсли;
	Возврат Результат;
