// ReportsCreateTaskResponseData
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// taskId - Строка - ID задания на генерацию
Перем taskId Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("taskId") <> Неопределено Тогда
		taskId = Значения.Получить("taskId");
	КонецЕсли;
КонецПроцедуры
...
Функция Данные() Экспорт
	...
	Если taskId <> Неопределено Тогда
		Результат.Вставить("taskId", ЗначениеДляJSON(taskId));
	КонецЕсли;
	Возврат Результат;
