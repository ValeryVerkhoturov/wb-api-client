// ReportsGetV1AnalyticsAntifraudDetails200Response
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// details - Массив
Перем details Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("details") <> Неопределено Тогда
		details = Значения.Получить("details");
	КонецЕсли;
КонецПроцедуры
...
Функция Данные() Экспорт
	...
	Если details <> Неопределено Тогда
		Результат.Вставить("details", ЗначениеДляJSON(details));
	КонецЕсли;
	Возврат Результат;
