// InStorePickupApiMetaDetailsResponseResultsInnerErrorsInner
//
...
// detail - Строка - - `NotFound` — сборочное задание не найдено - `StatusMismatch` — операция невозможна для этого статуса сборочного задания - `MetaValidationFail` — идентификатор…
Перем detail Экспорт;

// metaDetails - Массив - Ошибки проверки идентификаторов маркировки
