// InStorePickupApiBatchCustomsDeclarationErrorResponse
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// code - Число - Код ошибки: - `404` - `409` - `400`
Перем code Экспорт;

// detail - Строка - - `NotFound` — сборочное задание не найдено - `StatusMismatch` — операция невозможна для этого статуса сборочного задания - `OrderNotB2B` — операция доступна то…
