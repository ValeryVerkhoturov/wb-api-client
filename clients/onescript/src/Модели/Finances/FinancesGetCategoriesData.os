// FinancesGetCategoriesData
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// categories - Массив - Категории документов
Перем categories Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("categories") <> Неопределено Тогда
		categories = Значения.Получить("categories");
	КонецЕсли;
КонецПроцедуры
...
Функция Данные() Экспорт
	...
	Если categories <> Неопределено Тогда
		Результат.Вставить("categories", ЗначениеДляJSON(categories));
	КонецЕсли;
	Возврат Результат;
