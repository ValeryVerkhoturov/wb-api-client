// OrdersDbwPutV3DbwOrdersOrderIdMetaGtinRequest
//
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("gtin") <> Неопределено Тогда
		gtin = Значения.Получить("gtin");
	КонецЕсли;
КонецПроцедуры
...
Функция Данные() Экспорт
	...
	Если gtin <> Неопределено Тогда
		Результат.Вставить("gtin", ЗначениеДляJSON(gtin));
	КонецЕсли;
	Возврат Результат;
