// OrdersDbwPutV3DbwOrdersOrderIdMetaUinRequest
//
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("uin") <> Неопределено Тогда
		uin = Значения.Получить("uin");
	КонецЕсли;
КонецПроцедуры
...
Функция Данные() Экспорт
	...
	Если uin <> Неопределено Тогда
		Результат.Вставить("uin", ЗначениеДляJSON(uin));
	КонецЕсли;
	Возврат Результат;
