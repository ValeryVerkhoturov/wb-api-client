...
// orderIds - Массив - Список ID сборочных заданий
Перем orderIds Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЕсли;
	Если Значения.Получить("orderIds") <> Неопределено Тогда
		orderIds = Значения.Получить("orderIds");
	КонецЕсли;
КонецПроцедуры
...
Функция Данные() Экспорт
	...
	КонецЕсли;
	Если orderIds <> Неопределено Тогда
		Результат.Вставить("orderIds", ЗначениеДляJSON(orderIds));
	КонецЕсли;
	Возврат Результат;
