// DbsPostV3DbsOrdersStickersResponse200StickersInner
//
...
// partA - Строка - Первая часть ID стикера
Перем partA Экспорт;

// partB - Строка - Вторая часть ID стикера
Перем partB Экспорт;

// barcode - Строка - Закодированное значение стикера
Перем barcode Экспорт;

// file - Строка - Полное представление стикера, кодировка base64
Перем file Экспорт;
