// DbsPostV3DbsOrdersStickersResponse200
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// stickers - Массив - Стикеры
Перем stickers Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("stickers") <> Неопределено Тогда
		stickers = Значения.Получить("stickers");
	КонецЕсли;
КонецПроцедуры
...
Функция Данные() Экспорт
	...
	Если stickers <> Неопределено Тогда
		Результат.Вставить("stickers", ЗначениеДляJSON(stickers));
	КонецЕсли;
	Возврат Результат;
