...
// invite - createInviteRequest_invite
Перем invite Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЕсли;
	Если Значения.Получить("invite") <> Неопределено Тогда
		invite = Значения.Получить("invite");
	КонецЕсли;
КонецПроцедуры
...
Функция Данные() Экспорт
	...
	КонецЕсли;
	Если invite <> Неопределено Тогда
		Результат.Вставить("invite", ЗначениеДляJSON(invite));
	КонецЕсли;
	Возврат Результат;
