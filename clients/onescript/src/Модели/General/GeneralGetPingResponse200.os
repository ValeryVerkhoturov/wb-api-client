// GeneralGetPingResponse200
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// TS - Строка - Timestamp запроса
Перем TS Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("TS") <> Неопределено Тогда
		TS = Значения.Получить("TS");
	КонецЕсли;
...
Функция Данные() Экспорт
	...
	Если TS <> Неопределено Тогда
		Результат.Вставить("TS", ЗначениеДляJSON(TS));
	КонецЕсли;
