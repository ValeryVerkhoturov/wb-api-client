// GeneralUpdateUserAccessRequest
//
// Класс сформирован автоматически (onescript) из спецификации OpenAPI.
// Правки будут потеряны при следующей генерации.

// usersAccesses - Массив - Настройки доступа для пользователя
Перем usersAccesses Экспорт;
...
Процедура Заполнить(Знач Данные) Экспорт
	...
	КонецЦикла;
	Если Значения.Получить("usersAccesses") <> Неопределено Тогда
		usersAccesses = Значения.Получить("usersAccesses");
	КонецЕсли;
КонецПроцедуры
...
Функция Данные() Экспорт
	...
	Если usersAccesses <> Неопределено Тогда
		Результат.Вставить("usersAccesses", ЗначениеДляJSON(usersAccesses));
	КонецЕсли;
	Возврат Результат;
