...
class SearchReportGroupReq(BaseModel):
    ...
    report_type: StrictStr = Field(
        description="Тип отчёта `SEARCH_QUERIES_PREMIUM_REPORT_GROUP` — Отчёт по параметрам поиска. По предметам, брендам и ярлыкам",
        alias="reportType",
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "params": (
                    SearchReportGroupReqParams.from_dict(obj["params"])
