        ...
        _obj = cls.model_validate(
            {
                ...
                "timeToReadyDynamic": (
                    ComparisonTimeToReadyDynamic.from_dict(obj["timeToReadyDynamic"])
                    if obj.get("timeToReadyDynamic") is not None
                    else None
                ),
                "localizationPercentDynamic": obj.get("localizationPercentDynamic"),
                "wbClubDynamic": (
                    ComparisonWbClubDynamic.from_dict(obj["wbClubDynamic"])
                    if obj.get("wbClubDynamic") is not None
                    else None
                ),
                "conversions": (
