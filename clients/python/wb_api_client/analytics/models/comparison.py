...
class Comparison(BaseModel):
    ...
    localization_percent_dynamic: StrictInt = Field(description="Динамика локальных заказов в рамках одного региона. [На данный момент](https://dev.wildberries.ru/release-notes?id=570) может быть только `0`", alias="localizationPercentDynamic")
