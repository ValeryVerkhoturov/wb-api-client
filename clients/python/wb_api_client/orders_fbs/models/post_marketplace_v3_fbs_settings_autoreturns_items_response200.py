...
class PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200(BaseModel):
    """
    PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200
    """ # noqa: E501
    results: List[PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "results": [PostMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
