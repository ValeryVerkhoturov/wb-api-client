...
class GetV3OrdersNewResponse200(BaseModel):
    """
    GetV3OrdersNewResponse200
    """  # noqa: E501

    orders: Optional[List[OrderNew]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV3OrdersNewResponse200 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV3OrdersNewResponse200 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "orders": (
                    [OrderNew.from_dict(_item) for _item in obj["orders"]]
