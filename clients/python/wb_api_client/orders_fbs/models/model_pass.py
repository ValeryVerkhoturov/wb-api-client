...
class ModelPass(BaseModel):
    ...
    first_name: Optional[StrictStr] = Field(
        default=None, description="Имя водителя", alias="firstName"
    )
    date_end: Optional[StrictStr] = Field(
        default=None, description="Дата окончания действия пропуска", alias="dateEnd"
    )
    last_name: Optional[StrictStr] = Field(
        default=None, description="Фамилия водителя", alias="lastName"
    )
    car_model: Optional[StrictStr] = Field(
        default=None, description="Марка машины", alias="carModel"
    )
    car_number: Optional[StrictStr] = Field(
        default=None, description="Номер машины", alias="carNumber"
    )
    office_name: Optional[StrictStr] = Field(
        default=None, description="Название склада", alias="officeName"
    )
    office_address: Optional[StrictStr] = Field(
        default=None, description="Адрес склада", alias="officeAddress"
    )
