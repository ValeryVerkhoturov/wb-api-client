...
class PatchV3FbsSuppliesShippingMethodRequest(BaseModel):
    """
    PatchV3FbsSuppliesShippingMethodRequest
    """  # noqa: E501

    data: Annotated[
        List[UpdateSupplyShippingMethod], Field(min_length=1, max_length=100)
    ]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchV3FbsSuppliesShippingMethodRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchV3FbsSuppliesShippingMethodRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "data": (
                    [
                        UpdateSupplyShippingMethod.from_dict(_item)
