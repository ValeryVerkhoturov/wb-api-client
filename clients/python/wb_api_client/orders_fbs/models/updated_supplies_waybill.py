...
class UpdatedSuppliesWaybill(BaseModel):
    """
    Результат обработки запроса для одной поставки
    """  # noqa: E501

    error: Optional[UpdatedSuppliesWaybillError] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdatedSuppliesWaybill from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdatedSuppliesWaybill from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "error": (
                    UpdatedSuppliesWaybillError.from_dict(obj["error"])
