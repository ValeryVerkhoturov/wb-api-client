...
class PatchMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchMarketplaceV3FbsSettingsAutoreturnsItemsResponse200ResultsInnerErrorInner from a dict"""
        if obj is None:
            return None
