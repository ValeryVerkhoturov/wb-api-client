...
class UpdatedSuppliesShippingMethod(BaseModel):
    """
    Результат обработки запроса для одной поставки
    """  # noqa: E501

    error: Optional[UpdatedSuppliesShippingMethodError] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdatedSuppliesShippingMethod from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdatedSuppliesShippingMethod from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "error": (
                    UpdatedSuppliesShippingMethodError.from_dict(obj["error"])
