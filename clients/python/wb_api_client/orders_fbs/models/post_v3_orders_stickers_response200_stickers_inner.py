...
class PostV3OrdersStickersResponse200StickersInner(BaseModel):
    """
    ...
    file: Optional[StrictStr] = Field(default=None, description="Полное представление стикера в заданном формате")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV3OrdersStickersResponse200StickersInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV3OrdersStickersResponse200StickersInner from a dict"""
        if obj is None:
            return None
