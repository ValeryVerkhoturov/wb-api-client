...
class SupplySpotDataResponseSuppliesInnerError(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SupplySpotDataResponseSuppliesInnerError from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SupplySpotDataResponseSuppliesInnerError from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"detail": obj.get("detail"), "title": obj.get("title")}
        )
        return _obj
