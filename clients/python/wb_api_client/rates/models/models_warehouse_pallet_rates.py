...
class ModelsWarehousePalletRates(BaseModel):
    ...
    pallet_delivery_expr: Optional[StrictStr] = Field(
        default=None,
    ...
    pallet_delivery_value_base: Optional[StrictStr] = Field(
        default=None, description="Доставка 1 литра, ₽", alias="palletDeliveryValueBase"
    )
    pallet_delivery_value_liter: Optional[StrictStr] = Field(
        default=None,
        description="Доставка каждого дополнительного литра, ₽",
        alias="palletDeliveryValueLiter",
    )
    pallet_storage_expr: Optional[StrictStr] = Field(
        default=None,
    ...
    pallet_storage_value_expr: Optional[StrictStr] = Field(
        default=None,
