...
class GetV1QuestionsResponse200(BaseModel):
    """
    GetV1QuestionsResponse200
    """ # noqa: E501
    data: Optional[GetV1QuestionsResponse200Data] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV1QuestionsResponse200 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV1QuestionsResponse200 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": GetV1QuestionsResponse200Data.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error"),
