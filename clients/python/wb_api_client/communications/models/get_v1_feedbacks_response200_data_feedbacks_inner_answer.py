...
class GetV1FeedbacksResponse200DataFeedbacksInnerAnswer(BaseModel):
    """
    Структура ответа
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV1FeedbacksResponse200DataFeedbacksInnerAnswer from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV1FeedbacksResponse200DataFeedbacksInnerAnswer from a dict"""
        if obj is None:
            return None
