...
class GetV1FeedbacksResponse200(BaseModel):
    """
    GetV1FeedbacksResponse200
    """ # noqa: E501
    data: Optional[GetV1FeedbacksResponse200Data] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV1FeedbacksResponse200 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV1FeedbacksResponse200 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": GetV1FeedbacksResponse200Data.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error"),
