...
class OpenapiSellerLimitsResponseDataSubscription(BaseModel):
    """
    OpenapiSellerLimitsResponseDataSubscription
    """ # noqa: E501
    per_unit_limit: StrictInt = Field(description="Максимальное количество закреплённых отзывов в одной карточке товара или в группе [объединённых](/knowledge-base/articles/019d49a4-1320-71bb-9dac-8ba07e7177ce/rabota-s-tovarami#obuedinenie-i-razuedinenie-kartochek-tovarov) карточек", alias="perUnitLimit")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenapiSellerLimitsResponseDataSubscription from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenapiSellerLimitsResponseDataSubscription from a dict"""
        if obj is None:
            return None
