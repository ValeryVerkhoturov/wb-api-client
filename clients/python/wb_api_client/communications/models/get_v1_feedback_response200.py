...
class GetV1FeedbackResponse200(BaseModel):
    """
    GetV1FeedbackResponse200
    """ # noqa: E501
    data: Optional[GetV1FeedbackResponse200Data] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV1FeedbackResponse200 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV1FeedbackResponse200 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": GetV1FeedbackResponse200Data.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error"),
