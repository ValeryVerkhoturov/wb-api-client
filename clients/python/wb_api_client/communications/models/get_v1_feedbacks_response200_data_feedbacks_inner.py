...
class GetV1FeedbacksResponse200DataFeedbacksInner(BaseModel):
    ...
    product_details: Optional[
        GetV1FeedbacksResponse200DataFeedbacksInnerProductDetails
    ] = Field(default=None, alias="productDetails")
    ...
    is_able_supplier_product_valuation: Optional[StrictBool] = Field(
        default=None,
        description="Доступна ли продавцу возможность сообщить о проблеме с товаром:   - `true` — да   - `false` — нет ",
        ...
        _obj = cls.model_validate(
            {
                ...
                "answer": (
                    GetV1FeedbacksResponse200DataFeedbacksInnerAnswer.from_dict(
                        obj["answer"]
                    )
                ...
                "state": obj.get("state"),
                "productDetails": (
                    GetV1FeedbacksResponse200DataFeedbacksInnerProductDetails.from_dict(
                        obj["productDetails"]
                    )
                ...
                "video": (
                    GetV1FeedbacksResponse200DataFeedbacksInnerVideo.from_dict(
                        obj["video"]
                    )
