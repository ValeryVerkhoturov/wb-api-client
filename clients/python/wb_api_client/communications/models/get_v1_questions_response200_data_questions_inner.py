...
class GetV1QuestionsResponse200DataQuestionsInner(BaseModel):
    """
    ...
    answer: Optional[GetV1QuestionsResponse200DataQuestionsInnerAnswer] = None
    product_details: Optional[GetV1QuestionsResponse200DataQuestionsInnerProductDetails] = Field(default=None, alias="productDetails")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV1QuestionsResponse200DataQuestionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV1QuestionsResponse200DataQuestionsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "state": obj.get("state"),
            "answer": GetV1QuestionsResponse200DataQuestionsInnerAnswer.from_dict(obj["answer"]) if obj.get("answer") is not None else None,
            "productDetails": GetV1QuestionsResponse200DataQuestionsInnerProductDetails.from_dict(obj["productDetails"]) if obj.get("productDetails") is not None else None,
