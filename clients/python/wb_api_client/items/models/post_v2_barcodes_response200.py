...
class PostV2BarcodesResponse200(BaseModel):
    """
    PostV2BarcodesResponse200
    """  # noqa: E501

    data: Optional[List[StrictStr]] = Field(
        default=None, description="Массив сгенерированных баркодов"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV2BarcodesResponse200 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV2BarcodesResponse200 from a dict"""
        if obj is None:
            return None
