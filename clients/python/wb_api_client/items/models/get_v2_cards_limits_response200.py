...
class GetV2CardsLimitsResponse200(BaseModel):
    """
    GetV2CardsLimitsResponse200
    """ # noqa: E501
    data: Optional[GetV2CardsLimitsResponse200Data] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV2CardsLimitsResponse200 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV2CardsLimitsResponse200 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": GetV2CardsLimitsResponse200Data.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error"),
