...
class PostV2CardsUploadRequestInnerVariantsInner(BaseModel):
    ...
    vendor_code: Annotated[str, Field(strict=True, max_length=72)] = Field(
        description="Артикул продавца", alias="vendorCode"
    )
    ...
    sizes: Optional[List[PostV2CardsUploadRequestInnerVariantsInnerSizesInner]] = Field(
        default=None,
        description='Массив размеров. Если не указать для размерного товара (обувь, одежда и др.), сгенерируется автоматически с `techSize` = "A", `wbSize` = "1" и баркодом',
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "wholesale": (
                    PostV2CardsUploadRequestInnerVariantsInnerWholesale.from_dict(
                        obj["wholesale"]
                    )
                ...
                "dimensions": (
                    PostV2CardsUploadRequestInnerVariantsInnerDimensions.from_dict(
                        obj["dimensions"]
                    )
                ...
                "sizes": (
                    [
                        PostV2CardsUploadRequestInnerVariantsInnerSizesInner.from_dict(
                            _item
                        )
                ...
                "characteristics": (
                    [
                        PostV2CardsUpdateRequestInnerCharacteristicsInner.from_dict(
                            _item
                        )
