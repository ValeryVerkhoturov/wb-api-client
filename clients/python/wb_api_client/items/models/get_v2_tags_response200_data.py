...
class GetV2TagsResponse200Data(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV2TagsResponse200Data from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV2TagsResponse200Data from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"id": obj.get("id"), "color": obj.get("color"), "name": obj.get("name")}
        )
        return _obj
