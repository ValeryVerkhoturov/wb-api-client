...
class GetV2DirectorySeasonsResponse200(BaseModel):
    """
    GetV2DirectorySeasonsResponse200
    """  # noqa: E501

    data: Optional[List[StrictStr]] = Field(
        default=None, description="Массив значений для хар-ки Сезон"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV2DirectorySeasonsResponse200 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV2DirectorySeasonsResponse200 from a dict"""
        if obj is None:
            return None
