...
class PostV2GetCardsListResponse200CardsInnerCharacteristicsInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV2GetCardsListResponse200CardsInnerCharacteristicsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV2GetCardsListResponse200CardsInnerCharacteristicsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"id": obj.get("id"), "name": obj.get("name"), "value": obj.get("value")}
        )
        return _obj
