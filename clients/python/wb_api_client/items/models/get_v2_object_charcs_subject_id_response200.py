...
class GetV2ObjectCharcsSubjectIdResponse200(BaseModel):
    """
    GetV2ObjectCharcsSubjectIdResponse200
    """ # noqa: E501
    data: Optional[List[GetV2ObjectCharcsSubjectIdResponse200DataInner]] = Field(default=None, description="Данные")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV2ObjectCharcsSubjectIdResponse200 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV2ObjectCharcsSubjectIdResponse200 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [GetV2ObjectCharcsSubjectIdResponse200DataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "error": obj.get("error"),
