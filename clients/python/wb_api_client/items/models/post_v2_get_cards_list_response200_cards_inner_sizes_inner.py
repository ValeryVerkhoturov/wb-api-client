...
class PostV2GetCardsListResponse200CardsInnerSizesInner(BaseModel):
    """
    ...
    tech_size: Optional[StrictStr] = Field(
        default=None, description="Размер товара (А, XXL, 57 и др.)", alias="techSize"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV2GetCardsListResponse200CardsInnerSizesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV2GetCardsListResponse200CardsInnerSizesInner from a dict"""
        if obj is None:
            return None
