...
class PostV2GetCardsTrashResponse200Cursor(BaseModel):
    """
    Пагинатор
    """  # noqa: E501
    ...
    total: Optional[StrictInt] = Field(
        default=None, description="Количество возвращённых карточек товаров"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV2GetCardsTrashResponse200Cursor from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV2GetCardsTrashResponse200Cursor from a dict"""
        if obj is None:
            return None
