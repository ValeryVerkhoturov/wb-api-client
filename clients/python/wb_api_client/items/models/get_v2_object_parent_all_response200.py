...
class GetV2ObjectParentAllResponse200(BaseModel):
    """
    GetV2ObjectParentAllResponse200
    """ # noqa: E501
    data: Optional[List[GetV2ObjectParentAllResponse200DataInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV2ObjectParentAllResponse200 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV2ObjectParentAllResponse200 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [GetV2ObjectParentAllResponse200DataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "error": obj.get("error"),
