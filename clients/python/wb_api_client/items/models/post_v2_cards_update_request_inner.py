...
class PostV2CardsUpdateRequestInner(BaseModel):
    ...
    sizes: List[PostV2CardsUpdateRequestInnerSizesInner] = Field(description="Массив размеров Для безразмерного товара всё равно нужно передавать данный массив без параметров (wbSize и techSize), но с баркодом")
