...
class PostV2CardsUpdateRequestInner(BaseModel):
    ...
    sizes: List[PostV2CardsUpdateRequestInnerSizesInner] = Field(
        description="Массив размеров Для безразмерного товара всё равно нужно передавать данный массив без параметров (wbSize и techSize), но с баркодом"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "dimensions": (
                    PostV2CardsUpdateRequestInnerDimensions.from_dict(obj["dimensions"])
                    if obj.get("dimensions") is not None
                    else None
                ),
                "documents": (
                    PostV2CardsUpdateRequestInnerDocuments.from_dict(obj["documents"])
                ...
                "sizes": (
                    [
                        PostV2CardsUpdateRequestInnerSizesInner.from_dict(_item)
