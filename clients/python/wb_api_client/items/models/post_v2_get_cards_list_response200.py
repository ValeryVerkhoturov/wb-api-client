...
class PostV2GetCardsListResponse200(BaseModel):
    ...
    cards: Optional[List[PostV2GetCardsListResponse200CardsInner]] = Field(
        ...
        _obj = cls.model_validate(
            {
                "cards": (
                    [
                        PostV2GetCardsListResponse200CardsInner.from_dict(_item)
                ...
                "cursor": (
                    PostV2GetCardsListResponse200Cursor.from_dict(obj["cursor"])
