...
class PostV2GetCardsListResponse200(BaseModel):
    """
    PostV2GetCardsListResponse200
    """ # noqa: E501
    cards: Optional[List[PostV2GetCardsListResponse200CardsInner]] = Field(default=None, description="Список карточек товаров")
    cursor: Optional[PostV2GetCardsListResponse200Cursor] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostV2GetCardsListResponse200 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostV2GetCardsListResponse200 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "cards": [PostV2GetCardsListResponse200CardsInner.from_dict(_item) for _item in obj["cards"]] if obj.get("cards") is not None else None,
            "cursor": PostV2GetCardsListResponse200Cursor.from_dict(obj["cursor"]) if obj.get("cursor") is not None else None
        })
        return _obj
