...
class StatsBlok2DailyStatsInnerAppTypeStatsInner(BaseModel):
    """
    ...
    stats: Optional[List[StatsBlok2DailyStatsInnerAppTypeStatsInnerStatsInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StatsBlok2DailyStatsInnerAppTypeStatsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StatsBlok2DailyStatsInnerAppTypeStatsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "stats": [StatsBlok2DailyStatsInnerAppTypeStatsInnerStatsInner.from_dict(_item) for _item in obj["stats"]] if obj.get("stats") is not None else None
        })
        return _obj
