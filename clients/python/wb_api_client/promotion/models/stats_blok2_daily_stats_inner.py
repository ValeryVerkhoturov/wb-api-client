...
class StatsBlok2DailyStatsInner(BaseModel):
    ...
    app_type_stats: Optional[List[StatsBlok2DailyStatsInnerAppTypeStatsInner]] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "app_type_stats": (
                    [
                        StatsBlok2DailyStatsInnerAppTypeStatsInner.from_dict(_item)
                        for _item in obj["app_type_stats"]
                    ]
                    if obj.get("app_type_stats") is not None
                    else None
                ),
            }
        )
