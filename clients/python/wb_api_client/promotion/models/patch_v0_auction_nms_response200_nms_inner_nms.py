...
class PatchV0AuctionNmsResponse200NmsInnerNms(BaseModel):
    """
    Карточки товаров
    """  # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchV0AuctionNmsResponse200NmsInnerNms from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchV0AuctionNmsResponse200NmsInnerNms from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"added": obj.get("added"), "deleted": obj.get("deleted")}
        )
        return _obj
