...
class GetV1PromotionCountResponse200AdvertsInnerAdvertListInner(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV1PromotionCountResponse200AdvertsInnerAdvertListInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV1PromotionCountResponse200AdvertsInnerAdvertListInner from a dict"""
        if obj is None:
            return None
