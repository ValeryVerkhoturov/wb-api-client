...
class V0PutDailyLimitsAdvertResult(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["advertId", "belowMinLimit", "requiredLimit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V0PutDailyLimitsAdvertResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V0PutDailyLimitsAdvertResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "belowMinLimit": obj.get("belowMinLimit"),
