...
class ApiNewOrder(BaseModel):
    ...
    ddate: Optional[StrictStr] = Field(
        default=None, description="Планируемая дата доставки"
    )
    ...
    required_meta: Optional[List[StrictStr]] = Field(
        default=None,
        description="Список идентификаторов маркировки, доступных для сборочного задания ",
        alias="requiredMeta",
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "options": (
                    ApiNewOrderOptions.from_dict(obj["options"])
