...
from wb_api_client.in_store_pickup.api_response import ApiResponse, T as ApiResponseT
import wb_api_client.in_store_pickup.models
from wb_api_client.in_store_pickup import rest
from wb_api_client.in_store_pickup.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = "ValeryVerkhoturov/wb-api-client/python"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wb_api_client.in_store_pickup.models, klass)
