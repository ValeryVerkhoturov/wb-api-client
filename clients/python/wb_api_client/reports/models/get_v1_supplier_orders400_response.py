...
GETV1SUPPLIERORDERS400RESPONSE_ONE_OF_SCHEMAS = [
    "ResponseErrorStatistics",
    "ResponseErrorStatistics2",
]
...
class GetV1SupplierOrders400Response(BaseModel):
    ...
    actual_instance: Optional[
        Union[ResponseErrorStatistics, ResponseErrorStatistics2]
    ] = None
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, ResponseErrorStatistics):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `ResponseErrorStatistics`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, ResponseErrorStatistics2):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `ResponseErrorStatistics2`"
            )
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when setting `actual_instance` in GetV1SupplierOrders400Response with oneOf schemas: ResponseErrorStatistics, ResponseErrorStatistics2. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
            raise ValueError(
                "No match found when setting `actual_instance` in GetV1SupplierOrders400Response with oneOf schemas: ResponseErrorStatistics, ResponseErrorStatistics2. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when deserializing the JSON string into GetV1SupplierOrders400Response with oneOf schemas: ResponseErrorStatistics, ResponseErrorStatistics2. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
            raise ValueError(
                "No match found when deserializing the JSON string into GetV1SupplierOrders400Response with oneOf schemas: ResponseErrorStatistics, ResponseErrorStatistics2. Details: "
                + ", ".join(error_messages)
            )
        else:
            return instance
    ...
    def to_dict(
        ...
        Union[Dict[str, Any], ResponseErrorStatistics, ResponseErrorStatistics2]
    ]:
