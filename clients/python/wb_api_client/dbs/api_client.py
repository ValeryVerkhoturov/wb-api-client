...
from wb_api_client.dbs.api_response import ApiResponse, T as ApiResponseT
import wb_api_client.dbs.models
from wb_api_client.dbs import rest
from wb_api_client.dbs.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(wb_api_client.dbs.models, klass)
