...
class GetV2NewsResponse200DataInnerTypesInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetV2NewsResponse200DataInnerTypesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetV2NewsResponse200DataInnerTypesInner from a dict"""
        if obj is None:
            return None
