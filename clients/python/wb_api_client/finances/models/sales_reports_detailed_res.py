...
class SalesReportsDetailedRes(BaseModel):
    ...
    agency_vat: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "salePricePromocodeDiscountPrc": obj.get(
                    "salePricePromocodeDiscountPrc"
                ),
                "articleSubstitution": obj.get("articleSubstitution"),
                "salePriceAffiliatedDiscountPrc": obj.get(
                    "salePriceAffiliatedDiscountPrc"
                ),
                "agencyVat": obj.get("agencyVat"),
                "salePriceWholesaleDiscountPrc": obj.get(
                    "salePriceWholesaleDiscountPrc"
                ),
